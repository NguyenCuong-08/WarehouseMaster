...
<section class="section-rectangle">
    <div class="hosting-detail-container hosting-ready">
        @php $goiDichVus = DB::table('goi_dich_vu_lan_quet')->select('*')->get(); @endphp
        <div class="row">
              ...
              >
                            ...
                            <div class="global-host-btn text-center">
                                <form  action="https://hochieu.khoweb.top/payos/create-payment-link" method="POST" target="_blank">
                                    ...
                                    <button  class="button-custom-form-primary" type="submit" >Đăng ký</button>
                                </form>
                            </div>
                        </div>
                    </div>
              ...
              >
                            ...
                            <div class="global-host-btn text-center">
                                <form  action="https://hochieu.khoweb.top/payos/create-payment-link" method="POST" target="_blank">
                                    ...
                                    <input id="so_tien" type="hidden" name="soTien" value="{{$goiDichVu->price}}">
                                    <input id="goiDichVuId" type="hidden" name="goiDichVuId" value="{{$goiDichVu->id}}">
                                    <input id="typeGoiDichVuId" type="hidden" name="typeGoiDichVuId" value="1">
                                    <button  class="button-custom-form-primary" type="submit"  >Đăng ký</button>
                                </form>
                                {{--                                <a--}}
