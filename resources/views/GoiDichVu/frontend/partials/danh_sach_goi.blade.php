...
{{--                @if($goiDichVu->company_id==$user_company)--}}
                ...
                <div class="col-sm-3">
                    <div
                            ...
                            data-control="vpss"
                            class="col custom-bootstrap-post_type goi_dich_vu"
                            style="max-width: 100%;"
                    >
                        <div data-sticky="" class="eb-hosting-padding col-inner" style="scale: 0.7;
    width: 130%;top:-70px;right:50px; ">
                            <div style="
                            position: absolute;
                            top: -5px;
                            right: -3px;
                            ...
                            align-items: center;
                            font-size: 18px;
                            "> -{{round(($goiDichVu->old_price-$goiDichVu->price)*100/$goiDichVu->old_price)}}%</div>
                            <div class="global-host-post_title" style="  margin-top: -19px;  margin-bottom: 20px; width: 100%">
                                <div style="display:flex; align-items: center; justify-content:center">
                                    <img style="width: 33px" src="https://hostingviet.vn/wp-includes/images/icons/icon-card-title.svg">
                                    <span style="font-size: 33px; padding-top: 4px;margin-left: 4px;">{{$goiDichVu->name}}</span>
                                </div>
                              <div>
                                  <img style="max-width: 100%;margin-top:8px" src="{{asset('/filemanager/userfiles/'.$goiDichVu->image)}}" alt="">
                              </div>
                            </div>
                            <div class="global-host-border global-host-value w-100">
                                <div class="host-config" style="padding: 20px 0; border-top: 1px solid #DFDDDD; text-align: center;">
                                    <div class="card-col-info show"
...
{{--                                1 là tái mua hàng, 0 là mua lần đầu tiên--}}
{{--                                <input type="hidden" id="re_purchase" name="re_purchase" value="{{$total_bill>=1 ? '1' : '0'}}">--}}
{{--                                luôn là mua lần đầu--}}
                                <input type="hidden" id="re_purchase" name="re_purchase" value="0">
{{--                                @if($total_bill>=1)--}}
{{--                                <div class="host-config" style="padding: 20px 0; border-top: 1px solid #DFDDDD; text-align: center;">--}}
{{--                                    <div class="card-col-info show"--}}
{{--                                         style="padding-left: 0;--}}
...
{{--                                    <input data-id="{{$goiDichVu->id}}" type="number" id="quantity-{{$goiDichVu->id}}" name="quantity" value="1" min="1" max="10" style="width:160px; height: 40px; font-size: 24px;">--}}
{{--                                    <select data-id="{{$goiDichVu->id}}" id="quantity-{{$goiDichVu->id}}" name="quantity" style="width:160px; height: 40px; font-size: 24px;">--}}
{{--                                        @for ($i = 1; $i <= 10; $i++)--}}
{{--                                            <option value="{{ $i }}">{{ $i }}</option>--}}
{{--                                        @endfor--}}
{{--                                    </select>--}}
{{--                                    <div--}}
{{--                                            id="gift-{{$goiDichVu->id}}"--}}
{{--                                            class="card-col-info show"--}}
{{--                                            data-type=""--}}
{{--                                            data-key="host_cpu"--}}
{{--                                            style="padding-left: 0px;--}}
...
{{--                                </div>--}}
{{--                                @else--}}
                                    <input hidden data-id="{{$goiDichVu->id}}" type="number" id="quantity-{{$goiDichVu->id}}" name="quantity" value="1" min="1" max="10" style="width:160px; height: 40px; font-size: 24px;">
{{--                                @endif--}}
                                <div class="d-flex align-items-center justify-content-start flex-column price-to-min w-100"
                                     style="margin: 20px 0;
                                            padding: 0
                                        "
...
{{--                                    <p class="ebe-to-price show">Chỉ từ</p>--}}
                                    ...
                                    <p class="ebe-price show">
                                      ...
                                      >
                                    <span class="ebe-currency pay_min" style="text-decoration: line-through; font-size: 20px; display: block; margin-top: 12px;text-align:center"
                                    >{{number_format($goiDichVu->old_price, 0, '.', ',')}}</span
                                    >
                                    </p>
{{--                                    <p>Tổng Giá: <span id="price">{{ $goiDichVu->price }}</span></p>--}}
                                ...
                                >
                                    <p class="ebe-price show"> <span id="price-{{$goiDichVu->id}}" class="ebe-currency pay_min">Tổng Giá: {{number_format($goiDichVu->price, 0, '.', ',')}}</span></p>
                                    <div data-ex_sale="" class="cal-ex_sale"></div>
                                </div>
                                @endif
                            </div>

                            <div class="global-host-btn text-center" style="    display: flex;
    justify-content: center;
    padding-top: 24px;
    flex-wrap: wrap">
{{--                                <form  action="https://hochieu.khoweb.top/payos/create-payment-link" method="POST" target="_blank">--}}
{{--                                    {{ csrf_field() }}--}}
{{--                                    <input id="so_tien" type="hidden" name="soTien" value="{{$goiDichVu->price}}">--}}
{{--                                    <input id="goiDichVuId" type="hidden" name="goiDichVuId" value="{{$goiDichVu->id}}">--}}
{{--                                    <input id="typeGoiDichVuId" type="hidden" name="typeGoiDichVuId" value="2">--}}
{{--                                    <button  class="button-custom-form-primary" type="submit" >Mua ngay</button>--}}
{{--                                </form>--}}
{{--                                @if(\Auth::guard('admin')->user()->roles()->where('name', 'super_admin')->exists())--}}
{{--                                    <button data-id="{{$goiDichVu->id}}" class="button-custom-form-primary admin-khong-mua" type="submit"  >--}}
{{--                                        Mua ngay--}}
{{--                                    </button>--}}
{{--                                @else--}}
{{--                                    <button data-id="{{$goiDichVu->id}}" class="button-custom-form-primary chap-nhan-mua-goi" type="submit" >--}}
{{--                                        Mua ngay--}}
{{--                                    </button>--}}
{{--                                @endif--}}
{{--                                @php--}}
{{--                                    $now = \Carbon\Carbon::now();--}}
{{--                                    $bills = @\Auth::guard('admin')->user()->bill()->count();--}}
{{--//                                    dd($bills);--}}
{{--                                    if($bills<=0){--}}
{{--//                                        dd($bills);--}}
{{--                                        $so_ngay_con_lai = 0;--}}
...
{{--                                    <button data-id="{{$so_ngay_con_lai}}" data-ngay="{{$last_bill}}" class="button-custom-form-primary khong-mua" type="submit"  >--}}
{{--                                        Mua ngay--}}
{{--                                    </button>--}}
{{--                                @else--}}
                                @php
                                    $so_thanh_vien_gioi_thieu = CommonHelper::demSoThanhVienGioiThieu(\Auth()->guard('admin')->user()->id);
                                    $ngay_mua_don_cuoi = Auth::guard('admin')->user()->ngay_mua_don_cuoi;
                                    $checkSoDauTuDaMua=CommonHelper::demSoGoiDauTuDaMua();
                                    //check xem đã mua gói này bao h chưa
                                    $bills = Auth::guard('admin')->user()->bill;
                                    $checkdamuagoi = false;
                                    foreach ($bills as $bill){
                                        if($bill->goi_dich_vu->id == $goiDichVu->id){
                                            $checkdamuagoi = true;
                                            break;
                                        }
                                    }
                                @endphp
{{--                                //nếu chưa có ngày mua đơn cuối chứng tỏ mua lần đầu--}}
                                @if($goiDichVu->type==2)
                                    @if($checkSoDauTuDaMua>=100)
                                        <button disabled data-id="{{$goiDichVu->id}}" class="button-custom-form-primary chap-nhan-mua-goi" type="submit" style="background-color: grey">
                                            Mua ngay
                                        </button>
                                        <div style="color: red;font-size: 20px;
    margin-top: 16px;">Số lượng gói đầu tư đã bán đạt đủ mốc 100 gói </div>
                                    @else
                                        @if(!$checkdamuagoi)
                                            <button data-id="{{$goiDichVu->id}}" class="button-custom-form-primary chap-nhan-mua-goi" type="submit" >
                                                Mua ngay
                                        ...
                                        @else
                                            {{--                                    //chỉ cho phép mua một lần--}}
                                            <button disabled data-id="{{$goiDichVu->id}}" class="button-custom-form-primary chap-nhan-mua-goi" type="submit" style="background-color: grey">
                                                Mua ngay
                                            </button>
                                            {{--                                    @if($so_thanh_vien_gioi_thieu>=3)--}}
                                            {{--                                        <button data-id="{{$goiDichVu->id}}" class="button-custom-form-primary chap-nhan-mua-goi" type="submit" >--}}
                                            {{--                                            Mua ngay--}}
                                            {{--                                        </button>--}}
                                            {{--                                    @else--}}
                                            {{--                                        <button disabled data-id="{{$goiDichVu->id}}" class="button-custom-form-primary chap-nhan-mua-goi" type="submit" >--}}
                                            {{--                                            Mua ngay--}}
                                            {{--                                        </button>--}}
                                            {{--                                        <div style="color: red;font-size: 20px;--}}
                                            {{--    margin-top: 16px;">Bạn phải giới thiệu đủ 3 thành viên mới có thể tái mua</div>--}}
                                            {{--                                    @endif--}}
                                        @endif
                                    @endif
