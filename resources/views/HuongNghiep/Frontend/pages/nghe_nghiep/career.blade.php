...
<div class="wrapper" id="wrapper">
    ...
    <div class="top-menu sticky-container no-print " style="background: rgba(10, 30, 46, 0.9);">
        <div class="small-12 sticky">
            <div class="top-menu__main ">
                <div class="top-menu__left">
                    <nav role="navigation">
                        <ul class="top-menu__list" itemscope="" itemtype="https://schema.org/SiteNavigationElement">
                            <li class="top-menu__logo"><a href="/"><img alt="CareerHunter" class="top-menu__image" width="129" height="25" src="//cdn1.careerhunter.io/assets/CareerHunter-c5d37d4480b8e9fd358ce4d6f1fe629893627bf89acf827c9c68f5fde015b306.svg"></a></li>
                            <li itemprop="name" class=" top-menu__submenu show-for-large">
                                <a itemprop="url" class="top-menu__option">Our Tests <span class="upgrade-icon caret-down"></span></a>
                                <div class="top-menu__submenu-content">
                                    <ul>
                                        <li itemprop="name" class=""><a class="top-menu__option" itemprop="url" href="/tests/interests">Career Interests</a></li>
                                        <li itemprop="name" class=""><a class="top-menu__option" itemprop="url" href="/tests/personality">Work Personality</a></li>
                                        <li itemprop="name" class=""><a class="top-menu__option" itemprop="url" href="/tests/motivators">Career Motivators</a></li>
                                        <li itemprop="name" class=""><a class="top-menu__option" itemprop="url" href="/tests/abstract">Abstract Reasoning</a></li>
                                        <li itemprop="name" class=""><a class="top-menu__option" itemprop="url" href="/tests/numerical">Numerical Reasoning</a></li>
                                        <li itemprop="name" class=""><a class="top-menu__option" itemprop="url" href="/tests/verbal">Verbal Reasoning</a></li>
                                        <li itemprop="name" class=""><a class="top-menu__option" itemprop="url" href="/tests">See all tests</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li itemprop="name" class=" show-for-large"><a class="top-menu__option" itemprop="url" href="/how">How it works</a></li>
                            <li itemprop="name" class=" show-for-large"><a class="top-menu__option" itemprop="url" href="/careers">Careers</a></li>
                            <li itemprop="name" class=" top-menu__submenu show-for-large">
                                <a itemprop="url" class="top-menu__option">Explore <span class="upgrade-icon caret-down"></span></a>
                                <div class="top-menu__submenu-content">
                                    <ul>
                                        <li itemprop="name" class=""><a class="top-menu__option" itemprop="url" href="/courses">Courses</a></li>
                                        <li itemprop="name" class=""><a class="top-menu__option" itemprop="url" href="/jobs">Jobs</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li itemprop="name" class=" show-for-large"><a class="top-menu__option" itemprop="url" href="/upgrade">Full Access</a></li>
                            <li itemprop="name" class=" show-for-large"><a class="top-menu__option" itemprop="url" href="/group">For Educators</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="top-menu__right">
                    <nav role="navigation">
                        <ul class="top-menu__list" itemscope="" itemtype="https://schema.org/SiteNavigationElement">
                            <a href="/login" class="top-menu__login-text hide-for-small-only">Log in</a>
                            <li class="padR10 hide-for-small-only" title="Log in">
                                <a href="/login">
                                    <span class="small-icons login disable-fade-in"></span>
                                </a>
                            </li>
                            <li itemprop="name" class="">
                                <div data-react-class="buttons/getStartedMenuButton" data-react-props="{&quot;user&quot;:null,&quot;deleted&quot;:null,&quot;upgrade_page&quot;:false}" data-react-cache-id="buttons/getStartedMenuButton-0"><div class="buttons-line"><a class="button button--green before-fade-in fade-in button--menu" href="/get-access">Get Access<span class="button__hovered"></span></a></div></div>
                            </li>
                            <li class="top-menu__item   ">
                                <div class="hamburger button button--white" id="toggle-menu">
                                ...
                                <div class="overlay" id="overlay">
                                    <img class="wave-burger-menu hide-for-small-only" loading="lazy" alt="Wave" src="//cdn2.careerhunter.io/assets/wave-burger-menu-23593eb4bcf4bb8ab18e4731e7d0f3fead2a1a02713cf16fb6a07bdde1f71e3f.png">
                                    <div data-react-class="menu/overlay" data-react-props="{&quot;user&quot;:null}" data-react-cache-id="menu/overlay-0"><nav class="text-center"><div class="grid-container"><div class="grid-x align-middle overlay__submenu "><div class="medium-6 cell"><div class="grid-x align-middle overlay__submenu__content "><div class="cell"><ul class="overlay__list overlay__list--navigation"><a class="overlay__link overlay__link--navigation disable-fade-in"><span class="upgrade-icon caret-down left"></span>Tests</a><li><a href="/tests/interests" class="overlay__link">Career Interests</a></li><li><a href="/tests/personality" class="overlay__link">Work Personality</a></li><li><a href="/tests/motivators" class="overlay__link">Career Motivators</a></li><li><a href="/tests/abstract" class="overlay__link">Abstract Reasoning</a></li><li><a href="/tests/numerical" class="overlay__link">Numerical Reasoning</a></li><li><a href="/tests/verbal" class="overlay__link">Verbal Reasoning</a></li><li><a href="/tests" class="overlay__link">See all tests</a></li></ul></div></div></div></div><div class="grid-x align-middle overlay__submenu "><div class="medium-6 cell"><div class="grid-x align-middle overlay__submenu__content"><div class="cell"><ul class="overlay__list overlay__list--navigation"><a class="overlay__link overlay__link--navigation disable-fade-in"><span class="upgrade-icon caret-down left"></span>Explore</a><li><a href="/courses" class="overlay__link">Courses</a></li><li><a href="/jobs" class="overlay__link">Jobs</a></li></ul></div></div></div></div><div class="grid-x align-middle"><div class="medium-6 cell"><ul class="overlay__list overlay__list--navigation"><li class="disable-fade-in"><a class="overlay__link overlay__link--navigation disable-fade-in">Our Tests <span class="upgrade-icon caret-down right"></span></a></li><li class="disable-fade-in"><a href="/how" class="overlay__link overlay__link--navigation disable-fade-in">How it Works</a></li><li class="disable-fade-in"><a href="/careers" class="overlay__link overlay__link--navigation disable-fade-in">Careers</a></li><li class="disable-fade-in"><a class="overlay__link overlay__link--navigation disable-fade-in">Explore <span class="upgrade-icon caret-down right"></span></a></li><li><a href="/upgrade" class="overlay__link overlay__link--navigation disable-fade-in">Full Access</a></li><li class="disable-fade-in"><a href="/group" class="overlay__link overlay__link--navigation disable-fade-in">For Educators</a></li></ul></div><div class="medium-6 cell flex-end"><ul class="overlay__list overlay__list--account"><li class="overlay__gutter"><a href="/register" class="overlay__link overlay__link--info">Register</a> <span>/</span> <a href="/login" class="overlay__link overlay__link--info">Log in <span class="small-icons login"></span></a></li><li><a href="/faq" class="overlay__link overlay__link--info">FAQs</a></li><li><a href="/about" class="overlay__link overlay__link--info">About</a></li><li><a href="/contact" class="overlay__link overlay__link--info">Contact</a></li></ul></div></div></div></nav></div>
                                </div>
                            </li>
                        </ul>
                    </nav>
    ...
    <link rel="stylesheet" media="screen" href="//cdn1.careerhunter.io/assets/career_details-ba23340f54e6aac48cb2ce9c7c40c02d18fd0e03a566dd8576043c3c55e2f08f.css">
         ...
         [
          {
           ...
           "item":
           {
            "@id": "https://www.careerhunter.io/careers",
            "name": "Careers"
            }
          },
          {
          ...
          "item":
           {
             "@id": "https://www.careerhunter.io/careers/airline-pilot",
             "name": "Airline Pilot"
           }
          }
         ]
    ...
    <div itemscope="" itemtype="http://schema.org/Article">
        <meta itemprop="datePublished" content="2020-05-18 10:40:43 UTC">
        <meta itemprop="dateModified" content="2022-11-02 10:12:21 UTC">
        <meta itemprop="url" content="https://www.careerhunter.io/careers/airline-pilot">
        <meta itemprop="articleSection" content="Careers">
        <meta itemprop="description" content="Get a full breakdown of the job responsibilities, salary prospects, essential qualifications and typical working conditions of an airline pilot.">
        <meta itemprop="copyrightHolder" content="www.careerhunter.io">
        <div itemscope="" itemtype="http://schema.org/ImageObject" itemprop="image">
            <meta itemprop="url" content="https://www.careerhunter.io/uploads/images/195/Airline-Pilot.jpg">
        ...
        <div itemscope="" itemtype="http://schema.org/Organization" itemprop="publisher">
            ...
            <div itemscope="" itemtype="http://schema.org/ImageObject" itemprop="logo">
                <meta itemprop="url" content="https://www.careerhunter.io/images/CareerHunter-square-logo.jpg">
                <meta itemprop="width" content="1600">
                <meta itemprop="height" content="900">
            </div>
        </div>
        <div itemprop="mainEntityOfPage" itemscope="" itemtype="http://schema.org/WebPage" itemid="https://www.careerhunter.io/careers/airline-pilot">
            <meta itemprop="url" content="https://www.careerhunter.io/careers/airline-pilot">
            <meta itemprop="name" content="Airline Pilot">
            <meta itemprop="image" content="https://www.careerhunter.io/uploads/images/195/Airline-Pilot.jpg">
        </div>
        <div itemscope="" itemtype="http://schema.org/Person" itemprop="author">
            <meta itemprop="name" content="CareerHunter">
        </div>

        <div class="banner-top career-details" style="background: linear-gradient(rgba(10, 30, 46, 0.8), rgba(10, 30, 46, 0.8)),
           url('https://www.careerhunter.io/uploads/images/195/Airline-Pilot.jpg')">
            <div class="grid-container">
                <div class="grid-x">
                    <div class="small-12 cell breadcrumb-careers no-print">
                        <a class="breadcrumb-careers--link" href="/careers">
                            <span>Careers</span>
                        </a>          <p class="breadcrumb-careers--link"><span>&gt; Airline Pilot</span></p>
                    </div>
                    <div class="large-6 title cell">
                        <p class="career-profile">Career Profile</p>
                        <h1 class="career-title" itemprop="headline">Airline Pilot</h1>
                        <p class="career-names">Aircraft pilot / Airline captain / Airline transport captain / First officer</p>
                    </div>
                    <div class="large-6 cell">
                        <div class="large-flex-end">
                            <div class="match-info-text not-paid">
                                <div data-react-class="careers/careerBubble" data-react-props="{&quot;score&quot;:9,&quot;user&quot;:null}" data-react-cache-id="careers/careerBubble-0"><div class="flex-middle"><p><a href="/tests">Start testing</a> to see how you match!</p><a href="/tests/interests/take"><div class="match-tank pulse_0"><div class="inner"><div class="fill fillAction_0" style="transform: translate(0px, 54.6px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div></a></div></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid-container no-padding-top details-container">
            <div class="career__box--container" itemprop="articleBody">
                <div class="career__box left">
                    <h2 class="career__box__title">Job description</h2>
                    <p></p><p>Airline pilots work in the aviation industry. They operate aircraft, such as commercial jets, to transport people and goods to destinations all over the world. As an airline pilot, you will fly aeroplanes on short- or long-haul flights for airlines of all sizes, usually on scheduled air carrier routes.</p><p></p>
                </div>

                <div class="career__box left">
                    <h2 class="career__box__title">Duties</h2>
                    <div>
                        <ul class="green-list">
                            <ul>
                                <li class="before-fade-in fade-in">Carry out pre-flight checks of engines, instruments, fuel and safety systems</li>
                                <li class="before-fade-in fade-in">Ensure the aircraft is below its weight limit</li>
                                <li class="before-fade-in fade-in">Create a flight plan, using weather reports and information from air traffic control</li>
                                <li class="before-fade-in fade-in">Communicate with air traffic control before take-off and during flight and landing</li>
                                <li class="before-fade-in fade-in">Navigate the aircraft along planned routes by using cockpit instruments and visual references</li>
                                <li class="before-fade-in fade-in">Check data during the flight and adjust the route where necessary</li>
                                <li class="before-fade-in fade-in">Communicate with passengers using the public address system</li>
                                <li class="before-fade-in fade-in">Brief the cabin crew before the flight and maintain regular contact throughout the flight</li>
                                <li class="before-fade-in fade-in">Ensure the safety and comfort of passengers, cabin crew and aircraft</li>
                                <li class="before-fade-in fade-in">Update the aircraft logbook and write a report after each flight, noting any incidents or problems</li>
                            </ul>
                        </ul>
                    </div>
                </div>
                ...
                <div class="career__box left">
                    <h2 class="career__box__title before-fade-in fade-in">Skills and qualities</h2>
                    <div class="grid-x grid-padding-x career__box__skill__set">
                        <div class="career__box__skill">
                            <div class="cell auto">
                                Communication
                            </div>
                        </div>
                ...
                <div class="career__box left">
                    <h2 class="career__box__title before-fade-in fade-in">Job outlook</h2>
                    <div class="career__box__categories career__box--outlook">
                        <div class="career__box__types">
                            <h3 class="before-fade-in fade-in">Projected growth
                                <div class="tooltip-trigger align-left small-icons grey-off-tooltip before-fade-in fade-in">
                                    <span class="tooltip top">The projected growth rate of employment in the US from 2016 to 2026, based on data collected through the BLS Employment Projections (EP) programme. The national average growth rate for all professions is 7%.</span>
                                </div>
                            </h3>
                            <p class="career__box__top before-fade-in fade-in">3%</p>
                        </div>
                        <div class="career__box__types">
                            <h3 class="before-fade-in fade-in">New jobs
                                <div class="tooltip-trigger align-left small-icons grey-off-tooltip before-fade-in fade-in">
                                    <span class="tooltip top">The number of jobs projected to become available in the US between 2016 and 2026, based on data collected through the BLS Employment Projections (EP) programme.</span>
                                </div>
                            </h3>
                            <p class="career__box__low before-fade-in fade-in">2.9k</p>
                        </div>
                        <div class="career__box__types">
                            <h3 class="before-fade-in fade-in">Automation risk
                                <div class="tooltip-trigger align-left small-icons grey-off-tooltip before-fade-in fade-in">
                                    <span class="tooltip top">The probability of computerisation, based on data published in ‘The Future of Employment’, a 2013 working paper by Carl Benedikt Frey and Michael Osborne.</span>
                                </div>
                            </h3>
                            <p class="career__box__top before-fade-in fade-in">18%</p>
                        </div>
                    </div>
                </div>

                <div class="career__box left">
                    <h2 class="career__box__title before-fade-in fade-in">Career progression</h2>
                    <div>
                        <p class="before-fade-in fade-in">You will typically begin your career as a flight engineer before advancing to a first officer position and, after 5 to 15 years, to a captain position. With experience, you could become a flight training instructor or an air accident investigator.</p>
                    </div>
                </div>

                <div class="career__box green-list">
                    <h2 class="career__box__title career__box__title--center">Working conditions</h2>
                    <div class="career__box__categories">
                        <div class="career__box__types">
                            <h3>Average hours</h3>
                            <p class="career__box__low">40h<sup>/ week</sup></p>

                        </div>
                        <div class="career__box__types">
                            <h3>Typical schedule</h3>
                            <p class="career__box__education">Shift Work</p>
                            <p class="career__box__degree">Nights, weekends and holidays</p>
                        </div>
                    </div>
                    <div>
                        <p>Airline pilots are limited to flying a total of 100 hours per month, or 1,000 hours per year, as regulated by the Federal Aviation Administration (FAA). They typically fly 75 to 80 hours a month and spend an additional 150 hours each month performing other duties such as preparing flight plans.</p>
                        <p class="before-fade-in fade-in">Though work schedules are variable, the FAA requires a minimum of an eight-hour break between shifts, while flight assignments often involve overnight layovers. Airlines will typically cover accommodation, meals, airport transportation and other expenses for pilots when spending time away from home, and if you’ve worked at an airline for a long time, you can choose the routes and schedules you prefer.</p>
                        <p class="before-fade-in fade-in">As an airline pilot, fatigue and jetlag are common, as you will work long hours and travel into different time zones. It is also a highly stressful profession, as you are responsible for the safety of your passengers.</p>
                    </div>
                </div>

                <div class="career__box">
                    <h2 class="career__box__title career__box__title--center before-fade-in fade-in">Salary</h2>
                    <div class="career__box__categories">
                        <div class="career__box__types">
                            <h3 class="before-fade-in fade-in">Bottom 10%</h3>
                            <p class="career__box__low before-fade-in fade-in">$66k</p>
                        </div>
                        <div class="career__box__types">
                            <h3 class="before-fade-in fade-in">Median</h3>
                            <p class="career__box__median before-fade-in fade-in">$140k</p>
                        </div>
                        <div class="career__box__types">
                            <h3 class="before-fade-in fade-in">Top 10%</h3>
                            <p class="career__box__top before-fade-in fade-in">$210k</p>
                        </div>
                    </div>
                    <div class="career__box__tip"><p class="before-fade-in fade-in">Annual salary estimates are based on percentile wage data collected through the Occupational Employment Statistics (OES) survey of US workers.</p></div>
                </div>

                <div class="career__box green-list">
                    <h2 class="career__box__title career__box__title--center before-fade-in fade-in">Qualifications and training</h2>
                    <div class="career__box__categories">
                        <div class="career__box__types">
                            <h3 class="before-fade-in fade-in">Education level</h3>
                            <p class="career__box__education before-fade-in fade-in">Undergraduate</p>
                            <p class="career__box__degree before-fade-in fade-in">Bachelor’s degree in aviation or related field</p>
                        </div>
                        <div class="career__box__types">
                            <h3 class="before-fade-in fade-in">Study time</h3>
                            <p class="career__box__low before-fade-in fade-in">4
                                <sup>years</sup></p>

                        </div>
                    </div>
                    <div>
                        <p class="before-fade-in fade-in">In addition to a bachelor’s degree (which can be in any subject, although a degree in aviation or aeronautical sciences is preferable), you’ll need to obtain a commercial pilot’s licence from the FAA and the FAA-issued Airline Transport Pilot (ATP) certificate.</p>
                    </div>
                </div>

                <div class="career__box left">
                    <p class="before-fade-in fade-in">Sources</p>
                    <a class="career__box__source before-fade-in fade-in" target="_blank" rel="nofollow" href="https://www.bls.gov/ooh/transportation-and-material-moving/airline-and-commercial-pilots.htm">Bureau of Labor Statistics</a>
                    <a class="career__box__source before-fade-in fade-in" target="_blank" rel="nofollow" href="https://www.faa.gov/">Federal Aviation Administration (FAA)</a>
                    <a class="career__box__source before-fade-in fade-in" target="_blank" rel="nofollow" href="https://www.oxfordmartin.ox.ac.uk/publications/the-future-of-employment/">Oxford Martin School</a>
                </div>
                <p class="career__box__last-updated text-right before-fade-in fade-in">Last Updated: Wednesday, November 2, 2022 </p>
            </div>



            <div data-react-class="careers/lazyWidget" data-react-props="{&quot;user&quot;:null,&quot;options&quot;:{&quot;id&quot;:14},&quot;type&quot;:&quot;similar&quot;,&quot;title&quot;:&quot;Similar Careers&quot;,&quot;random&quot;:true}" data-react-cache-id="careers/lazyWidget-0"><div class="grid-x widget__cards widget-section"><div class="large-5 cell"><h2 class="widget__spaced widget__spaced--cards">Similar Careers</h2></div><div class="large-7 cell"><div class="widget__spaced widget__spaced--cards flex large-flex-end"><div class="capsule capsule--status capsule--widget widget-right"><span class="small-icons white-tooltip-icon"></span><span class="capsule__status"><a href="/upgrade" class="capsule__link">Get your career matches by completing all tests</a></span></div><a class="button button--white hide-for-small-only" href="/careers">See all careers</a></div></div><div class="small-12 cell"><div class="careers-slider careers-widget-slider is-overlapping"><div class="grid-x"><div class="large-3 medium-6 small-12 cell show-for-large"><div class="card card--careers "><a href="/careers/aircrew-member" class="disable-fade-in"><div class="card__image" style="background-image: url(&quot;https://www.careerhunter.io/uploads/images/434/small-Aircrew-Member.jpg&quot;);"></div><div class="card__section card__section--careers"><p class="card__name disable-fade-in">Aircrew Member</p><p class="card__salary">$0-$0 annually</p><p class="card__education">N/A growth | Undergraduate | 4 years</p><p class="card__link">Go to Career <span class="small-icons next-arrow-green-xs"></span></p></div><div class="match-tank pulse_6"><div class="inner"><div class="fill fillAction_6" style="transform: translate(0px, 20.4px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="match-tank pulse_6"><div class="inner"><div class="fill fillAction_6" style="transform: translate(0px, 20.4px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="card__hover"></div></a></div></div><div class="large-3 medium-6 small-12 cell show-for-large"><div class="card card--careers "><a href="/careers/locomotive-engineer" class="disable-fade-in"><div class="card__image" style="background-image: url(&quot;https://www.careerhunter.io/uploads/images/318/small-Locomotive-Engineer.jpg&quot;);"></div><div class="card__section card__section--careers"><p class="card__name disable-fade-in">Locomotive Engineer</p><p class="card__salary">$46K-$98K annually</p><p class="card__education">-2% growth | High school | 3 months</p><p class="card__link">Go to Career <span class="small-icons next-arrow-green-xs"></span></p></div><div class="match-tank pulse_3"><div class="inner"><div class="fill fillAction_3" style="transform: translate(0px, 39px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="match-tank pulse_3"><div class="inner"><div class="fill fillAction_3" style="transform: translate(0px, 39px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="card__hover"></div></a></div></div><div class="large-3 medium-6 small-12 cell show-for-large"><div class="card card--careers "><a href="/careers/flight-attendant" class="disable-fade-in"><div class="card__image" style="background-image: url(&quot;https://www.careerhunter.io/uploads/images/280/small-Flight-Attendant.jpg&quot;);"></div><div class="card__section card__section--careers"><p class="card__name disable-fade-in">Flight Attendant</p><p class="card__salary">$29K-$81K annually</p><p class="card__education">10% growth | High school | 6 weeks</p><p class="card__link">Go to Career <span class="small-icons next-arrow-green-xs"></span></p></div><div class="match-tank pulse_3"><div class="inner"><div class="fill fillAction_3" style="transform: translate(0px, 42px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="match-tank pulse_3"><div class="inner"><div class="fill fillAction_3" style="transform: translate(0px, 42px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="card__hover"></div></a></div></div><div class="large-3 medium-6 small-12 cell show-for-large"><div class="card card--careers "><a href="/careers/maritime-pilot" class="disable-fade-in"><div class="card__image" style="background-image: url(&quot;https://www.careerhunter.io/uploads/images/325/small-Maritime-Pilot.jpg&quot;);"></div><div class="card__section card__section--careers"><p class="card__name disable-fade-in">Maritime Pilot</p><p class="card__salary">$35K-$150K annually</p><p class="card__education">-2% growth | High school | 2 years</p><p class="card__link">Go to Career <span class="small-icons next-arrow-green-xs"></span></p></div><div class="match-tank pulse_9"><div class="inner"><div class="fill fillAction_9" style="transform: translate(0px, 6px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="match-tank pulse_9"><div class="inner"><div class="fill fillAction_9" style="transform: translate(0px, 6px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="card__hover"></div></a></div></div><div class="small-12 cell hide-for-large"><div class="careers-slider"><div class="slick-slider slick-initialized" dir="ltr"><div class="slick-list"><div class="slick-track" style="opacity: 1; transform: translate3d(0px, 0px, 0px); width: 1120px;"><div data-index="0" class="slick-slide slick-active slick-current" tabindex="-1" aria-hidden="false" style="outline: none; width: 280px;"><div><div class="card card--careers "><a href="/careers/aircrew-member" class="disable-fade-in"><div class="card__image" style="background-image: url(&quot;https://www.careerhunter.io/uploads/images/434/small-Aircrew-Member.jpg&quot;);"></div><div class="card__section card__section--careers"><p class="card__name disable-fade-in">Aircrew Member</p><p class="card__salary">$0-$0 annually</p><p class="card__education">N/A growth | Undergraduate | 4 years</p><p class="card__link">Go to Career <span class="small-icons next-arrow-green-xs"></span></p></div><div class="match-tank pulse_6"><div class="inner"><div class="fill fillAction_6" style="transform: translate(0px, 20.4px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="match-tank pulse_6"><div class="inner"><div class="fill fillAction_6" style="transform: translate(0px, 20.4px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="card__hover"></div></a></div></div></div><div data-index="1" class="slick-slide slick-active" tabindex="-1" aria-hidden="false" style="outline: none; width: 280px;"><div><div class="card card--careers "><a href="/careers/locomotive-engineer" class="disable-fade-in"><div class="card__image" style="background-image: url(&quot;https://www.careerhunter.io/uploads/images/318/small-Locomotive-Engineer.jpg&quot;);"></div><div class="card__section card__section--careers"><p class="card__name disable-fade-in">Locomotive Engineer</p><p class="card__salary">$46K-$98K annually</p><p class="card__education">-2% growth | High school | 3 months</p><p class="card__link">Go to Career <span class="small-icons next-arrow-green-xs"></span></p></div><div class="match-tank pulse_3"><div class="inner"><div class="fill fillAction_3" style="transform: translate(0px, 39px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="match-tank pulse_3"><div class="inner"><div class="fill fillAction_3" style="transform: translate(0px, 39px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="card__hover"></div></a></div></div></div><div data-index="2" class="slick-slide slick-active" tabindex="-1" aria-hidden="false" style="outline: none; width: 280px;"><div><div class="card card--careers "><a href="/careers/flight-attendant" class="disable-fade-in"><div class="card__image" style="background-image: url(&quot;https://www.careerhunter.io/uploads/images/280/small-Flight-Attendant.jpg&quot;);"></div><div class="card__section card__section--careers"><p class="card__name disable-fade-in">Flight Attendant</p><p class="card__salary">$29K-$81K annually</p><p class="card__education">10% growth | High school | 6 weeks</p><p class="card__link">Go to Career <span class="small-icons next-arrow-green-xs"></span></p></div><div class="match-tank pulse_3"><div class="inner"><div class="fill fillAction_3" style="transform: translate(0px, 42px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="match-tank pulse_3"><div class="inner"><div class="fill fillAction_3" style="transform: translate(0px, 42px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="card__hover"></div></a></div></div></div><div data-index="3" class="slick-slide" tabindex="-1" aria-hidden="true" style="outline: none; width: 280px;"><div><div class="card card--careers "><a href="/careers/maritime-pilot" class="disable-fade-in"><div class="card__image" style="background-image: url(&quot;https://www.careerhunter.io/uploads/images/325/small-Maritime-Pilot.jpg&quot;);"></div><div class="card__section card__section--careers"><p class="card__name disable-fade-in">Maritime Pilot</p><p class="card__salary">$35K-$150K annually</p><p class="card__education">-2% growth | High school | 2 years</p><p class="card__link">Go to Career <span class="small-icons next-arrow-green-xs"></span></p></div><div class="match-tank pulse_9"><div class="inner"><div class="fill fillAction_9" style="transform: translate(0px, 6px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="match-tank pulse_9"><div class="inner"><div class="fill fillAction_9" style="transform: translate(0px, 6px);"><svg version="1.1" x="0px" y="0px" width="88px" height="88px" viewBox="0 0 88 88" enable-background="new 0 0 88 88"><path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path></svg></div></div><div class="match-percent hidden "><div class="qm">?</div>match</div></div><div class="card__hover"></div></a></div></div></div></div></div></div></div></div></div></div></div><div class="small-12 show-for-small-only mar-top-20"><a class="button button--white" href="/careers">See all careers</a></div></div></div>
            <div class="grid-x mar-top-20">
                <div class="small-12 cell">
                    <div class="career-bottom-containers lar-pad-r5">
                        <img class="wave-top wave-top-small before-fade-in fade-in" loading="lazy" alt="Perfect career wave" src="//cdn3.careerhunter.io/assets/wave-search-jobs-start-da6dcbe4212f6a7caff34f095ecf09e99b83985175e8638eba97c36ccf44b8fa.png">
                        <div class="grid-x">
                            <div class="small-12 cell">
                                <h2 class="career-bottom-containers__headline-small before-fade-in fade-in">Search for jobs</h2>
                                <h4 class="career-bottom-containers__desc career-bottom-containers__desc--double before-fade-in fade-in">Find airline pilot
                                    vacancies near you</h4>
                            </div>
                            <div class="small-12 cell career-bottom-containers__search">
                                <div data-react-class="jobs/smallSearchBlock" data-react-props="{&quot;q&quot;:&quot;Airline Pilot&quot;,&quot;location&quot;:&quot;Vietnam&quot;}" data-react-cache-id="jobs/smallSearchBlock-0"><div class="expanding-search expanding-search--careers expanding-search expanding-search--term"><label class="expanding-search__label active" title="search"><span class="small-icons expanding-search__icon expanding-search__icon--magnify magnify-left-s"></span></label><div><input placeholder="Job Title" type="text" name="searchQuery" class="search-field expanding-search__input active" role="combobox" aria-autocomplete="list" aria-expanded="false" autocomplete="off" value="Airline Pilot"></div></div><div class="expanding-search expanding-search--line show-for-large"></div><div class="expanding-search expanding-search--location expanding-search--careers"><label class="expanding-search__label active" title="location"><span class="small-icons expanding-search__icon expanding-search__icon--location location-icon"></span></label><div><input placeholder="Location" type="text" name="location" class="location-field expanding-search__input active" role="combobox" aria-autocomplete="list" aria-expanded="false" autocomplete="off" value="Vietnam"></div></div><button class="button button--white before-fade-in fade-in button--with-icon search-button">Search<span class="small-icons next-arrow-blue"></span><span class="button__hovered"></span></button></div>
                            </div>
                        </div>
                        <div class="circle right-large hide-for-small-only"><div class="large-icon white-magnifying-glass before-fade-in fade-in"></div></div>
                        <div class="circle right-small hide-for-small-only"><div class="large-icon climber before-fade-in fade-in"></div></div>
                        <div class="circle right-xsmall hide-for-small-only"></div>
                        <div class="circle right-medium hide-for-small-only"><div class="large-icon hands-deal before-fade-in fade-in"></div></div>
                    </div>
                </div>
        ...
        <div data-react-class="adBanners/lazyPromo" data-react-props="{&quot;banner_code_prefix&quot;:&quot;careers&quot;}" data-react-cache-id="adBanners/lazyPromo-0"><div class="fade-in"><div class="fade-in"><div class="grid-container no-padding-top full-width"><div><div class="grid-x testing-banner testing-banner--with-space">
                                <div class="large-7 medium-12 cell testing-banner__left-blk--padding testing-banner__left-blk-large large-order-1 medium-order-2 small-order-2">
                                    <p class="testing-banner__title">Reveal your career matches</p>
                                    <ul class="testing-banner__list">
                                        <li class="testing-banner__point">
                                            <h3 class="testing-banner__text">Access all 6 tests and complete reporting</h3>
                                        </li>
                                        <li class="testing-banner__point">
                                            <h3 class="testing-banner__text">Uncover your final career matches</h3>
                                        </li>
                                        <li class="testing-banner__point">
                                            <h3 class="testing-banner__text">Get a personalized 400-page report</h3>
                                        </li>
                                    </ul>
                                    <div class="testing-banner__buttons-block">
                                        <a class="button button--big button--green button--with-icon" href="/checkout" onmouseenter="handleButtonOnHover(event)">Get full access <span class="small-icons next-arrow-white-xs"></span><span class="button__hovered"></span></a>
                                    </div>
                                </div>
                                <div class="large-5 medium-12 cell testing-banner__right-blk--padding testing-banner__right-blk-large large-order-2 medium-order-1 small-order-1">
                                    <div class="testing-banner__img testing-banner__img--medium"></div>
                                </div>
