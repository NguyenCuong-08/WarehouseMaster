...
<head>
    ...
    <link rel="stylesheet" media="all"
          href="{{ asset('HuongNghiep/news_page/cdn2.careerhunter.io/assets/application-349b29af163d5822a096212e2dd202386f20dc4d2f59953f2fd3e210070ad75c.css')}}">
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W9FK75H" height="0" width="0"
                    ...
                    <nav role="navigation">
                        <ul class="top-menu__list" itemscope="" itemtype="https://schema.org/SiteNavigationElement">
                            <li class="top-menu__logo"><a href="index.html"><img alt="CareerHunter"
                                                                                 class="top-menu__image" width="129"
                                                                                 height="25"
                                                        ...
                                                        <ul class="overlay__list overlay__list--account">
                                                            <li class="overlay__gutter"><a href="/register"
                                                                ...
                                                                <span>/</span> <a href="/login"
                                                                                  class="overlay__link overlay__link--info">Log
                                                                    in
                        ...
                        <div class="grid-x spaced-between padT10 flex-middle">
                            ...
                            <div class="filter-menu small-order-3 large-order-2">
                                ...
                                <div class="filter-menu__buttons" style="display: block;">
                                    <button
                                            class="button button--white before-fade-in fade-in filter-menu__buttons__item hide-at-large">
                                        Filter<span
                                                            ...
                                                            <div class="grid-container filters-selection">
                                                                <div class="tabs-panel is-active">
                                                                    ...
                                                                    <div class="flex-center filters__apply">
                                                                        <button
                                                                                class="button button--filter before-fade-in fade-in">
                                                                            Done<span
                                                                                    class="button__hovered"></span>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="tabs-panel" style="height: 320px;">
                                            <div class="aligned-checkboxes flex-center filters__options">
                                                <div class="aligned-checkboxes__item input-tick"><label><input
                                                        ...
                                                        <span class="check-text">No education</span>
                                                    </label></div>
                                                <div class="aligned-checkboxes__item input-tick"><label><input
                                                        ...
                                                        <span class="check-text">High school</span>
                                                    </label></div>
                                                <div class="aligned-checkboxes__item input-tick"><label><input
                                                        ...
                                                        <span class="check-text">Undergraduate</span>
                                                    </label></div>
                                                <div class="aligned-checkboxes__item input-tick"><label><input
                                                        ...
                                                        <span class="check-text">Postgraduate</span>
                                                    </label></div>
                                                <div class="aligned-checkboxes__item input-tick"><label><input
                                                        ...
                                                        <span class="check-text">Vocational</span>
                                                    </label></div>
                                            </div>
                                            <div class="flex-center filters__apply">
                                                <button
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                    ...
                    <div class="large-3 medium-6 small-12 cell">
                        <div class="card card--careers "><a href="/careers/financial-manager"
                                ...
                                <div class="match-tank pulse_8">
                                    <div class="inner">
                                        <div class="fill fillAction_8" style="transform: translate(0px, 9px);">
                                            <svg
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                    ...
                    <div class="large-3 medium-6 small-12 cell">
                        <div class="card card--careers "><a href="/careers/physicist" class="disable-fade-in">
                                ...
                                <div class="match-tank pulse_2">
                                    <div class="inner">
                                        <div class="fill fillAction_2" style="transform: translate(0px, 45px);">
                                            <svg
                                                    version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                    ...
                    <div class="large-3 medium-6 small-12 cell">
                        <div class="card card--careers "><a href="/careers/actuary" class="disable-fade-in">
                                ...
                                <div class="match-tank pulse_2">
                                    <div class="inner">
                                        <div class="fill fillAction_2" style="transform: translate(0px, 48px);">
                                            <svg
                                                    version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                    ...
                    <div class="large-3 medium-6 small-12 cell">
                        <div class="card card--careers "><a href="/careers/art-director" class="disable-fade-in">
                                ...
                                <div class="match-tank pulse_6">
                                    <div class="inner">
                                        <div class="fill fillAction_6" style="transform: translate(0px, 24px);">
                                            <svg
                                                    version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
...
<link rel="stylesheet" media="screen"
      href="{{ asset('HuongNghiep/news_page/cdn3.careerhunter.io/assets/application_bottom-93d8a0a27799f58aa78e27c62f1927bfc111998fe47b308085b383a581c507ba.css') }}"
      defer="defer">


<script
        src="{{ asset('HuongNghiep/news_page/cdn0.careerhunter.io/assets/application-353dcd5078ea9b9428db0a401e52fca71d68824b66555302b545456e24759fb7.js') }}"></script>
...
<!-- <script src="../cdn3.careerhunter.io/packs/js/application_upgrade-2384eb8adcf4c66f36fd.chunk.js"
    defer="defer"></script> -->
<script src="{{ asset('HuongNghiep/news_page/cdn2.careerhunter.io/packs/js/application-c7138677c407a1b2b03e.js') }}"
        defer="defer"></script>
