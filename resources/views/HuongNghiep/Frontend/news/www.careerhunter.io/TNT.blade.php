...
<head>
    ...
    <script async="" src="../www.googletagmanager.com/gtm5445.html?id=GTM-W9FK75H"></script>
...
<body class="webp">
    ...
    <div class="wrapper" id="wrapper">
        ...
        <div class="top-menu sticky-container no-print " style="background: transparent;">
            <div class="small-12 sticky">
                <div class="top-menu__main ">
                    <div class="top-menu__left">
                        <nav role="navigation">
                            <ul class="top-menu__list" itemscope="" itemtype="https://schema.org/SiteNavigationElement">
                                <li class="top-menu__logo"><a href="index.html"><img alt="CareerHunter"
                                            class="top-menu__image" width="129" height="25"
                                ...
                                <!-- <li itemprop="name" class=" top-menu__submenu show-for-large">
                                    <a itemprop="url" class="top-menu__option">Our Tests <span
                                            class="upgrade-icon caret-down"></span></a>
                                ...
                                <li itemprop="name" class=" top-menu__submenu show-for-large">
                                    <a itemprop="url" class="top-menu__option">Explore <span
                                            class="upgrade-icon caret-down"></span></a>
                                    <div class="top-menu__submenu-content">
                                        <ul>
                                            <li itemprop="name" class=""><a class="top-menu__option" itemprop="url"
                            ...
                            <ul class="top-menu__list" itemscope="" itemtype="https://schema.org/SiteNavigationElement">
                                ...
                                <li itemprop="name" class="">
                                    <div data-react-class="buttons/getStartedMenuButton"
                                        ...
                                        data-react-cache-id="buttons/getStartedMenuButton-0">
                                        <!-- <div class="buttons-line"><a
                                                class="button button--green before-fade-in fade-in button--menu"
                                                href="/get-access">Get Access<span class="button__hovered"
                                                    style="top: 39px; left: 17.4688px;"></span></a></div> -->
                                    </div>
                                </li>
                                <li class="top-menu__item   ">
                                    ...
                                    <div class="overlay" id="overlay">
                                        ...
                                        <div data-react-class="menu/overlay" data-react-props="{&quot;user&quot;:null}"
                                            data-react-cache-id="menu/overlay-0">
                                            <nav class="text-center">
                                                <div class="grid-container">
                                                    <div class="grid-x align-middle overlay__submenu ">
                                                        <div class="medium-6 cell">
                                                            <div class="grid-x align-middle overlay__submenu__content ">
                                                                <div class="cell">
                                                                    <ul class="overlay__list overlay__list--navigation">
                                                                        <a
                                                                            class="overlay__link overlay__link--navigation disable-fade-in"><span
                                                                                class="upgrade-icon caret-down left"></span>Tests</a>
                                                                        <li><a href="/tests/interests"
                                                                                class="overlay__link">Career
                                                                                Interests</a></li>
                                                                        <li><a href="/tests/personality"
                                                                                class="overlay__link">Work
                                                                                Personality</a></li>
                                                                        <li><a href="/tests/motivators"
                                                                                class="overlay__link">Career
                                                                                Motivators</a></li>
                                                                        <li><a href="/tests/abstract"
                                                                                class="overlay__link">Abstract
                                                                                Reasoning</a></li>
                                                                        <li><a href="/tests/numerical"
                                                                                class="overlay__link">Numerical
                                                                                Reasoning</a></li>
                                                                        <li><a href="/tests/verbal"
                                                                                class="overlay__link">Verbal
                                                                                Reasoning</a></li>
                                                                        <li><a href="/tests" class="overlay__link">See
                                                                                all tests</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="grid-x align-middle overlay__submenu__content">
                                                                <div class="cell">
                                                                    <ul class="overlay__list overlay__list--navigation">
                                                                        <a
                                                                            class="overlay__link overlay__link--navigation disable-fade-in"><span
                                                                                class="upgrade-icon caret-down left"></span>Explore</a>
                                                                        <li><a href="/courses"
                                                                                class="overlay__link">Courses</a></li>
                                                                        <li><a href="/jobs"
                                                                                class="overlay__link">Jobs</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="grid-x align-middle">
                                                        <div class="medium-6 cell">
                                                            <ul class="overlay__list overlay__list--navigation">
                                                                <li class="disable-fade-in"><a
                                                                        class="overlay__link overlay__link--navigation disable-fade-in">Our
                                                                        Tests <span
                                                                            class="upgrade-icon caret-down right"></span></a>
                                                                </li>
                                                                <li class="disable-fade-in"><a href="/how"
                                                                        class="overlay__link overlay__link--navigation disable-fade-in">How
                                                                        it Works</a></li>
                                                                <li class="disable-fade-in"><a href="/careers"
                                                                        class="overlay__link overlay__link--navigation disable-fade-in">Careers</a>
                                                                </li>
                                                                <li class="disable-fade-in"><a
                                                                        class="overlay__link overlay__link--navigation disable-fade-in">Explore
                                                                        <span
                                                                            class="upgrade-icon caret-down right"></span></a>
                                                                </li>
                                                                <li><a href="/upgrade"
                                                                        class="overlay__link overlay__link--navigation disable-fade-in">Full
                                                                        Access</a></li>
                                                                <li class="disable-fade-in"><a href="/group"
                                                                        class="overlay__link overlay__link--navigation disable-fade-in">For
                                                                        Educators</a></li>
                                                            </ul>
                                                        </div>
                                                        <div class="medium-6 cell flex-end">
                                                            <ul class="overlay__list overlay__list--account">
                                                                <li class="overlay__gutter"><a href="/register"
                                                                        class="overlay__link overlay__link--info">Register</a>
                                                                    <span>/</span> <a href="/login"
                                                                        class="overlay__link overlay__link--info">Log in
                                                                        <span class="small-icons login"></span></a></li>
                                                                <li><a href="/faq"
                                                                        class="overlay__link overlay__link--info">FAQs</a>
                                                                </li>
                                                                <li><a href="/about"
                                                                        class="overlay__link overlay__link--info">About</a>
                                                                </li>
                                                                <li><a href="/contact"
                                                                        class="overlay__link overlay__link--info">Contact</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                    ...
                    <div class="filter-area__container">
                        <div class="grid-container no-padding">
                            <div class="grid-x">
                                ...
                                <!-- <div class="large-6 cell flex-end show-for-large">
                                    <p class="filter-area__info"><span
                        ...
                        <div class="grid-container no-padding-top inner-bottom">
                            <div class="grid-x spaced-between padT10 flex-middle">
                                <div>
                                    <p class="courses__heading">Browse our database of popular careers</p>
                                    <p class="filter-area__info hide-for-large"><span
                                            class="small-icons grey-tooltip-icon"></span>Complete all tests to reveal
                                        your matches</p>
                                </div>
                                <div class="filter-menu small-order-3 large-order-2">
                                    <p class="filter-text flex-center desktop-filter">Filter by</p>
                                    <ul class="desktop-filter tabs filter-tabs ">
                                        <li class="filter-tabs__title"><a class="filter-tabs__link">Suitability</a></li>
                                        <li class="filter-tabs__title"><a class="filter-tabs__link">Salary</a></li>
                                        <li class="filter-tabs__title"><a class="filter-tabs__link">Growth</a></li>
                                        <li class="filter-tabs__title"><a class="filter-tabs__link">Education</a></li>
                                        <li class="filter-tabs__title hide-at-large"><a
                                                class="filter-tabs__link">Search</a></li>
                                    </ul>
                                    <div class="filter-menu__buttons" style="display: block;"><button
                                            class="button button--white before-fade-in fade-in filter-menu__buttons__item hide-at-large">Filter<span
                                                class="button__hovered"></span></button>
                                        <div class="search-bars__container hide-at-medium-down">
                                            <div
                                                class="expanding-search expanding-search--term small-order-1 large-order-2">
                                ...
                                <div class="filters-container small-order-2 large-order-3 hide-at-medium-down">
                                    <div class="filters-wrapper filter-tabs">
                                        <div class="grid-container filters-selection">
                                                    ...
                                                    <div class="tabs-container">
                                                        <div class="tabs-content">
                                                            <ul class="tabs filter-tabs ">
                                                                <li class="filter-tabs__title"><a
                                                                        class="filter-tabs__link">Suitability</a></li>
                                                                <li class="filter-tabs__title"><a
                                                                        class="filter-tabs__link">Salary</a></li>
                                                                <li class="filter-tabs__title"><a
                                                                        class="filter-tabs__link">Growth</a></li>
                                                                <li class="filter-tabs__title"><a
                                                                        class="filter-tabs__link">Education</a></li>
                                                                <li class="filter-tabs__title"><a
                                                                        class="filter-tabs__link">Search</a></li>
                                                            </ul>
                                                        </div>
                                            ...
                                            <div class="tabs-panel" style="height: 320px;">
                                                            ...
                                                            <ul class="tabs filter-tabs ">
                                                                <li class="filter-tabs__title is-active"><a
                                                                        class="filter-tabs__link">Interests <span
                                                                            class="dot"></span></a></li>
                                                                <li class="filter-tabs__title"><a
                                                                        class="filter-tabs__link">Personality </a></li>
                                                                <li class="filter-tabs__title"><a
                                                                        class="filter-tabs__link">Motivator </a></li>
                                                                <li class="filter-tabs__title"><a
                                                                        class="filter-tabs__link">Match % </a></li>
                                                            </ul>
                                                        </div>
                                                            ...
                                                            <div class="filters-wrapper sub-filters filter-tabs">
                                                                <div class="grid-container filters-selection">
                                                                    <div class="tabs-panel is-active">
                                                                        <div
                                                                            class="grid-x grid-padding-x mar-top-10 mar-bot-10 filters__options">
                                                                        </div>
                                                                        <div class="flex-center filters__apply"><button
                                                                                class="button button--filter before-fade-in fade-in">Done<span
                                                                                    class="button__hovered"></span></button>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="tabs-panel">
                                                                        <div class="full-height">
                                                                            <h2 class="no-matches-text text-center">You
                                                                                don't have any career matches yet!</h2>
                                                                            <a class="button button--with-icon button--green button--green--medium"
                                                ...
                                                <div class="flex-center filters__apply"><button
                                                        class="button button--filter before-fade-in fade-in">Done<span
                                                            class="button__hovered"></span></button></div>
                                            </div>
                                            <div class="tabs-panel" style="height: 320px;">
                                                <div class="aligned-checkboxes flex-center filters__options">
                                                    <div class="aligned-checkboxes__item input-tick"><label><input
                                                            ...
                                                            </div><span class="check-text">No education</span>
                                                        </label></div>
                                                    <div class="aligned-checkboxes__item input-tick"><label><input
                                                                type="checkbox" name="high_school" value="false">
                                                            <div class="checkbox-material">
                                                                <div class="custom-checkbox"></div>
                                                            </div><span class="check-text">High school</span>
                                                        </label></div>
                                                    <div class="aligned-checkboxes__item input-tick"><label><input
                                                                type="checkbox" name="undergraduate" value="false">
                                                            <div class="checkbox-material">
                                                                <div class="custom-checkbox"></div>
                                                            </div><span class="check-text">Undergraduate</span>
                                                        </label></div>
                                                    <div class="aligned-checkboxes__item input-tick"><label><input
                                                                type="checkbox" name="postgraduate" value="false">
                                                            <div class="checkbox-material">
                                                                <div class="custom-checkbox"></div>
                                                            </div><span class="check-text">Postgraduate</span>
                                                        </label></div>
                                                    <div class="aligned-checkboxes__item input-tick"><label><input
                                                                type="checkbox" name="vocational" value="false">
                                                            <div class="checkbox-material">
                                                                <div class="custom-checkbox"></div>
                                                            </div><span class="check-text">Vocational</span>
                                                        </label></div>
                                                </div>
                                                <div class="flex-center filters__apply"><button
                                                        class="button button--filter before-fade-in fade-in">Done<span
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/mayor" class="disable-fade-in">
                                    ...
                                    <div class="card__section card__section--careers">
                                        <p class="card__name disable-fade-in">Mayor</p>
                                        <p class="card__salary">$68K-$210K annually</p>
                                        <p class="card__education">N/A growth | N/A | N/A</p>
                                        <p class="card__link">Go to Career <span
                                                class="small-icons next-arrow-green-xs"></span></p>
                                    </div>
                                    <div class="match-tank pulse_8">
                                        <div class="inner">
                                            <div class="fill fillAction_8" style="transform: translate(0px, 10.2px);">
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/advertising-account-executive"
                                    ...
                                    <div class="match-tank pulse_7">
                                        <div class="inner">
                                            <div class="fill fillAction_7" style="transform: translate(0px, 13.2px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/airline-pilot" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_5">
                                        <div class="inner">
                                            <div class="fill fillAction_5" style="transform: translate(0px, 25.2px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/chief-executive" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_0">
                                        <div class="inner">
                                            <div class="fill fillAction_0" style="transform: translate(0px, 57.6px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/financial-manager"
                                    class="disable-fade-in">
                                    <div class="card__image"
                                    ...
                                    <div class="match-tank pulse_8">
                                        <div class="inner">
                                            <div class="fill fillAction_8" style="transform: translate(0px, 9px);"><svg
                                                    version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/green-marketer" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_8">
                                        <div class="inner">
                                            <div class="fill fillAction_8" style="transform: translate(0px, 10.8px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/surgeon" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_4">
                                        <div class="inner">
                                            <div class="fill fillAction_4" style="transform: translate(0px, 35.4px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/marketing-manager"
                                    class="disable-fade-in">
                                    <div class="card__image"
                                    ...
                                    <div class="match-tank pulse_9">
                                        <div class="inner">
                                            <div class="fill fillAction_9" style="transform: translate(0px, 3.6px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/advertising-manager"
                                    class="disable-fade-in">
                                    <div class="card__image"
                                    ...
                                    <div class="match-tank pulse_2">
                                        <div class="inner">
                                            <div class="fill fillAction_2" style="transform: translate(0px, 46.8px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/petroleum-engineer"
                                    class="disable-fade-in">
                                    <div class="card__image"
                                    ...
                                    <div class="match-tank pulse_3">
                                        <div class="inner">
                                            <div class="fill fillAction_3" style="transform: translate(0px, 38.4px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/promotions-manager"
                                    class="disable-fade-in">
                                    <div class="card__image"
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/psychiatrist" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_2">
                                        <div class="inner">
                                            <div class="fill fillAction_2" style="transform: translate(0px, 45.6px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/compensation-and-benefits-manager"
                                    ...
                                    <div class="match-tank pulse_8">
                                        <div class="inner">
                                            <div class="fill fillAction_8" style="transform: translate(0px, 7.2px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/astronaut" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_4">
                                        <div class="inner">
                                            <div class="fill fillAction_4" style="transform: translate(0px, 36px);"><svg
                                                    version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/hr-manager" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_7">
                                        <div class="inner">
                                            <div class="fill fillAction_7" style="transform: translate(0px, 17.4px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/broadcast-news-analyst"
                                    ...
                                    <div class="match-tank pulse_6">
                                        <div class="inner">
                                            <div class="fill fillAction_6" style="transform: translate(0px, 21.6px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/judge" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_9">
                                        <div class="inner">
                                            <div class="fill fillAction_9" style="transform: translate(0px, 4.8px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/physicist" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_2">
                                        <div class="inner">
                                            <div class="fill fillAction_2" style="transform: translate(0px, 45px);"><svg
                                                    version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/palaeontologist" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_0">
                                        <div class="inner">
                                            <div class="fill fillAction_0" style="transform: translate(0px, 58.8px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/purchasing-manager"
                                    class="disable-fade-in">
                                    <div class="card__image"
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/actuary" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_2">
                                        <div class="inner">
                                            <div class="fill fillAction_2" style="transform: translate(0px, 48px);"><svg
                                                    version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/air-traffic-controller"
                                    ...
                                    <div class="match-tank pulse_8">
                                        <div class="inner">
                                            <div class="fill fillAction_8" style="transform: translate(0px, 6.6px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/postsecondary-teacher"
                                    ...
                                    <div class="match-tank pulse_3">
                                        <div class="inner">
                                            <div class="fill fillAction_3" style="transform: translate(0px, 37.2px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/sales-manager" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_3">
                                        <div class="inner">
                                            <div class="fill fillAction_3" style="transform: translate(0px, 37.8px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/art-director" class="disable-fade-in">
                                    ...
                                    <div class="match-tank pulse_6">
                                        <div class="inner">
                                            <div class="fill fillAction_6" style="transform: translate(0px, 24px);"><svg
                                                    version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/film-and-video-editor"
                                    ...
                                    <div class="match-tank pulse_0">
                                        <div class="inner">
                                            <div class="fill fillAction_0" style="transform: translate(0px, 55.2px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="large-3 medium-6 small-12 cell">
                            <div class="card card--careers "><a href="/careers/chemical-engineer"
                                    class="disable-fade-in">
                                    <div class="card__image"
                                    ...
                                    <div class="match-tank pulse_3">
                                        <div class="inner">
                                            <div class="fill fillAction_3" style="transform: translate(0px, 39.6px);">
                                                <svg version="1.1" x="0px" y="0px" width="88px" height="88px"
                                                    viewBox="0 0 88 88" enable-background="new 0 0 88 88">
                                                    <path class="wave-shape" d="M300,300V2.5c0,0-0.6-0.1-1.1-0.1c0,0-25.5-2.3-40.5-2.4c-15,0-40.6,2.4-40.6,2.4
  c-12.3,1.1-30.3,1.8-31.9,1.9c-2-0.1-19.7-0.8-32-1.9c0,0-25.8-2.3-40.8-2.4c-15,0-40.8,2.4-40.8,2.4c-12.3,1.1-30.4,1.8-32,1.9
  ...
  c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
            ...
            <div class="grid-x text-center-small">
                <div class="large-4 medium-3 small-12 cell">
                    <img alt="CareerHunter" width="130" height="14"
                        ...
                        class="before-fade-in">
                </div>
                <div class="large-8 medium-9 small-12 cell links">
                    <a href="about.html" class="link-page before-fade-in">About </a>
                    <a href="affiliates.html" class="link-page before-fade-in">Affiliates</a>
                    <a href="partners.html" class="link-page before-fade-in">Partners </a>
                    <a href="group.html" class="link-page before-fade-in">Educators </a>
                    <a href="contact.html" class="link-page before-fade-in">Contact </a>
                    <a href="terms.html" class="link-page before-fade-in">Terms </a>
                    <a href="privacy.html" class="link-page before-fade-in">Privacy </a>
                </div>
            </div>
            <div class="grid-x text-center-small">
                <div class="large-9 medium-7 small-12 cell">
                    <p class="rights before-fade-in">
                        © 2024 DeltaQuest Media Limited. All rights reserved.
                    </p>
                </div>
                <div class="large-3 medium-5 small-12 cell payment-icons">
                    <div class="small-icons payment-icon-cards before-fade-in"></div>
                    <div class="small-icons applePay-card before-fade-in"></div>
                    <div class="small-icons am-ex-card before-fade-in"></div>
                    <div class="small-icons union-pay-card before-fade-in"></div>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script>
        // JavaScript để vô hiệu hóa chuột phải và các phím tắt sao chép
        ...
        // JavaScript để xóa clipboard khi chụp màn hình
