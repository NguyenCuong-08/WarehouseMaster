                            ...
                            <div class="dropdown dropdown-inline">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                    ...
                                    <ul class="kt-nav">
                                        ...
                                        <li class="kt-nav__item">
                                            @if($module['code'] === 'o_hang')
                                                <!-- Nội dung sẽ hiển thị nếu $module['code'] là "o_hang" -->
                                                @php
                                                    $name1 = 'Ô Hàng'; // Gán giá trị cho biến $name
                                                @endphp
                                            @else
                                                <!-- Nội dung sẽ hiển thị nếu $module['code'] không phải là "o_hang" -->
                                                @php
                                                    $name1 = 'Dãy Hàng'; // Gán giá trị cho biến $name
                                                @endphp
                                            @endif
                                            <a href="/admin/import/add?table={{$module['code']}}&amp;table_label={{$name1}}" class="kt-nav__link" title="Nhập file excel lên để đẩy dữ liệu vào hệ thống">
