        ...
        <div class="kt-portlet kt-portlet--mobile">
                                    ...
                                    <ul class="kt-nav">
                                        ...
                                        <li class="kt-nav__item">
                                            <a class="kt-nav__link export-excel"
                                               ...
                                               onclick="setExportValueAndSubmit('export', 'export');">
                                                <i class="kt-nav__link-icon la la-file-excel-o"></i>
                                                <span class="kt-nav__link-text">Xuất Excel</span>
                                            </a>
                                        </li>
                                        {{--                                        {{@dd($module['label'])}}--}}
                                        @if($module['label'] == "Tồn kho" )
                                            <li class="kt-nav__item">
                                                <a class="kt-nav__link export-excel"
                                                   title="Xuất các bản ghi đang lọc ra file excel"
                                                   onclick="setExportValueAndSubmit('export_xuat_nhap_ton', 'export_xuat_nhap_ton');">
                                                    <i class="kt-nav__link-icon la la-file-excel-o"></i>
                                                    <span class="kt-nav__link-text">Xuất Excel Xuất Nhập Tồn</span>
                                                </a>
                                            </li>
                                        @endif
                                        {{--                                        <li class="kt-nav__item">--}}
                                        {{--                                            <a class="kt-nav__link export-excel"--}}
                                        {{--                                               title="Xuất các bản ghi đang lọc ra file excel"--}}
                                        {{--                                               onclick="$('input[name=export_nhap_xuat_ton]').click();">--}}
                                        {{--                                                <i class="kt-nav__link-icon la la-file-excel-o"></i>--}}
                                        {{--                                                <span class="kt-nav__link-text">XNT</span>--}}
                                        {{--                                            </a>--}}
                                        {{--                                        </li>--}}
            ...
            <div class="kt-portlet__body kt-portlet-search @if(!isset($_GET['search'])) no-padding @endif">
                ...
                <form class="kt-form kt-form--fit kt-margin-b-20 form-search" id="form-search" method="GET" action=""
                    ...
                    <!-- Hidden input field for 'export' -->
                    <input id="export-input" type="hidden" value=""/>
                    {{--                    <input name="export_nhap_xuat_ton" type="submit" value="export_nhap_xuat_ton" style="display: none;">--}}
                ...
                <script>
                    function setExportValueAndSubmit(name, value) {
                        // Set the name and value for the hidden input dynamically
                        const exportInput = document.getElementById('export-input');
                        exportInput.name = name; // Set the input name dynamically
                        exportInput.value = value; // Set the input value dynamically

                        // Log the name and value to ensure they are set correctly
                        console.log('Input name:', exportInput.name);
                        console.log('Input value:', exportInput.value);
