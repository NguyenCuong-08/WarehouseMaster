...
@section('main')
    <style>
        ...
        @media only screen and (max-width: 768px){
            ...
            .tim-kiem-cu-the input{
                width: 100%;
            }
            .tim-kiem-cu-the form{
                flex-wrap: wrap;
        ...
        <div class="kt-portlet kt-portlet--mobile">
			...
			<span class="kt-portlet__head-icon">
                <i class="kt-font-brand flaticon-interface-3"></i>
                   ...
                   <div class="tim-kiem-cu-the search-container">
                       <form action="" method="GET">
                           <div class="" style="margin-right: 4px">
                               <input type="number" name="sdt" value="{{ @$_GET['sdt'] }}"
                                      class="form-control" title="Chỉ cần enter để thực hiện tìm kiếm"
                                      placeholder="Nhập SĐT của thành viên">
                           </div>
...
{{--                            @endif--}}
            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                     id="scrolling_vertical" style="padding: 17px; overflow: auto;">
...
@push('scripts')
    ...
    <script>
        ...
        $('.duyet_don').click(function (e) {
            ...
            console.log(data);
            Swal.fire({
                title: "Duyệt đơn này sẽ trừ tiền trong ví người dùng và cộng tiền hoa hồng cho các cấp. Bạn có chắc chắn thực hiện?",
