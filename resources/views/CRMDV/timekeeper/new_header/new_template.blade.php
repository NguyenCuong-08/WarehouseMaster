...
<!-- begin:: Header Mobile -->
@include('CRMDV.timekeeper.new_header.new_header_mobile')
<!-- end:: Header Mobile -->
    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper"
            ...
            <div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
                ...
                {{--                    </div>--}}
                {{--                    --}}
                @include('CRMDV.timekeeper.new_header.new_nv_xuat_sac')
                ...
                <div class="kt-header__topbar" style="position: static;">
                    ...
                    @include('CRMDV.timekeeper.new_header.new_user_bar')
                    <!--end: BillPayment Bar -->
                </div>
                <!-- end:: Header Topbar -->
            </div>
