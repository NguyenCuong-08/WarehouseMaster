...
@section('main')
    ...
    <form class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid {{ @$module['code'] }}"
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8">
                <!--begin::Portlet-->
                @include('CRMDV.form.fields.thong_tin_trien_khai')
                <!--end::Portlet-->
        ...
        <div class="row">
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            ...
                            <div class="log_logs">
                                <?php
                                $logs = \App\CRMDV\Models\LeadContactedLog::where('type', 'hđ')->where('lead_id', @$result->id)->orderBy('id', 'desc')->get();
                                ?>
                                @foreach($logs as $log)
                                    <hr>
            ...
            <div class="col-xs-12 col-md-4">
                @include('CRMDV.bill.partials.dich_vu_lien_quan')
            </div>
        </div>
    </form>
