    ...
    <div class="kt-form">
        <div class="kt-portlet__body">
            <div class="kt-section kt-section--first">
                ...
                <?php
                $field = ['name' => 'progress_yctk', 'type' => 'text', 'label' => 'Link yêu cầu triển khai', 'class' => 'required', 'group_class' => 'col-md-9 required', 'value' => isset($result) ? @$result->bill_progress->yctk : '', 'inner' => 'placeholder="Nhớ share full quyền chỉnh sửa"'];
                ?>
                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                     id="form-group-{{ $field['name'] }}">
                    <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
                ...
                <?php
                $field = ['name' => 'customer_classify', 'type' => 'select', 'label' => 'Phân loại khách', 'class' => ' required', 'group_class' => 'col-md-3', 'value' => isset($result) ? @$result->customer->classify : '', 'options' => [
                    '-' => '',
