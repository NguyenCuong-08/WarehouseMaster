        ...
        <div class="kt-portlet__body">
            <div class="kt-section kt-section--first">
                ...
                @if(isset($result))
                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
                         id="form-group-{{ $field['name'] }}">
                        <label for="{{ $field['name'] }}">Đã trả</label>
                        <div class="col-xs-12">
                    ...
                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
                         id="form-group-{{ $field['name'] }}">
                        <label for="{{ $field['name'] }}">Còn thiếu</label>
                        <div class="col-xs-12">
                    ...
                    $field = ['name' => 'iframe', 'type' => 'iframe', 'class' => 'col-xs-12 col-md-12 padding-left'
                        , 'src' => '/admin/bill_receipts?bill_id={id}', 'inner' => 'style="min-height: 400px;"'];
                    ?>
                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                             id="form-group-{{ $field['name'] }}">
                ...
                <?php 
                $field = ['name' => 'finance_detail', 'type' => 'textarea', 'label' => 'Chi tiết hạng mục tiền', 'class' => 'required', 'group_class' => 'col-md-12', 'value' => isset($result) ? @$result->bill_finance->detail : '', 'inner' => 'placeholder="Ví dụ: Gói chuyên nghiệp 2 năm tặng 1 năm 6,3tr. Cọc trước 100% tặng thêm 6 tháng. Tên miền .vn 670k"'];
                ?>
                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                     id="form-group-{{ $field['name'] }}">
                    <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
