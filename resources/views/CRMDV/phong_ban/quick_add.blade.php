                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                <?php
                                $field = ['name' => 'ladipage', 'type' => 'textarea', 'class' => '', 'label' => 'Thêm nhanh Ladipage đã làm',
                                    'inner' => 'rows=15', 'group_class' => 'col-md-6',];
                                ?>
                                ...
                                <?php
                                $field = ['name' => 'wordpress', 'type' => 'textarea', 'class' => '', 'label' => 'Thêm nhanh Wordpress đã làm',
                                    'inner' => 'rows=15', 'group_class' => 'col-md-6',];
                                ?>
                                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                     id="form-group-{{ $field['name'] }}">
                                    ...
                                    <?php
                                    $field = ['name' => 'ladipage_mang', 'type' => 'textarea', 'class' => '', 'label' => 'Thêm nhanh Ladipage kiếm trên mạng',
                                        'inner' => 'rows=15', 'group_class' => 'col-md-6',];
                                    ?>
                                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                         id="form-group-{{ $field['name'] }}">
                                    ...
                                    <?php
                                    $field = ['name' => 'wordpress_mang', 'type' => 'textarea', 'class' => '', 'label' => 'Thêm nhanh Wordpress kiếm trên mạng',
                                        'inner' => 'rows=15', 'group_class' => 'col-md-6',];
                                    ?>
                                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                         id="form-group-{{ $field['name'] }}">
