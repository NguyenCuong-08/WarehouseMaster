                        ...
                        <div class="dropdown dropdown-inline">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                ...
                                <ul class="kt-nav">
                                    ...
                                    @if(in_array($module['code'] . '_import', $permissions))
                                        <li class="kt-nav__item">
                                            <a href="/admin/import/add?table=leads&table_label=Đầu mối"
                                               class="kt-nav__link"
                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                    ...
                    <table class="table table-striped">
                        ...
                        <tr class="kt-datatable__row" style="left: 0px;">
                            ...
                            <th data-field="sale_id" class="kt-datatable__cell kt-datatable__cell--sort">Sale</th>
                        </tr>
                        </thead>
                        ...
                        @foreach($listItem as $item)
                            ...
                            <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                ...
                                <!-- Nếu được xem hết dữ liệu thì hiển thị ra cột sale phụ trách -->
                                <td data-field="sale_id" class="kt-datatable__cell kt-datatable__cell--sort">
                                        <?php
