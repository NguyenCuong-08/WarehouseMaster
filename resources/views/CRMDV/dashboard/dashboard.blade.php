...
@section('main')
    ...
    if (!$bill_warning) {
        // ====|Min|======|Now|=====|Closed|======|Max|======>
        $bill_warning = \App\CRMDV\Models\Bill::select('service_id', 'customer_id', 'id', 'created_at', 'total_price', 'exp_price', 'expiry_date', 'domain', 'auto_extend')
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6 order-lg-1 order-xl-1">
                @include('CRMDV.dashboard.partials.xep_hang.xep_hang_dich_vu')
            </div>
            <div class="col-xs-12 col-md-6 order-lg-1 order-xl-1">
