    ...
    <div class="container">
        ...
        <div class="row">
            ...
            @foreach($ds_dieu_hanh as $admin)
                <?php
                    $so_da_dang_lam = App\CRMDV\Models\BillProgress::whereIn('status', [
                                    'Thu thập YCTK L1',
                                    'Triển khai L1',
                    ...
                    $so_da_da_lam = App\CRMDV\Models\BillProgress::whereIn('status', [
                                    'Khách xác nhận xong',
                                    'Kết thúc',
                                ])
                            ->where('dh_id', $admin->id)
                        ...
                        <!--begin::Toolbar-->
                            ...
                            <!-- <p class="mb-7">I distinguish three
                                ...
                                <div class="mb-7 noi-dung">
                                    ...
                                    <div class=" justify-content-between align-items-cente my-1">
                                        <span class="text-dark-75 font-weight-bolder mr-2">Dự án đang làm:</span>
                                        <a class="text-muted text-hover-primary">{{ $so_da_dang_lam }} / {{ $admin->maximum_projects }}</a>
                                    </div>
                                ...
                                <div class="mb-7 noi-dung">
                                    <div class="justify-content-between align-items-center">
                                        <span class="text-dark-75 font-weight-bolder mr-2">Dự án đã làm:</span>
        ...
        <div class="row">
            ...
            @foreach($ds_ky_thuat as $admin)
                <?php
                    ...
                    $so_da_dang_lam = App\CRMDV\Models\BillProgress::leftJoin('bills', 'bills.id', '=', 'bill_progress.bill_id')
...
//                            ->whereIn('bills.service_id', [ //  ko tính dự án landingpage
//                                5,
//                                9,
//                                10,
//                                11,
                        ...
                        <!--begin::Toolbar-->
                            ...
                            <!-- <p class="mb-7">I distinguish three
                                ...
                                <div class="mb-7 noi-dung">
                                    ...
                                    <div class=" justify-content-between align-items-cente my-1">
                                        <span class="text-dark-75 font-weight-bolder mr-2 text-bold">Dự án đang làm:</span>
