...
@section('main')
    <div class="col-xs-12 menu-document">
        <ul class="nav">
            <a class="nav-link " href="/admin/course/view/0" style="margin-right: 20px;
    color: #fff;
    background: #6176fa;">Quản lý tài liệu</a>
        </ul>
    </div>
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        <div class="kt-portlet__head-actions">
                            ...
                            @if(in_array('course', $permissions))
                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($listItem as $item)
                            ...
                            <?php 
                                $childs1 = \App\CRMDV\Models\Category::where('parent_id', $item->id)->orderBy('order_no', 'desc')->orderBy('name', 'asc')->get();
                            ?>
                            @foreach($childs1 as $item)
                                ...
                                <?php 
                                    $childs2 = \App\CRMDV\Models\Category::where('parent_id', $item->id)->orderBy('order_no', 'desc')->orderBy('name', 'asc')->get();
                                ?>
