...
{{--                        --}}{{--    width: 500px;">Quét--}}
{{--                        --}}{{--                        </button>--}}
{{--                        <a href="{{ route('lichsuxuatkho') }}"><button id="lammoi" style="padding: 8px 20px;--}}
...
{{--                    </div>--}}
                    ...
                    <form style="margin-left: 20px; margin-top: 40px;" action="{{ route('nhaptt') }}" method="post"
                          id="qrForm">
{{--                        @csrf--}}
                        {{ csrf_field() }}
                        <div>
    ...
    height: 40px;" type="text" id="qrInput1" name="code" autofocus required>
                        </div>
                        <div style="margin-top: 20px;">
                            <button type="submit" style="width: 100px; height: 40px;">Kiểm tra</button>
                        </div>
