...
@section('content')
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        errorElement.textContent = 'Email không tồn tại';
                        document.getElementById('emailforgot').parentNode.appendChild(errorElement);
    ...
    <div class="wrapper" id="wrapper">
        ...
        <div class="banner-top login-form login-form--white">
            <div class="grid-container transparent" style="padding-top: 0px !important;">
                <div class="grid-x align-center align-middle blk">
                    <div class="small-12 cell">
                        <div data-react-class="login/index" data-react-props="{&quot;continue_path&quot;:null}"
                             data-hydrate="t" data-react-cache-id="login/index-0">
                            <div class="login-register">
                                <form action="{{ route('login.submit') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="grid-x text-center-medium">
                                        <div class="small-12 cell">
                                            <h1 class="set-up__header">Xin chào bạn của tôi! </h1>
                                            <p class="set-up__subheader" style="font-size: 22px;">Hãy truy cập ngay để
                                                tạo
                                                lợi thế cho bản thân! </p>
                                        </div>
                                        <div class="small-12 cell">
                                            <div class=""><input type="text" value="" placeholder="Thư điện tử*		"
                                                                 name="email">
                                            </div>
                                            <div class=""><input type="password" value="" placeholder="Mật khẩu*		"
                                                                 name="password">
                                                @if (session('error'))
                                    ...
                                    <div class="grid-x align-middle text-center-small">
                                        <div class="medium-6 small-12 cell  text-left-center">
                                            <div class=" input-tick"><label class="before-fade-in"><input
                                                            type="checkbox"
                                                            value="false"
                                                            name="remember_me"
                                                    ...
                                                    <span class="check-text">Giữ cho tôi luôn đăng nhập		</span>
                                                </label></div>
                                        </div>
                                        <div class="medium-6 small-12 cell medium-flex-end">
                                            <button type="submit"
                                                    class="button button--green before-fade-in fade-in button--green--large">
                                                Đăng nhập<span
                                                        class="small-icons next-arrow-white-l before-fade-in"></span><span
                                                        class="button__hovered"></span></button>
                                        </div>
                                    </div>
                                </form>
                                <div class="grid-x align-middle mar-top-10 text-center-small">
                                    <div class="medium-6 small-12 cell medium-order-1 small-order-2 text-left-center">
                                        <p class="registration__link ">Bạn chưa có tài khoản? <a
                                                    href="{{ route('signup.form') }}" class="">Đăng ký </a></p>
                                    </div>
                                    <div class="medium-6 small-12 cell medium-flex-end medium-order-2 small-order-1"><a
                                                class="login-register__forgot" data-bs-toggle="modal"
                                                data-bs-target="#myModal">Quên mật khẩu </a>
                                    </div>
                                </div>
                                <div class="grid-x">
                                    <div class="small-12 cell login-register__social">
                                        <p class="login-register__or text-center" style="    margin-left: -20px;
                                        margin-right: -10px;">Có thể sử dụng email của giáo viên (được cấp từ website
                                            của trường học hoặc tổ chức giáo dục) để đại diện đăng ký cho nhóm học sinh
                                            của bạn </p>
                                        <a href="/dich-vu-nhom"
                                           class="button button--clear " style="color: #59ce61; font-size: 14px; ">
                                            {{--                                            <span--}}
                                            {{--                                                    class="small-icons is-left google-plus "></span>--}}
                                            Tôi là giáo viên /
                                            nhà giáo dục
                                        </a>
                                    </div>
                ...
                <div id="oaiklv">
                    <div class="popup opened">
                        <div class="popup__content">
                            <div class="form-container"><h3>Nếu bạn quên mật khẩu?
                                </h3>
                                <p class="popup__text">Vui lòng nhập địa chỉ email bạn đã sử dụng để tạo Tài khoản
                                    TeenCodes để đặt lại mật khẩu. </p>
                                <div class=""><input placeholder="Email*" type="email" id="emailforgot" name="email"
                                                     value=""></div>
                                <div class="medium-text-center text-right">
                                    <button class="button button--green before-fade-in fade-in"
                                            onclick="forgotpassword()">Gửi đi <span
                                                class="button__hovered"></span></button>
                                </div>
                            </div>
                            <a class="popup__close" data-bs-dismiss="modal">×</a></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="popup opened">
                        <div class="popup__content">
                            <div class="grid-x align-center align-middle">
                                <div class="small-12 cell text-center"><h3 class="mar-bot-10">Check your inbox</h3>
                                    <p class="popup__text">We sent you an email with a link to reset your password.
