...
@section('content')
    ...
    <script>
        function validateForm() {
            ...
            var field_password = document.getElementById('new_password').value;
            var field_password2 = document.getElementById('new_password2').value;
            ...
            if (field_password2.trim() === '') {
                ...
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Bạn chưa điền thông tin';
                document.getElementById('new_password2').parentNode.appendChild(errorElement);
                errors.push('Field 1 is required.');
    ...
    <div class="wrapper" id="wrapper">
        <div class="banner-top login-form login-form--white">
            ...
            <form onsubmit="return validateForm()"
                  ...
                  class="form-container grid-x" action="{{ route('resetpassword.submit') }}" method="post">
                {{ csrf_field() }}

                <h3>Reset Password</h3>
                <input type="hidden" name="token" value="{{ $token }}">
                <div class="cell">
                    <div class="strong-validation ">
                        <div class="">
                            <input placeholder="New Password*" type="password" id="new_password" name="new_password"
                                   value=""></div>
                    </div>
                </div>
                <div class="cell">
                    <div class="strong-validation ">
                        <div class="">
                            <input placeholder="Confirm Password*" type="password" id="new_password2"
                                   name="new_password2"
                                   value="">
                        @if(session('error'))
                ...
                <div class="grid-x align-middle">
                    <div class="cell text-center">
                        <button type="submit" class="button button--green before-fade-in fade-in">Save<span
