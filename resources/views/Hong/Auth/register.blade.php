@extends('HuongNghiep.Frontend.layouts.layout_home')
@section('content')
    ...
    <script>
        function validateForm() {
            ...
            var field_year = document.getElementById('field_year').value;
            var field_email = document.getElementById('field_email').value;
            var field_password2 = document.getElementById('field_password2').value;
            var field_gender = document.getElementById('field_gender').value;
            var field_address = document.getElementById('field_address').value;
            var field_class = document.getElementById('field_class').value;
            var field_class2 = document.getElementById('field_class2').value;
            ...
            if (field_name.trim() === '') {
                ...
                document.getElementById('field_name').parentNode.appendChild(errorElement);

                errors.push('Field 1 is required.');
            }
            if (field_password.trim() === '') {
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Bạn chưa điền thông tin';
                document.getElementById('field_password').parentNode.appendChild(errorElement);
                errors.push('Field 1 is required.');

            } else if (field_password.trim().length < 8 || field_password.trim().length > 16) {
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Mật khẩu phải dài từ 8 đến 16 ký tự';
                document.getElementById('field_password').parentNode.appendChild(errorElement);
                errors.push('Field 1 is required.');
            } else if (!uppercaseRegex.test(field_password)) {
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Mật khẩu phải chứa ít nhất 1 ký tự viết hoa';
                document.getElementById('field_password').parentNode.appendChild(errorElement);
                errors.push('Field 1 is required.');
            }else if (!lowercaseRegex.test(field_password)) {
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Mật khẩu phải chứa ít nhất 1 ký tự viết thường';
                document.getElementById('field_password').parentNode.appendChild(errorElement);
                errors.push('Field 1 is required.');
            }else if (!digitRegex.test(field_password)) {
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Mật khẩu phải chứa ít nhất 1 ký tự số';
                document.getElementById('field_password').parentNode.appendChild(errorElement);
                errors.push('Field 1 is required.');
            }else if (!specialCharRegex.test(field_password)) {
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
            ...
            if (field_year.trim() === '') {
                ...
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Bạn chưa điền thông tin';
                document.getElementById('field_year').parentNode.appendChild(errorElement);
                errors.push('Field 1 is required.');
            }
            if (field_email.trim() === '') {
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Bạn chưa điền thông tin';
                document.getElementById('field_email').parentNode.appendChild(errorElement);
                errors.push('Field 1 is required.');
            }else if(!emailRegex.test(field_email)){
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
            ...
            if (field_password2.trim() === '') {
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Bạn chưa điền thông tin';
                document.getElementById('field_password2').parentNode.appendChild(errorElement);
                errors.push('Field 1 is required.');
            }else if(field_password2.trim() !== field_password.trim()){
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
            ...
            if (field_gender.trim() === '') {
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Bạn chưa điền thông tin';
                document.getElementById('field_gender').parentNode.appendChild(errorElement);

                errors.push('Field 1 is required.');
            }
            if (field_address.trim() === '') {
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Bạn chưa điền thông tin';
                document.getElementById('field_address').parentNode.appendChild(errorElement);
            ...
            if (field_class.trim() === '') {
                ...
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Bạn chưa điền thông tin';
                document.getElementById('field_class').parentNode.appendChild(errorElement);

                errors.push('Field 1 is required.');
            }
            if (field_class2.trim() === '') {
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Bạn chưa điền thông tin';
                document.getElementById('field_class2').parentNode.appendChild(errorElement);

                errors.push('Field 1 is required.');
            }
            // Nếu có lỗi, ngăn form được submit và hiển thị thông báo lỗi
            if (errors.length > 0) {
                return false;
            }
            if (!agreeCheckbox.checked) {
                ...
                var errorElement = document.createElement('small');
                errorElement.className = 'text-left error';
                errorElement.textContent = 'Bạn chưa xác nhận';
                document.getElementById('agree_terms').parentNode.appendChild(errorElement);
    ...
    <form class="registration__form" onsubmit="return validateForm()" action="{{ route('signup.submit') }}" method="POST">
        {{ csrf_field() }}
        <div class="grid-x text-center-medium">
            <div class="large-8 medium-12 small-12 cell registration__left-side">
                <div class="small-12 cell">
                    <h1 class="set-up__header">Tạo tài khoản TeenCodes</h1>
                    <p class="set-up__subheader">Để lưu trữ hồ sơ, kết quả kiểm tra của bạn và báo cáo tư vấn hướng
                        nghiệp luôn được cập nhật dành riêng cho bạn. </p>
                </div>

                <div class="grid-x">
                    <div class="medium-6 small-12 cell med-up-padR10">
                        <div class="">
                            <input placeholder="Họ và tên đầy đủ*" type="text" id="field_name" name="name" value="">

                        </div>
                        <div class=""><input placeholder="Mật khẩu*" type="password" id="field_password" name="password"
                                             value=""></div>
                        <div class=""><input placeholder="Năm sinh" type="number" id="field_year" name="year" value="">
                        </div>
                    </div>

                    <div class="medium-6 small-12 cell">
                        <div class=""><input placeholder="Thư điện tử*" type="text" id="field_email" name="email"
                                             value=""></div>
                        <div class=""><input placeholder="Xác nhận mật khẩu*" type="password" id="field_password2"
                                             name="password_confirmation" value=""></div>
                        <div class="label-icon-right select-label ">
                            <select name="gender" id="field_gender">
                ...
                <div class="small-12 cell">
                    <div class="label-icon-right select-label ">
                        <select name="address" id="field_address">
                    ...
                    <div class="label-icon-right select-label "><select name="class" id="field_class">
                            <option value="">Cấp trường / lớp hiện nay*</option>
                            ...
                            <option value="Tôi là giáo viên">Tôi là giáo viên</option>
                        </select></div>
                    <div class="label-icon-right select-label "><select name="class2" id="field_class2">
                            <option value="">Cấp học mục tiêu*</option>
                            <option value="Đại học chính quy">Đại học chính quy</option>
                            <option value="Cao đẳng">Cao đẳng</option>
                            <option value="Trung cấp nghề">Trung cấp nghề</option>
                            <option value="THPT">THPT</option>
                            <option value="Trung tâm GDTX">Trung tâm GDTX</option>
                            <option value="Đại học liên thông">Đại học liên thông</option>
                            <option value="Đào tạo quốc tế">Đào tạo quốc tế</option>
                            <option value="Làm việc ngay">Làm việc ngay</option>
                        </select></div>
                </div>
                <div class="cell">
                    <div class="input-tick-wrapper">
                        <div class="input-tick--inline input-tick"><label><input type="checkbox"
                                                                                 name="newsletter_subscription"
                                                                                 value="false">
{{--                                <div class="checkbox-material">--}}
{{--                                    <div class="custom-checkbox"></div>--}}
{{--                                </div>--}}
                                <span class="agreeText">Số điện thoại di động (để nhận hỗ trợ đặc biệt)*
                                    <!-- Sign up to <a href="https://dose.careeraddict.com/"
                                        target="_blank">The Dose</a> for career hacks - sent 3x week -->
                                </span>
                            </label></div>
                    </div>
                </div>
                <div class="grid-x align-middle agree-text">
                    <div class="large-8 medium-12 small-12 cell">
                        <div class=" input-tick"><label><input type="checkbox" id="agree_terms" name="agree_terms" value="false">
                                <div class="checkbox-material">
                                    <div class="custom-checkbox"></div>
                                </div>
                                <span class="agreeText">Tôi đồng ý với quy định
                                    <a href="huongnghiep/new_detail" target="_blank">Điều khoản</a>
                                    và <a href="/privacy" target="_blank">Pháp lý </a></span>
                            </label></div>
                    </div>
                    <div class="large-4 medium-12 small-12 cell large-flex-end medium-o-m-top-10">
                        <button type="submit"
                                class="button button--green before-fade-in fade-in cancel button--green--large">Đăng ký
                            <span class="small-icons next-arrow-white-l"></span><span class="button__hovered"
                                                                                      style="top: 11.6666px; left: 64.0312px;"></span>
                        </button>
                    </div>
                    <div class="small-12 cell">
                        <p class="set-up__info"><span class="small-icons blue-off-tooltip"></span><span>
                                (*) Bạn có thể chỉnh sửa các nội dung này bất kỳ lúc nào trong cài đặt tài khoản của
                                mình </span></p>
                    </div>
                </div>
            </div>
            <div class="large-4 medium-12 small-12 cell registration__right-side">
                <div class="green-circle top-half"></div>
                <div class="circle top-small"></div>
                <div class="circle bottom-half"></div>
                <div class="registration__img-block">
                    <p class="registration__link">Bạn đã có sẵn một tài khoản? <a href="{{ route('login.form') }}">Đăng nhập </a></p>
                    <img
                            src="//cdn0.careerhunter.io/packs/media/images/register-44a32a10.png"
                            alt="Create a CareerHunter Account" width="261px" height="166px">
                    <p class="registration__social" style="font-weight: bold">Hãy truy cập ngay để tạo lợi thế cho bản
                        thân. </p>
                    <div id="huivdn">
                        <div class="grecaptcha-badge" data-style="bottomright"
                            ...
                            <div class="grecaptcha-logo">
                                <iframe title="reCAPTCHA" width="256" height="60"
                                        role="presentation" name="a-mxw66h0w4mm" frameborder="0" scrolling="no"
                                        sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation"
                                        src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LcTOCkaAAAAAC2I3uSEvpG6bSyfLKQP04Ik2zl-&amp;co=aHR0cHM6Ly93d3cuY2FyZWVyaHVudGVyLmlvOjQ0Mw..&amp;hl=en&amp;v=joHA60MeME-PNviL59xVH9zs&amp;size=invisible&amp;cb=wxxv6mvut7p9"></iframe>
                            </div>
                    ...
                    <div class="grid-x align-middle">
                        <div class="small-12 cell registration__social-btns">
                            <p class="registration__social" style="font-weight: bold">TeenCodes chúc bạn Thành
                                công! </p>
                            <!-- <button class="button button--clear"> -->
                            <!-- <span
                                class="small-icons is-left google-plus"></span>Sign up using
                            <span>Google</span> -->
                            <!-- </button> -->
                        </div>
                    </div>
