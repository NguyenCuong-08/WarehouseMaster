...
<div class="wrapper" id="wrapper">
    ...
    <div class="upgrade-top__background before-fade-in fade-in" id="full_access">
        <img class="wave-top" width="628" height="230" loading="lazy" alt="Full access wave"
             src="//cdn0.careerhunter.io/assets/upgrade/wave-top-48ad3a7b57599dd38621ac0130144bcfd25f03dabb8b48f37038558c9a91557f.png">
        ...
        <div class="grid-container" style="height: 600px;">
            <div class="grid-x upgrade-top__section">
                <div class="large-6 cell">
                    <p class="upgrade-top__access">Tài khoản TeenCodes - CƠ BẢN </p>
                    <h1 class="upgrade-top__title">Bạn có muốn biết tổ hợp môn học nào phù hợp nhất với định hướng
                        nghề nghiệp lý tưởng của mình ? </h1>
                    <p class="upgrade-top__bullet-point">
                        <span class="checkout-icon green-tick"></span>
                        Báo cáo phân tích thế mạnh của bạn để lựa chọn các môn học trọng tâm (trong chương trình
                        trung học) sẽ phù hợp nhất đối với bạn cũng như để phát triển định hướng ngành học, nghề
                        nghiệp tương lai lý tưởng dành cho bạn.
                    </p>
                    <p class="upgrade-top__bullet-point"><span class="checkout-icon green-tick"></span>Danh sách
                        những nghề nghiệp (theo chuyên ngành đào tạo ở Việt Nam) thuộc 3 trong 6 thể loại ngành nghề
                        phù hợp nhất với bạn được chọn lọc tự động từ hệ thống của chúng tôi. </p>
                    <p class="upgrade-top__bullet-point"><span class="checkout-icon green-tick"></span> <span
                                class="hide-for-small-only">Nhận báo cáo tư vấn hướng nghiệp cơ bản dành cho riêng bạn.
                    </p>
                    <div class="upgrade-top__action apply-fade-in">
                        <div>
                            <a href="/checkout" aria-label="Unlock Tests"
                               class="button button--with-icon button--green button--green--big"
                               data-checkout-link="">Tôi đăng ký dịch vụ <span
                                        class="small-icons checkout-card"></span><span
                                        class="button__hovered"></span></a>
                            <p class="upgrade-top__test">Hoặc <a href="/tests" aria-label="Free Tests"> thử sử dụng
                                    gói KHÁM PHÁ (miễn phí) </a></p>
                        </div>
                        <div>
                            <p class="upgrade-top__price-value">Thanh toán
                                799.999 vnd
                            </p>
                            <p class="upgrade-top__price-value small">Phí trả một lần cho 18 tháng </p>
                        </div>
                    </div>
                </div>
                <div class="large-6 cell upgrade-top--right">
                    <div class="circle top-right-small"></div>
                    <div class="circle bottom-left-large"><span class="icon-1"></span></div>
                    <div class="circle bottom-right-small"></div>
                    <div class="circle bottom-right-large hide-for-small-only"><span class="icon-2"></span></div>
                    <div class="circle bottom-right-large-above hide-for-small-only"><span class="icon-3"></span>
                    </div>
        ...
        c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
                        ...
                        <div class="card-2 show-for-large">
                            <div class="card__image" style=""></div>
                            <div class="card__section">
        ...
        c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z"></path>
            ...
            <div class="grid-x">
                <div class="small-12">
                    <div class="upgrade-logos__wrapper apply-fade-in">
                        <div class="upgrade-logos__inline">
                            <div class="upgrade-logos__block upgrade-logos__block--right">
                                <div class="large-icon guarentee-icon"></div>
                            </div>
                            <div class="upgrade-logos__block  upgrade-logos__block--right">
                                <a href="#our_student-discount" aria-label="Student Discount"
                                   data-id="our_student-discount" data-smooth-scroll="">
                                    <div class="large-icon student-discount"></div>
                                </a>
                            </div>
                            <div class="upgrade-logos__block hide-trustpilot">
                                <a href="#the_applause" aria-label="Student Discount" data-id="the_applause"
                                   data-smooth-scroll="">
                                    <div class="large-icon trustpilot"></div>
                                </a>
                            </div>
    ...
    <div class="upgrade-sticky-menu__container">
        <div class="upgrade-sticky-menu" data-smooth-scroll-menu-container="">
            <div class="grid-container">
                <div class="grid-x" data-indicator-container="" style="">
                    <ul style="margin: 0; padding: 0;">
                        <li class="active"><a href="#full_access" aria-label="Full Access" data-id="full_access"
                                              data-smooth-scroll="" data-nav-progress="" class="before-fade-in">GÓI [CƠ BẢN] </a>
                        </li>
                        <li><a href="#the_benefits" aria-label="The Benefits" data-id="the_benefits"
                               data-smooth-scroll="" data-nav-progress="" class="before-fade-in">LỢI ÍCH</a>
                        </li>
                        <li><a href="#our_guarantee" aria-label="Our Guarantee" data-id="our_guarantee"
                               data-smooth-scroll="" data-nav-progress="" class="before-fade-in">ĐẢM BẢO CỦA CHÚNG
                                TÔI </a>
                        </li>
                        <li><a href="#who_can_use" aria-label="Who can use" data-id="who_can_use"
                               data-smooth-scroll="" data-nav-progress="" class="before-fade-in">AI CÓ THỂ SỬ DỤNG
                            </a>
                        </li>
                        <li><a href="#how_it_works" aria-label="How it works" data-id="how_it_works"
                               data-smooth-scroll="" data-nav-progress="" class="before-fade-in">LÀM THẾ NÀO NÓ
                                HOẠT ĐỘNG </a>
                        </li>
                        <li><a href="#the_applause" aria-label="The Applause" data-id="the_applause"
                               data-smooth-scroll="" data-nav-progress="" class="before-fade-in">CẢM NHẬN </a>
                        </li>
                    </ul>
                    <div data-indicator=""
                         style="width: 198.219px; border-color: rgb(89, 206, 97); transform: translateX(0px);"></div>
                </div>
            </div>
        </div>
    </div>
    <div class="upgrade-benefits upgrade-benefits--section-1" id="the_benefits">
        <div class="grid-container">
            <div class="grid-x align-middle">
                <div class="large-6 medium-12 cell">
                    <h3 class="upgrade-benefits__title before-fade-in">Khám phá các khả năng tương thích của bạn
                    </h3>
                    <h2 class="upgrade-benefits__subtitle before-fade-in">Hiểu biết cơ bản về mức độ phù hợp của bạn đối với
                        các môn học trọng tâm </h2>
                    <p class="upgrade-benefits__desc before-fade-in">Thuật toán độc đáo của TeenCodes đánh giá kết
                        quả bài trắc nghiệm của bạn và sắp xếp chính xác danh sách những môn học trọng tâm ở trường
                        trung học mà bạn không chỉ đang yêu thích lúc này mà còn sẽ mang lại thành công trong tương
                        lai gần. </p>
                </div>
                <div class="large-6 medium-12 cell">
                    <div class="upgrade-benefits__imgs">
                        <picture>
                            <source
                                    srcset="//cdn0.careerhunter.io/assets/upgrade/benefits-desktop-fc1563fd6a108765f92bce93371cb394c6603097397ba6420f8dc20e12869673.webp"
                                    media="(min-width: 1025px)" type="image/webp">
                            <source
                                    srcset="//cdn2.careerhunter.io/assets/upgrade/benefits-tablet-baa77d8298b3c050949d1bf6b258751d0b271ff3e4123b33f60dfb652f5231a7.webp"
                                    media="(min-width: 641px) and (max-width: 1024px)" type="image/webp">
                            <source
                                    srcset="//cdn0.careerhunter.io/assets/upgrade/benefits-mobile-008ea6f4de476c6f34d3d2bac0eacfa13b333e50311cdbcedbdf2fe854d04886.webp"
                                    media="(min-width: 320px) and (max-width: 640px)" type="image/webp">
                            <img loading="lazy" alt="Discover your compatibility"
                                 class="show-for-large before-fade-in"
                                 src="//cdn2.careerhunter.io/assets/upgrade/benefits-desktop-37aacfccaac3b64f126e68ba81e87003d992c0d68f900789be3022494c130569.png">
                            <img loading="lazy" alt="Discover your compatibility" class="show-for-medium-only"
                                 src="//cdn0.careerhunter.io/assets/upgrade/benefits-tablet-c1a4c376218df019ad196f9623dd90002c8a1f618bd6f242ac2deb2cebe5fa2f.png">
                            <img loading="lazy" alt="Discover your compatibility" class="show-for-small-only"
                                 src="//cdn1.careerhunter.io/assets/upgrade/benefits-mobile-b2d1b76c7694a07f2b844c0eb9b738dfb2739f5abd9132584b1e17b316c67356.png">
                        </picture>
                    </div>
                </div>
            </div>
    ...
    <div class="upgrade-benefits upgrade-benefits--section-2">
        <div class="grid-container">
            <div class="grid-x align-middle">
                <div class="large-6 medium-12 large-order-1  small-order-2 cell">
                    <div class="upgrade-benefits__imgs">
                        <picture>
                            <source
                                    srcset="//cdn0.careerhunter.io/assets/upgrade/benefits-desktop-2-0e86443c6cd633a26962701d0330c2d9a8ba104b16e36e085c85aebd3d8d514f.webp"
                                    media="(min-width: 1025px)" type="image/webp">
                            <source
                                    srcset="//cdn1.careerhunter.io/assets/upgrade/benefits-tablet-2-b677d5b68d6a4e01d21bc1ec9ff2ad33f743a4b6749a462b68ddb9c5a3dd88ce.webp"
                                    media="(min-width: 641px) and (max-width: 1024px)" type="image/webp">
                            <source
                                    srcset="//cdn0.careerhunter.io/assets/upgrade/benefits-mobile-2-8a443b1e37aa7b25d6d48056d538176a92c2f7f6f782222614cdb9c0e621f227.webp"
                                    media="(min-width: 320px) and (max-width: 640px)" type="image/webp">
                            <img loading="lazy" alt="Reveal your strengths" class="show-for-large before-fade-in"
                                 src="//cdn0.careerhunter.io/assets/upgrade/benefits-desktop-2-ef302ca26bc64de38feb0323f041fd1a4870326940f3a0e15f1bb782ee9cf312.png">
                            <img loading="lazy" alt="Reveal your strengths" class="show-for-medium-only"
                                 src="//cdn3.careerhunter.io/assets/upgrade/benefits-tablet-2-bc706e87d3113ed85b18ccb3d94ed42994ca2f805d1707d6ea2958264ba0b817.png">
                            <img loading="lazy" alt="Reveal your strengths" class="show-for-small-only"
                                 src="//cdn1.careerhunter.io/assets/upgrade/benefits-mobile-2-235fe4465816f7794d5163b949ba3a857dd9cbccd9c68370a6e4b8b203b40a73.png">
                        </picture>
                    </div>
                </div>
                <div class="large-6 medium-12 large-order-2 small-order-1 cell upgrade-benefits__wrapper">
                    <h3 class="upgrade-benefits__title before-fade-in">Phương pháp đánh giá chính xác và đáng tin
                        cậy </h3>
                    <h2 class="upgrade-benefits__subtitle before-fade-in">Phát hiện thế mạnh của bạn cần phát huy
                    </h2>
                    <p class="upgrade-benefits__desc upgrade-benefits__desc--marginless before-fade-in">Tìm hiểu về
                        tài năng thực sự, tính cách trong công việc và động lực nghề nghiệp của bạn để xem xét mức
                        ảnh hưởng đối với lựa chọn nghề nghiệp tương lai của bạn bằng cách thực hiện bài khảo sát
                        trắc nghiệm theo nguyên lý của John Lewis Holland (nhà tâm lý học nổi tiếng thế giới người
                        Mỹ) đối với cả 6 thể loại nghề nghiệp (R - Hành động thực tế, I - Nghiên cứu & Điều tra, A -
                        Nghệ thuật & Sáng tạo, S - Xã hội & Cộng đồng, E - Quản lý & Điều hành, C - Nghiệp vụ & Tổ
                        chức). </p>
                </div>
            </div>
        </div>
    </div>
    <div class="people-trusted apply-fade-in before-fade-in">
        <div class="circle left-small show-for-large"></div>
        <div class="circle right-small hide-for-small-only"></div>
        <div class="green-circle left-large show-for-large"></div>
        <div class="green-circle half-right-large show-for-medium-only"></div>
        <div class="green-circle right-large show-for-large"></div>
        <div class="grid-container">
            <div class="grid-x text-center">
                <div class="small-12 cell">
                    <div class="people-trusted__img-wrapper">
                        <h2 class="people-trusted__title before-fade-in">Hơn 260 trường đại học ở Việt Nam</h2>
                        <p style="font-size: 23px;"
                                class="people-trusted__description people-trusted__description--upgrade show-for-large before-fade-in">
                            đang hướng tới áp dụng kết quả từ nguyên lý Holland Codes như của TeenCodes trong quá trình tuyển sinh vào các ngành học của từng trường.</p>
                    </div>
                    <p class="people-trusted__description hide-for-large">have trusted us to find their career
                        matches</p>
                </div>
            </div>
        </div>
    </div>
    <div class="upgrade-benefits upgrade-benefits--section-3">
        <div class="grid-container">
            <div class="grid-x align-middle">
                <div class="large-6 medium-12 cell">
                    <div class="green-circle right-large hide-for-small-only"></div>
                    <div class="circle bottom-left-small hide-for-small-only"></div>
                    <h3 class="upgrade-benefits__title before-fade-in">Thông tin chi tiết được cá nhân hóa </h3>
                    <h2 class="upgrade-benefits__subtitle before-fade-in">Tải báo cáo hướng nghiệp chi tiết </h2>
                    <p class="upgrade-benefits__desc before-fade-in">Kết quả khảo sát, đánh giá và tư vấn dành cho
                        bạn được tổng hợp thành Báo cáo tư vấn TeenCodes phù hợp để bạn tải xuống bất cứ lúc nào.
                        Bạn cũng sẽ có quyền truy cập trực tuyến vào trang Báo cáo của mình để tham khảo các dữ liệu
                        thông tin (liên tục được cập nhật) trước khi bạn phải lựa chọn nghề nghiệp tương lai của
                        mình. </p>
                </div>
                <div class="large-6 medium-12 cell">
                    <div class="upgrade-benefits__imgs">
                        <picture>
                            <source
                                    srcset="//cdn2.careerhunter.io/assets/upgrade/benefits-desktop-3-e03c802b668e22d4cd4ad90cd1184151ffdc57fd3503a594a28283b89fece7ea.webp"
                                    media="(min-width: 1025px)" type="image/webp">
                            <source
                                    srcset="//cdn2.careerhunter.io/assets/upgrade/benefits-desktop-3-e03c802b668e22d4cd4ad90cd1184151ffdc57fd3503a594a28283b89fece7ea.webp"
                                    media="(min-width: 641px) and (max-width: 1024px)" type="image/webp">
                            <source
                                    srcset="//cdn2.careerhunter.io/assets/upgrade/benefits-mobile-3-d4d55d878c3e3bc4c6bc91c9ba06a2bd539f81eb6d12b9495d2259a733a2c326.webp"
                                    media="(min-width: 320px) and (max-width: 640px)" type="image/webp">
                            <img loading="lazy" alt="Personalised assessment" class="show-for-large before-fade-in"
                                 src="//cdn0.careerhunter.io/assets/upgrade/benefits-desktop-3-fffce3f5af8bcf91c4951ca5cd03e139eabcbbea9aca11efd168474813e02819.png">
                            <img loading="lazy" alt="Personalised assessment" class="show-for-medium-only"
                                 src="//cdn0.careerhunter.io/assets/upgrade/benefits-desktop-3-fffce3f5af8bcf91c4951ca5cd03e139eabcbbea9aca11efd168474813e02819.png">
                            <img loading="lazy" alt="Personalised assessment" class="show-for-small-only"
                                 src="//cdn1.careerhunter.io/assets/upgrade/benefits-mobile-3-d6dcdda8212ad8f8965441bc720132f0840cdcdd91e628a344aa2cb9c46e9030.png">
                        </picture>
                    </div>
                </div>
                <div class="small-6 cell text-center" style="padding-right: 10px;">
                    <a href="/checkout" aria-label="Unlock Tests"
                       class="button button--with-icon button--green button--green--big before-fade-in"
                       style="margin:0 auto" data-checkout-link="">Tôi đăng ký dịch vụ <span
                                class="small-icons checkout-card before-fade-in"></span><span
                                class="button__hovered"></span></a>
                    <p class="upgrade__price before-fade-in">Phí trả một lần chỉ
                        $79.99
                        <span class="upgrade__free-test">hoặc <a href="/tests/interests/take" aria-label="Free Test"
                                                                 class="before-fade-in"> thử sử dụng gói KHÁM PHÁ (miễn phí) </a></span>
                    </p>
                </div>
                <div class="small-6 cell text-center" style="padding-left: 10px;">
                    <a href="/checkout" aria-label="Unlock Tests"
                       class="button button--with-icon button--green button--green--big before-fade-in"
                       style="margin:0 auto" data-checkout-link="">Đăng ký nhóm <span
                                class="small-icons checkout-card before-fade-in"></span><span
                                class="button__hovered"></span></a>
                    <p class="upgrade__price before-fade-in"> Trả phí chỉ một lần cho cả nhóm
                        <span class="upgrade__free-test"> <a href="/tests/interests/take" aria-label="Free Test"
                                                             class="before-fade-in"> Tham khảo dành cho giáo viên </a></span>
                    </p>
                </div>
            </div>
        </div>
    </div>
    <div class="upgrade-student-discount" id="our_student-discount">
        <div class="grid-container">
            <div class="circle left-large show-for-large"></div>
            <div class="circle left-small show-for-large"></div>
            <div class="circle right-small show-for-large"></div>
            <div class="green-circle right-large show-for-large"></div>
            <div class="upgrade-student-discount__box">
                <div class="large-icon disable-fade-in student-discount-big"></div>
                <div>
                    <h2 class="upgrade-student-discount__title before-fade-in" style="color: #fff;">Hỗ trợ dành
                        riêng cho giáo viên </h2>
                    <p class="upgrade-student-discount__description before-fade-in">Nếu bạn là giáo viên, bạn được
                        đăng ký Nhóm TeenCodes cho các học sinh của mình với yêu cầu nhận ưu đãi giảm giá từ 10%
                        (cho tất cả học sinh) và được nhận thêm phần phí quản lý dữ liệu xứng đáng dành cho riêng
                        giáo viên. </p>
                    <a href="{{ route('dichvunhom') }}" aria-label="Student Discount"
                       class="button button--with-icon button--white button--white--small before-fade-in"> Đăng ký nhận hỗ trợ<span class="small-icons next-arrow-white-xs before-fade-in"></span><span
                                class="button__hovered"></span></a>
                </div>
            </div>
        </div>
            ...
            <div class="grid-x">
                <div class="small-12 cell">
                    <div class="swiper-container">
                        <div data-react-class="upgrade/servicesSlider" data-react-props="{}"
                             data-react-cache-id="upgrade/servicesSlider-0">
                            <div class="">
                                <div class="slick-slider upgrade-services__slider slick-initialized">
                                    <div class="slick-list">
                                        <div class="slick-track"
                                             style="width: 1164px; opacity: 1; transform: translate3d(0px, 0px, 0px);">
                                            <div data-index="0" class="slick-slide slick-active slick-current"
                                                 tabindex="-1" aria-hidden="false"
                                                 style="outline: none; width: 388px;">
                                                <div>
                                                    <div class="small-12 cell upgrade-services__block" tabindex="-1"
                                                         style="width: 100%; display: inline-block;">
                                                        <div class="upgrade-services__card">
                                                            <picture>
                                                                <source
                                                                        srcset="//cdn0.careerhunter.io/packs/media/upgrade_components/upgrade/industryExperts-e96943b28a065a8bfedf4bbf0a2e62f1.webp"
                                                                        type="image/webp"><img
                                                                        src="//cdn0.careerhunter.io/packs/media/upgrade_components/upgrade/industryExperts-2b28bac3170310750c9e79944c051388.png"
                                                                        alt="industry Experts" loading="lazy">
                                                            </picture>
                                                            <div class="upgrade-services__content">
                                                                <h3 class="upgrade-services__title">Phát triển từ
                                                                    nguyên cứu của nhà khoa học người Mỹ </h3>
                                                                <p class="upgrade-services__desc">Thuật toán tự động
                                                                    độc đáo của TeenCodes được xây dựng theo đặc thù
                                                                    và luôn cập nhật từ thực tế của Việt Nam, vì vậy
                                                                    bạn có thể hoàn toàn tin tưởng vào kết quả nhận
                                                                    được.
                                                                </p>
                                                            </div>
                                                        </div>
                                            ...
                                            <div data-index="1" class="slick-slide slick-active" tabindex="-1"
                                                 aria-hidden="false" style="outline: none; width: 388px;">
                                                <div>
                                                    <div class=" small-12 cell upgrade-services__block"
                                                         tabindex="-1" style="width: 100%; display: inline-block;">
                                                        <div class="upgrade-services__card">
                                                            <picture>
                                                                <source
                                                                        srcset="//cdn0.careerhunter.io/packs/media/how_works/4-4344c224.webp"
                                                                        type="image/webp"><img
                                                                        src="//cdn0.careerhunter.io/packs/media/how_works/4-c456df17.png"
                                                                        alt="recommended Jobs" loading="lazy">
                                                            </picture>
                                                            <div class="upgrade-services__content">
                                                                <h3 class="upgrade-services__title">Tuyển chọn từ
                                                                    hơn 1.200 chuyên ngành đào tạo </h3>
                                                                <p class="upgrade-services__desc">Bạn sẽ nhận được
                                                                    đề xuất về các chuyên ngành học, nghề nghiệp
                                                                    (đang được đào tạo ở Việt Nam) phù hợp với sở
                                                                    thích, tính cách và khả năng của bạn. </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    <div class=" small-12 cell upgrade-services__block"
                                                        ...
                                                        <div class="upgrade-services__card">
                                                            <picture>
                                                                <source
                                                                        srcset="//cdn0.careerhunter.io/packs/media/upgrade_components/upgrade/lifetimeAccess-ae724f7acd9b0f38a25697cee4e11153.webp"
                                                                        type="image/webp"><img
                                                                        src="//cdn0.careerhunter.io/packs/media/upgrade_components/upgrade/lifetimeAccess-8b48227c9571264946dd9ab39c7208f3.png"
                                                                        alt="lifetime Access" loading="lazy">
                                                            </picture>
                                                            <div class="upgrade-services__content">
                                                                <h3 class="upgrade-services__title">Truy cập không
                                                                    giới hạn và nhận tư vấn trong 12 tháng </h3>
                                                                <p class="upgrade-services__desc">Với khoản phí một
                                                                    lần, bạn sẽ có quyền truy cập không giới hạn vào
                                                                    Báo cáo tư vấn TeenCodes luôn được cập nhật theo
                                                                    thực tế dành cho bạn trong vòng 12 tháng. </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div class="cm-guarantee" id="our_guarantee">
        <div class="circle right-medium show-for-large"></div>
        <div class="circle bot-right-small show-for-large"></div>
        <div class="circle left-small show-for-large"></div>
        <div class="circle left-large show-for-large"></div>

        <div class="grid-container">
            <div class="cm-guarantee__box">
                <div class="large-icon guarantee-large apply-fade-in before-fade-in"></div>
                <div>
                    <h2 class="cm-guarantee__title before-fade-in">TeenCodes đảm bảo chất lượng </h2>
                    <p class="cm-guarantee__desc before-fade-in">Bạn sử dụng dịch vụ của TeenCodes với sự tự tin và
                        yên tâm với đảm bảo hoàn tiền trong 20 ngày. Đó là mức độ TeenCodes tự tin và tin tưởng rằng
                        bạn sẽ thấy kết quả của mình vừa chính xác vừa giá tri. Thông tin chi tiết có tại Điều khoản
    ...
    <div class="upgrade-users" id="who_can_use">
        <!--  we need to create new only for upgrade page-->
        <div class="grid-container">
            <div class="grid-x text-center">
                <div class="small-12 cell">
                    <h2 class="upgrade-users__title before-fade-in">Dịch vụ này dành riêng cho ai </h2>
                    <p class="upgrade-users__description before-fade-in">Bài khảo sát trắc nghiệm của TeenCodes rất có ích cho các bạn Teen từ 14-19 tuổi có chí tiến thủ.
                    </p>
                </div>
                <div class="large-6 medium-12 small-12 cell">
                    <img alt="School leavers" class="show-for-small-only" width="110" height="118" loading="lazy"
                         src="//cdn1.careerhunter.io/assets/upgrade/school-leavers-1e2ebc4b6ae9b030199fd306fbf023000051b7adb1b69270b840868f92cf984d.png">
                    <div class="upgrade-users__block upgrade-users__block--on-left">
                        <div class="upgrade-users__block-img left">
                            <img alt="School leavers" class="hide-for-small-only before-fade-in" width="110"
                                 height="118" loading="lazy"
                                 src="//cdn1.careerhunter.io/assets/upgrade/school-leavers-1e2ebc4b6ae9b030199fd306fbf023000051b7adb1b69270b840868f92cf984d.png">

                        </div>
                        <div class="upgrade-users__block-details">
                            <h3 class="upgrade-users__block-title before-fade-in">Học sinh trung học cơ sở </h3>
                            <p class="upgrade-users__block-desc before-fade-in">Bạn đang chuẩn bị bước lên bậc học
                                THPT và bắt đầu có mơ ước về tương lai của mình? Hãy sử dụng TeenCodes để được tư
                                vấn hướng nghiệp sớm từ các môn học yêu thích cho bạn. </p>
                        </div>
                    </div>
                </div>
                <div class="large-6 medium-12 small-12 cell">
                    <img alt="Students &amp; Graduates" class="show-for-small-only" width="102" height="128"
                         loading="lazy"
                         src="//cdn0.careerhunter.io/assets/upgrade/students-graduates-b9598ed4c27d88631fd2d6e96d045cfbff000df468634221b7743961a8695505.png">
                    <div class="upgrade-users__block upgrade-users__block--on-right">
                        <div class="upgrade-users__block-details">
                            <h3 class="upgrade-users__block-title before-fade-in">Chuẩn bị nhập học lớp 10 </h3>
                            <p class="upgrade-users__block-desc before-fade-in">Bạn vừa trúng tuyển vào lớp 10 THPT
                                và ngay lập tức phải lựa chọn các môn học ở trường trung học của mình ? Kết quả từ
                                bài trắc nghiệm TeenCodes sẽ giúp bạn có quyết định phù hợp nhất hướng đến nhóm
                                ngành nghề tương lai mà bạn yêu thích. </p>
                        </div>
                        <div class="upgrade-users__block-img">
                            <img alt="Students &amp; Graduates" class="hide-for-small-only before-fade-in"
                                 width="102" height="128" loading="lazy"
                                 src="//cdn0.careerhunter.io/assets/upgrade/students-graduates-b9598ed4c27d88631fd2d6e96d045cfbff000df468634221b7743961a8695505.png">
                ...
                <!-- <div class="large-6 medium-12 small-12 cell">
                    <img alt="workers" class="show-for-small-only" width="102" height="118" loading="lazy"
                        src="//cdn0.careerhunter.io/assets/upgrade/workers-524464c73c4a8513126f763e4d92a827e706e932b70cc76eed53f614a8659372.png">
                    <div class="upgrade-users__block upgrade-users__block--on-left">
                        <div class="upgrade-users__block-img left">
                            <img alt="workers" class="hide-for-small-only before-fade-in" width="102" height="118"
                                loading="lazy"
                                src="//cdn0.careerhunter.io/assets/upgrade/workers-524464c73c4a8513126f763e4d92a827e706e932b70cc76eed53f614a8659372.png">
                        </div>
                        <div class="upgrade-users__block-details">
                            <h3 class="upgrade-users__block-title before-fade-in">Workers</h3>
                            <p class="upgrade-users__block-desc before-fade-in">Currently working in an unideal role
                                and prefer a more ambitious career? Our tests will show you new job options that
                                suit your abilities and interests.</p>
                        </div>
                    </div>
                </div>
                <div class="large-6 medium-12 small-12 cell">
                    <img alt="Professionals" class="show-for-small-only" width="102" height="125" loading="lazy"
                        src="//cdn0.careerhunter.io/assets/upgrade/professionals-42629b278269b1d27861128a8057dc5855cd8f5d9a4f21eecea34a5b495171f2.png">
                    <div class="upgrade-users__block upgrade-users__block--on-right">
                        <div class="upgrade-users__block-details">
                            <h3 class="upgrade-users__block-title before-fade-in">Professionals</h3>
                            <p class="upgrade-users__block-desc before-fade-in">If you’re already a working
                                professional but desire a career which fits all your traits, abilities and work
                                preferences better, CareerHunter can help.</p>
                        </div>
                        <div class="upgrade-users__block-img">
                            <img alt="Professionals" class="hide-for-small-only before-fade-in" width="102"
                ...
                <div class="large-6 medium-12 small-12 cell">
                    <img alt="Career changers" class="show-for-small-only" width="102" height="113" loading="lazy"
                        src="//cdn3.careerhunter.io/assets/upgrade/career-changers-f19b23bd1a0f6cbc540ab157dfd69ffbaaf0cbb76c95d3631f716c91f56774f2.png">
                    <div class="upgrade-users__block upgrade-users__block--on-left">
                        <div class="upgrade-users__block-img left">
                            <img alt="Career changers" class="hide-for-small-only before-fade-in" width="102"
                                height="113" loading="lazy"
                                src="//cdn3.careerhunter.io/assets/upgrade/career-changers-f19b23bd1a0f6cbc540ab157dfd69ffbaaf0cbb76c95d3631f716c91f56774f2.png">

                        </div>
                        <div class="upgrade-users__block-details">
                            <h3 class="upgrade-users__block-title before-fade-in">Career Changers</h3>
                            <p class="upgrade-users__block-desc before-fade-in">No longer satisfied with what you
                                do? Thinking about switching careers? CareerHunter can easily help you decide on a
                                path that suits you best.</p>
                        </div>
                    </div>
                </div>
                <div class="large-6 medium-12 small-12 cell">
                    <img alt="unemployed" class="show-for-small-only" width="110" height="122" loading="lazy"
                        src="//cdn2.careerhunter.io/assets/upgrade/unemployed-f99488775f7281630d842131e95439b21254dd3f4179d011bae84f6c079fc24f.png">
                    <div class="upgrade-users__block upgrade-users__block--on-right">
                        <div class="upgrade-users__block-details">
                            <h3 class="upgrade-users__block-title before-fade-in">Unemployed</h3>
                            <p class="upgrade-users__block-desc before-fade-in">If you’re currently looking for a
                                job, now is the perfect time to ensure your next move sets you on the right journey.
                                CareerHunter will set you up for success!</p>
                        </div>
                        <div class="upgrade-users__block-img right-space">
                            <img alt="unemployed" class="hide-for-small-only before-fade-in" width="110"
    ...
    <div class="upgrade-steps" id="how_it_works">
        <div class="circle left-small hide-for-small-only"></div>
        <div class="circle right-small hide-for-small-only"></div>
        <div class="green-circle right-large hide-for-small-only"></div>
        <div class="grid-container no-side-pad-med">
            <div class="grid-x text-center">
                <div class="small-12 cell">
                    <h2 class="upgrade-steps__headline before-fade-in">Nguyên lý vận hành tự động của TeenCodes
                    </h2>
                    <p class="upgrade-steps__subheader before-fade-in">Hệ thống logic và tính khoa học từ bài trắc
                        nghiệm đã được kiểm chứng!
                    </p>
                    <div class="swiper-container">
                        <div data-react-class="upgrade/howWorksSlider" data-react-props="{}"
                             data-react-cache-id="upgrade/howWorksSlider-0">
                            <div class="">
                                <div class="slick-slider upgrade-steps__slider slick-initialized">
                                    <div class="slick-list">
                                        <div class="slick-track"
                                             style="width: 1185px; opacity: 1; transform: translate3d(0px, 0px, 0px);">
                                            <div data-index="0" class="slick-slide slick-active slick-current"
                                                 tabindex="-1" aria-hidden="false"
                                                 style="outline: none; width: 395px;">
                                                <div>
                                                    <div class="upgrade-steps__block" tabindex="-1"
                                                         style="width: 100%; display: inline-block;">
                                                        <picture>
                                                            <source
                                                                    srcset="//cdn0.careerhunter.io/packs/media/how_works/1-86cf5d79.webp"
                                                                    type="image/webp"><img
                                                                    src="//cdn0.careerhunter.io/packs/media/how_works/1-5e0f207a.png"
                                                                    alt="industry Experts" loading="lazy">
                                                        </picture>
                                                        <div class="upgrade-steps__number apply-fade-in">
                                                            <span>1</span>
                                                        </div>
                                                        <div class="upgrade-steps__content">
                                                            <div class="medium-flex-center">
                                                                <div class="large-icon white-tick-icons"></div>
                                                                <h3 class="upgrade-steps__title">Hoàn thành bài khảo
                                                                    sát trắc nghiệm đơn giản </h3>
                                                            </div>
                                                            <p class="upgrade-steps__desc">Khảo sát sở thích, tính cách, động lực, năng khiếu của bạn bằng nguyên lý Holland Codes để hiểu biết chính xác về điểm mạnh, điểm yếu, sở thích, giá trị bản thân của bạn. </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div data-index="1" class="slick-slide slick-active" tabindex="-1"
                                                 aria-hidden="false" style="outline: none; width: 395px;">
                                                <div>
                                                    <div class="upgrade-steps__block" tabindex="-1"
                                                         style="width: 100%; display: inline-block;">
                                                        <picture>
                                                            <source
                                                                    srcset="//cdn0.careerhunter.io/packs/media/how_works/2-9eea48b1.webp"
                                                                    type="image/webp"><img
                                                                    src="//cdn0.careerhunter.io/packs/media/how_works/2-9ec6aa6b.png"
                                                                    alt="industry Experts" loading="lazy">
                                                        </picture>
                                                        <div class="upgrade-steps__number apply-fade-in">
                                                            <span>2</span>
                                                        ...
                                                        <div class="upgrade-steps__content">
                                                            <div class="medium-flex-center">
                                                                <div class="large-icon white-luggage"></div>
                                                                <h3 class="upgrade-steps__title">TeenCodes.vn xử lý
                                                                    kết quả bằng thuật toán </span>
                                                                </h3>
                                                            </div>
                                                            <p class="upgrade-steps__desc">Công nghệ 4.0 tự động tập hợp và phân tích kết quả khảo sát của bạn dựa trên cơ sở dữ liệu cập nhật về toàn bộ nghề nghiệp đang được đào tạo tại Việt Nam.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div data-index="2" class="slick-slide slick-active" tabindex="-1"
                                                ...
                                                <div>
                                                    <div class="upgrade-steps__block" tabindex="-1"
                                                        ...
                                                        <picture>
                                                            <source
                                                                    srcset="//cdn0.careerhunter.io/packs/media/how_works/3-3b26dc84.webp"
                                                                    type="image/webp"><img
                                                                    src="//cdn0.careerhunter.io/packs/media/how_works/3-ecbd46b7.png"
                                                                    alt="industry Experts" loading="lazy">
                                                        </picture>
                                                        <div class="upgrade-steps__number apply-fade-in">
                                                            <span>3</span>
                                                        ...
                                                        <div class="upgrade-steps__content">
                                                            <div class="medium-flex-center">
                                                                <div class="large-icon white-star-box"></div>
                                                                <h3 class="upgrade-steps__title">Cung cấp dữ liệu cá
                                                                    nhân hóa dành riêng cho bạn </span></h3>
                                                            </div>
                                                            <p class="upgrade-steps__desc">Bạn nhận được các thông
                                                                tin nghề nghiệp chính xác phù hợp với kết quả bài
                                                                khảo sát của bạn cũng như tư vấn hướng nghiệp và các
                                                                khóa học phù hợp nhất đối với bạn. </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <div class="expert-review" id="the_applause">
        <div class="grid-container inner-bottom">
            <div class="grid-x">
                <div class="small-12 cell">
                    <h3 class="blue-blk__title blue-blk__title--with-mrg white before-fade-in">Đánh giá của chuyên
                        gia
                    </h3>
                    <h4 class="blue-blk__mini-subtitle before-fade-in">Ý kiến chứng thực trực tiếp từ các chuyên gia
                        về TeenCodes </h4>
                </div>
            </div>
        </div>
        <div class="grid-container review__container">
            <div data-react-class="reviews/reviewSlider"
                 data-react-props="{&quot;reviews&quot;:[{&quot;id&quot;:2,&quot;order&quot;:1,&quot;name&quot;:&quot;Chelsea Jay&quot;,&quot;description&quot;:&quot;This is truly the modern version of Myer Briggs assessments! Accurate, detailed, and extremely informative. The quizzes are not time consuming and extremely engaging. All of the tests are able to easily pinpoint your strengths and weaknesses upon completion. I truly loved reading my test results and found myself nodding the entire way through. Not only do they provide you with your highest scoring “matches,” they also provide you with a detailed overview of the career’s job description, common duties, salary, job outlook, preferred work environment, and so much more. This platform is perfect for recent graduates and career changers! Going forward I will make sure to utilize this resource for my clients as well.&quot;,&quot;position&quot;:&quot;Resume Writer \u0026 Career Coach&quot;,&quot;company&quot;:&quot;Seasoned and Growing&quot;,&quot;website&quot;:null,&quot;twitter&quot;:null,&quot;linkedin&quot;:null,&quot;image&quot;:{&quot;id&quot;:650,&quot;original&quot;:&quot;https://www.careerhunter.io/uploads/expertreviewimage/650/chelsea-jay.jpg&quot;}},{&quot;id&quot;:3,&quot;order&quot;:2,&quot;name&quot;:&quot;Bergin Sullivan&quot;,&quot;description&quot;:&quot;Being a younger candidate dipping my toes in the water of the professional world, I found the CareerAddict tests to be extremely helpful and eye-opening. I am a recent college graduate (May ’19) and currently working towards my master’s degree. I have always known I had a passion for leadership, marketing and business in general, but struggled to think of a definite “dream job”. The 6 tests helped me get a better idea of what that “dream job” could look like for me.  By going through the first three tests – Career Interests, Work Personality \u0026 Career Motivators, they showed me some new aspects of myself as well as re-instated some things I already knew. The last three tests – Abstract Reasoning, Numerical Reasoning and Verbal Reasoning really opened my eyes to my strengths and weaknesses in reasonings and problem-solving skills. Upon completion of the tests, I found the detailed report to be extremely helpful, pointing out careers I am most compatible with as well as salary breakdowns and more. All in all, I would recommend CareerAddict to anyone trying to figure out their next step in their careers. It’s a great way to get a better understanding of your internal strengths and how those can match up in the professional world.&quot;,&quot;position&quot;:&quot;Creative Marketing Specialist&quot;,&quot;company&quot;:&quot;JCSI PRO&quot;,&quot;website&quot;:null,&quot;twitter&quot;:null,&quot;linkedin&quot;:null,&quot;image&quot;:{&quot;id&quot;:649,&quot;original&quot;:&quot;https://www.careerhunter.io/uploads/expertreviewimage/649/bergin-sullivan.jpeg&quot;}},{&quot;id&quot;:1,&quot;order&quot;:3,&quot;name&quot;:&quot;Rachel Wells&quot;,&quot;description&quot;:&quot;CareerHunter is one of the most accurate career discovery platforms I have seen. Some of the questions in the 6 tests may not make sense initially, but once the tests are completed, you're able to see the big picture as to why they are so important to understanding what your career interests and passions are, and what job best suits you. The features are easy to use and clear to understand, with very personalised results. I love the downloadable PDF at the end of completing all tests. It has very accurate recommendations for suitable careers as well as assessing what motivates you at work, and what your preferred working environment is. I would highly recommend CareerHunter and intend on using it to help my career coaching clients.&quot;,&quot;position&quot;:&quot;Career Coach&quot;,&quot;company&quot;:&quot;Distinction Career Transformation Coaching&quot;,&quot;website&quot;:null,&quot;twitter&quot;:null,&quot;linkedin&quot;:null,&quot;image&quot;:{&quot;id&quot;:651,&quot;original&quot;:&quot;https://www.careerhunter.io/uploads/expertreviewimage/651/rachel-wells.jpg&quot;}}]}"
                 data-react-cache-id="reviews/reviewSlider-0">
                <div class="">
                    <div class="slick-slider review__slider slick-initialized" dir="ltr">
                        <div class="slick-arrow slick-prev slick-disabled" style="display: block;"><span
                                    class="slider-arrow slider-arrow--prev"></span></div>
                        <div class="slick-list">
                            <div class="slick-track"
                                 style="width: 1791px; opacity: 1; transform: translate3d(0px, 0px, 0px);">
                                <div data-index="0" class="slick-slide slick-active slick-current" tabindex="-1"
                                     aria-hidden="false" style="outline: none; width: 597px;">
                                    <div>
                                        <div class="review__slide" data-more-less-container="true"
                                             data-more-less-short-fade="true" data-more-less-short="">
                                            <div class="grid-x">
                                                <div class="small-10 cell">
                                                    <h3 class="review__slide-name mar-bot-20">Chelsea Jay<div
                                                                class="review__icons"></div>
                                                    </h3>
                                                    <h3 class="review__slide-details white">Resume Writer &amp;
                                                        Career Coach</h3>
                                                    <h4 class="review__slide-details review__company mar-bot-20">
                                                        Seasoned and Growing</h4>
                                                </div>
                                                <div class="small-2 cell flex-end">
                                                    <div class="review__pic"
                                                         style="background-image: url(&quot;https://www.careerhunter.io/uploads/expertreviewimage/650/chelsea-jay.jpg&quot;); background-size: cover; background-position: center center;">
                                                    </div>
                                                </div>
                                            </div>
                                            <p class="review__desc" data-more-less-content=""
                                               data-more-less-enabled="true" style="max-height: 100px;">This is
                                                truly the modern version of Myer Briggs assessments! Accurate,
                                                detailed, and extremely informative. The quizzes are not time
                                                consuming and extremely engaging. All of the tests are able to
                                                easily pinpoint your strengths and weaknesses upon completion. I
                                                truly loved reading my test results and found myself nodding the
                                                entire way through. Not only do they provide you with your highest
                                                scoring “matches,” they also provide you with a detailed overview of
                                                the career’s job description, common duties, salary, job outlook,
                                                preferred work environment, and so much more. This platform is
                                                perfect for recent graduates and career changers! Going forward I
                                                will make sure to utilize this resource for my clients as well.</p>
                                            <p data-more-less-ctrl="true" class="how__illustrations--more"
                                               style="visibility: visible;">Read more</p>
                                        </div>
                                    </div>
                                </div>
                                <div data-index="1" class="slick-slide slick-active" tabindex="-1"
                                    ...
                                    <div>
                                        <div class="review__slide" data-more-less-container="true"
                                            ...
                                            <div class="grid-x">
                                                <div class="small-10 cell">
                                                    <h3 class="review__slide-name mar-bot-20">Bergin Sullivan<div
                                                                class="review__icons"></div>
                                                    </h3>
                                                    <h3 class="review__slide-details white">Creative Marketing
                                                        Specialist</h3>
                                                    <h4 class="review__slide-details review__company mar-bot-20">
                                                        JCSI PRO</h4>
                                                </div>
                                                <div class="small-2 cell flex-end">
                                                    <div class="review__pic"
                                                         style="background-image: url(&quot;https://www.careerhunter.io/uploads/expertreviewimage/649/bergin-sullivan.jpeg&quot;); background-size: cover; background-position: center center;">
                                                    </div>
                                                </div>
                                            </div>
                                            <p class="review__desc" data-more-less-content=""
                                               data-more-less-enabled="true" style="max-height: 100px;">Being a
                                                younger candidate dipping my toes in the water of the professional
                                                world, I found the CareerAddict tests to be extremely helpful and
                                                eye-opening. I am a recent college graduate (May ’19) and currently
                                                working towards my master’s degree. I have always known I had a
                                                passion for leadership, marketing and business in general, but
                                                struggled to think of a definite “dream job”. The 6 tests helped me
                                                get a better idea of what that “dream job” could look like for me.
                                                By going through the first three tests – Career Interests, Work
                                                Personality &amp; Career Motivators, they showed me some new aspects
                                                of myself as well as re-instated some things I already knew. The
                                                last three tests – Abstract Reasoning, Numerical Reasoning and
                                                Verbal Reasoning really opened my eyes to my strengths and
                                                weaknesses in reasonings and problem-solving skills. Upon completion
                                                of the tests, I found the detailed report to be extremely helpful,
                                                pointing out careers I am most compatible with as well as salary
                                                breakdowns and more. All in all, I would recommend CareerAddict to
                                                anyone trying to figure out their next step in their careers. It’s a
                                                great way to get a better understanding of your internal strengths
                                                and how those can match up in the professional world.</p>
                                            <p data-more-less-ctrl="true" class="how__illustrations--more"
                                               style="visibility: visible;">Read more</p>
                                        </div>
                                    </div>
                                ...
                                <div data-index="2" class="slick-slide" tabindex="-1" aria-hidden="true"
                                     style="outline: none; width: 597px;">
                                    <div>
                                        <div class="review__slide" data-more-less-container="true"
                                             data-more-less-short-fade="true" data-more-less-short="">
                                            <div class="grid-x">
                                                <div class="small-10 cell">
                                                    <h3 class="review__slide-name mar-bot-20">Rachel Wells<div
                                                                class="review__icons"></div>
                                                    </h3>
                                                    <h3 class="review__slide-details white">Career Coach</h3>
                                                    <h4 class="review__slide-details review__company mar-bot-20">
                                                        Distinction Career Transformation Coaching</h4>
                                                </div>
                                                <div class="small-2 cell flex-end">
                                                    <div class="review__pic"
                                                         style="background-image: url(&quot;https://www.careerhunter.io/uploads/expertreviewimage/651/rachel-wells.jpg&quot;); background-size: cover; background-position: center center;">
                                                    </div>
                                                </div>
                                            </div>
                                            <p class="review__desc" data-more-less-content=""
                                               data-more-less-enabled="true" style="max-height: 100px;">
                                                CareerHunter is one of the most accurate career discovery platforms
                                                I have seen. Some of the questions in the 6 tests may not make sense
                                                initially, but once the tests are completed, you're able to see the
                                                big picture as to why they are so important to understanding what
                                                your career interests and passions are, and what job best suits you.
                                                The features are easy to use and clear to understand, with very
                                                personalised results. I love the downloadable PDF at the end of
                                                completing all tests. It has very accurate recommendations for
                                                suitable careers as well as assessing what motivates you at work,
                                                and what your preferred working environment is. I would highly
                                                recommend CareerHunter and intend on using it to help my career
                                                coaching clients.</p>
                                            <p data-more-less-ctrl="true" class="how__illustrations--more"
                                               style="visibility: visible;">Read more</p>
                                        </div>
                        ...
                        <div class="slick-arrow slick-next" style="display: block;"><span
                                    class="slider-arrow slider-arrow--next"></span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bottom-banner">
        <img class="wave-top wave-top-small before-fade-in" loading="lazy" alt="Perfect career wave"
             src="//cdn0.careerhunter.io/assets/upgrade/wave-top-48ad3a7b57599dd38621ac0130144bcfd25f03dabb8b48f37038558c9a91557f.png">
        <div class="circle left-large hide-for-small-only"></div>
        <div class="circle left-small  hide-for-small-only"></div>
        <div class="grid-container ">
            <div class="grid-x text-center">
                <h2 class="bottom-banner__headline before-fade-in">Bạn đã sẵn sàng "mở khóa" tương lai của mình chưa ?			</h2>
                <p class="bottom-banner__desc bottom-banner__desc--more-space before-fade-in" style="width: 100%; font-size: 19px;">
                    Từ bài trắc nghiệm của bạn, TeenCodes sẽ giúp cho bạn có sự lựa chọn nghề nghiệp tương lai đúng đắn và phù hợp nhất với bản thân.			</p>
                <div class="small-6 cell text-center" style="padding-right: 10px;">
                    <a href="/checkout" aria-label="Unlock Tests"
                       class="button button--with-icon button--green button--green--big before-fade-in"
                       style="margin:0 auto" data-checkout-link="">Tôi đăng ký dịch vụ <span
                    ...
                    <p class="upgrade__price before-fade-in">Phí trả một lần chỉ
                        $79.99
                        <span class="upgrade__free-test">hoặc <a href="/tests/interests/take" aria-label="Free Test"
                                                                 class=""> thử sử dụng gói KHÁM PHÁ (miễn phí) </a></span>
                    </p>
                </div>
                <div class="small-6 cell text-center" style="padding-left: 10px;">
                    <a href="/checkout" aria-label="Unlock Tests"
                    ...
                    <p class="upgrade__price before-fade-in"> Trả phí chỉ một lần cho cả nhóm
                        <span class="upgrade__free-test"> <a href="/tests/interests/take" aria-label="Free Test"
                                                             class=""> Tham khảo dành cho giáo viên </a></span>
                    </p>
                </div>
            </div>
            <div class="circle right-large show-for-large"></div>
            <div class="circle right-small show-for-large"></div>
            <div class="circle right-medium show-for-large"></div>
        </div>
    </div>
...
<style>
    ...
    .license-checkout__container .upgrade-form .err input,
    .license-checkout__container .upgrade-form .err select,
    .license-checkout__container .upgrade-form .err textarea {
    ...
    .license-checkout.full-access .license-checkout__box.license-checkout__is-stuck h3,
    .license-checkout.full-access .license-checkout__box.license-checkout__is-stuck .group__price {
        font-size: 15px;
        line-height: 1
    }

    .license-checkout.full-access .license-checkout__box.license-checkout__is-stuck h3 p span,
    .license-checkout.full-access .license-checkout__box.license-checkout__is-stuck .group__price p span {
        font-size: 15px !important
    }

    .license-checkout.full-access .license-checkout__box.license-checkout__is-stuck h3 p span.small,
    .license-checkout.full-access .license-checkout__box.license-checkout__is-stuck .group__price p span.small {
    ...
    @media screen and (max-width: 39.99875em) {
        ...
        .license-checkout.for-educators .small-icons.visa-card,
        .license-checkout.for-educators .small-icons.master-card,
        .license-checkout.for-educators .small-icons.am-express-card,
        .license-checkout.for-educators .small-icons.union-card {
            top: 0
        }
    }
    ...
    .users__table tbody tr:hover .small-icon,
    .users__table tbody tr:hover .trash-icon {
        opacity: 1
    }
    ...
    .users__table .small-icon,
    .users__table .trash-icon {
        display: inline-block;
        opacity: 0.5;
        cursor: pointer
    }
    ...
    .users__pagination .pagination-previous a,
    .users__pagination .pagination-next a {
        background-color: transparent
    }
    ...
    .why-ch .accordion .accordion-content,
    .why-ch .accordion .accordion-content p {
        color: rgba(10, 30, 46, 0.5)
    }
    ...
    .review__icons .linkedin,
    .review__icons .twitter,
    .review__icons .web {
        display: inline-block;
        margin: 0 10px
    }
    ...
    .simple-top-hero--how .circle,
    .simple-top-hero--about .circle {
        position: absolute;
    ...
    .simple-top-hero--how .circle.small-right,
    .simple-top-hero--about .circle.small-right {
        width: 30px;
        height: 30px;
        top: 150px;
        right: 50px
    ...
    .simple-top-hero--how .circle.half-right,
    .simple-top-hero--about .circle.half-right {
        top: 180px;
        right: 0;
        width: 65px;
        height: 130px;
    ...
    .simple-top-hero--how .circle.small-left,
    ...
    .simple-top-hero--how .green-circle,
    .simple-top-hero--about .green-circle {
        position: absolute;
    ...
    .simple-top-hero--how .green-circle.half-bot,
    ...
    .simple-top-hero--how .green-circle.right-med,
    .simple-top-hero--about .green-circle.right-med {
        width: 50px;
        height: 50px;
        bottom: 74px;
        right: 115px
    ...
    .discount__verify .input-with-icon input::placeholder,
    .discount__verify .input-with-icon input:focus {
        color: rgba(10, 30, 46, 0.5) !important
    }

    .discount__verify .input-with-icon input:-webkit-autofill,
    .discount__verify .input-with-icon input:-webkit-autofill:hover,
    .discount__verify .input-with-icon input:-webkit-autofill:focus,
    .discount__verify .input-with-icon input:-webkit-autofill:active {
    ...
    @media screen and (min-width: 64.0625em) {
        ...
        .discount__services--section-2 .discount__services-title,
        .discount__services--section-2 .discount__services-desc {
            margin-left: 50px
        }
    }
    ...
    .upgrade-student-discount.white h2,
    .upgrade-student-discount.white p {
        color: #0A1E2E
    }
    ...
    .strong-validation.short [type='password'],
    .strong-validation.not_match [type='password'],
    .strong-validation.bad [type='password'] {
    ...
    .strong-validation.strong [type='password'],
    .strong-validation.match [type='password'] {
    ...
    *::after {
    ...
    .upgrade__free-test a {
        font-family: "Sofia-Pro-Bold", sans-serif
    }

    .upgrade__free-test--white {
        color: rgba(255,255,255,0.5)
    }

    @media screen and (min-width: 1080px) {
        .upgrade-logos__wrapper {
            margin:0 0 40px 0
        }
    }

    @media screen and (max-width: 1279px) and (min-width: 1025px) and (max-height: 760px) {
        .upgrade-logos__wrapper {
            margin:0;
            position: absolute;
            bottom: 5px
    ...
    .upgrade-logos__block img {
        -webkit-transition: all 0.3s ease;
        transition: all 0.3s ease
    }

    .upgrade-logos__block:hover img {
        opacity: 0.5
    }

    .upgrade-logos__block--right {
        margin-right: 50px
    }
    ...
    .no-webp .upgrade-top--right {
        background-image: url("//cdn3.careerhunter.io/assets/upgrade/upgrade_man-ac3b2593afee463046d693a481c2f1facdeeac3c52c74b013eba24dea8698961.png")
    }

    @media screen and (min-width: 640px) and (max-width: 1079px) {
        .no-webp .upgrade-top--right {
            background-image:url("//cdn1.careerhunter.io/assets/upgrade/upgrade_man_tablet-fadccbb4542950bf9d3785228dfe2f57810a7df8f9f5d804afdb5e99b673b251.png")
        }
    }

    @media screen and (max-width: 39.99875em) {
        .no-webp .upgrade-top--right {
            background-image:url("//cdn1.careerhunter.io/assets/upgrade/upgrade_man_mob-bfa9ed8d55628f2c7f4c5cb26a4f0f8fa549096357cfc6955134c554bdfe2853.png")
        }
    }

    .upgrade-top__background {
        background: #091926;
        background: -webkit-radial-gradient(5% 105%, ellipse, #4f5458 0%, #212b34 17%, #091926 35%, transparent 100%),-webkit-radial-gradient(70% -10%, circle, #5c6063 0%, #2a3c4a 0%, #243644, #1a2b3b, #0d202f, #0b1c2c, #091926 90%);
        background: radial-gradient(ellipse at 5% 105%, #4f5458 0%, #212b34 17%, #091926 35%, transparent 100%),radial-gradient(circle at 70% -10%, #5c6063 0%, #2a3c4a 0%, #243644, #1a2b3b, #0d202f, #0b1c2c, #091926 90%);
        background-position: bottom !important;
    ...
    @media screen and (min-width: 64.0625em) {
        .upgrade-top__background .grid-container {
            padding-top:0 !important;
            padding-bottom: 0 !important
        }
    }
    ...
    @media screen and (min-width: 1080px) {
        .upgrade-top__background .grid-container {
            position:relative;
            top: 50%;
            -webkit-transform: translateY(calc(-50% - 51px));
            -ms-transform: translateY(calc(-50% - 51px));
    ...
    .upgrade-top__background .particle {
        position: absolute;
        z-index: 2;
        border-radius: 50%
    }

    .upgrade-top__background .particle:nth-child(1) {
        height: 30px;
        width: 30px;
        top: 14px
    }
    ...
    .upgrade-top__background .particle:nth-child(2) {
        height: 45px;
        width: 45px;
        top: 175px;
        left: 180px
    ...
    .upgrade-top__background .particle:nth-child(3) {
        height: 32px;
        width: 32px;
        top: 234px
    }

    .upgrade-top__background .particle:nth-child(4) {
        height: 90px;
        width: 90px;
        top: 0;
        left: 0
    ...
    .upgrade-top__background .particle:nth-child(5) {
        height: 50px;
        width: 50px;
        top: 105px;
        left: 0px
    ...
    .upgrade-top__background .particle:nth-child(6) {
        height: 170px;
        width: 170px;
        right: 200px
    }
    ...
    .upgrade-top__background .circle {
        position: absolute;
        background: rgba(255,255,255,0.08);
        border-radius: 50%;
        -webkit-border-radius: 50%;
    ...
    .upgrade-top__background .circle.top-left-big {
        top: 76px;
        left: 561px;
        width: 45px;
        height: 45px
    ...
    .upgrade-top__background .circle.top-left-small {
        top: 130px;
        left: 604px;
        width: 17px;
        height: 17px
    ...
    .upgrade-top__background .circle.bottom-right-small {
        top: 400px;
        right: -80px;
        width: 21px;
        height: 21px
    ...
    .upgrade-top__background .circle.top-right-small {
        position: relative;
        top: 0px;
        left: 110px;
        width: 21px;
    ...
    .upgrade-top__background .circle.bottom-left-large {
        bottom: 390px;
        left: 30px;
        width: 65px;
        height: 65px;
    ...
    .upgrade-top__background .circle.bottom-left-large .icon-1 {
        background: url("//cdn3.careerhunter.io/assets/sprites/upgrade_icons-fdc3b2823d41002783508e0f8aa415b54e01ef01711cf936bdf0d659b10dc58d.svg");
    ...
    .upgrade-top__background .circle.bottom-right-large {
        top: 440px;
        right: -50px;
        width: 65px;
        height: 65px;
    ...
    .upgrade-top__background .circle.bottom-right-large .icon-2 {
        background: url("//cdn3.careerhunter.io/assets/sprites/upgrade_icons-fdc3b2823d41002783508e0f8aa415b54e01ef01711cf936bdf0d659b10dc58d.svg");
        background-position: -375px -605px;
        width: 40px;
        height: 33px;
        margin: auto
    }

    .upgrade-top__background .circle.bottom-right-large-above {
        right: -15px;
        top: 400px;
        width: 65px;
        height: 65px;
    ...
    .upgrade-top__background .circle.bottom-right-large-above .icon-3 {
        background: url("//cdn3.careerhunter.io/assets/sprites/upgrade_icons-fdc3b2823d41002783508e0f8aa415b54e01ef01711cf936bdf0d659b10dc58d.svg");
        background-position: -327px -605px;
        width: 34px;
        height: 35px;
        margin: auto
    }

    .upgrade-top__section .grey-line-through {
        font-size: 14px;
        color: rgba(255,255,255,0.5);
        line-height: 25px;
        margin-left: 5px
    ...
    @media screen and (max-width: 375px) {
        .upgrade-top__section .button--green--big {
            padding:15px !important
        }
    }

    @media screen and (min-width: 40em) {
        .upgrade-top__section {
            margin-top:-120px
        }
    }

    @media screen and (min-width: 1025px) and (max-width: 1079px) {
        .upgrade-top__section .large-6 {
            width:100%
        }
    }
    ...
    .upgrade-top__title .underline {
        text-decoration: underline
    }

    .upgrade-top__title .green {
        color: #59CE61
    }

    .upgrade-top__title .animation-wrapper {
        position: relative;
        display: inline-block
    }

    .upgrade-top__title .animation-wrapper .wrap:last-child {
        border-right: 0.08em solid #ffffff
    }

    .upgrade-top__title .animation-wrapper .wrap.green:last-child {
        border-color: #59CE61
    }

    .upgrade-top__title .animation-wrapper.green .line {
        background: #59CE61
    }

    .upgrade-top__title .animation-wrapper.green .typing-animation {
        color: #59CE61
    }

    .upgrade-top__title .animation-wrapper.underline-animated .letter {
        text-decoration: underline
    }

    .upgrade-top__title .line {
        opacity: 0;
        position: absolute;
        left: 0;
        height: 100%;
    ...
    .upgrade-top__title .line1 {
        top: 0;
        left: 0
    }

    .upgrade-top__title .letter {
        display: inline-block
    }

    .upgrade-top__bullet-point {
        font-family: "Sofia-Pro-Light", sans-serif;
        color: #ffffff;
        margin: 0 0 10px 0;
        font-size: 21px
    ...
    .upgrade-top__price-value.small {
        font-size: 16px
    }
    ...
    .upgrade-top--right {
        background-image: url("//cdn0.careerhunter.io/assets/upgrade/upgrade_man-a9c7d10af15b11745d524fad0268b332d5e438b53f2dd9df36c45785be191ac5.webp");
        background-repeat: no-repeat;
    ...
    @media screen and (min-width: 640px) and (max-width: 1079px) {
        .upgrade-top--right {
            background-image:url("//cdn1.careerhunter.io/assets/upgrade/upgrade_man_tablet-d035add79302c0811dde2d8a94fc29e79a5eceffc8c45e19e20cca5a4d0a5bd2.webp");
            background-repeat: no-repeat;
            background-position: 200px 0;
            margin: 0 0 auto auto
        }
    ...
    @media screen and (max-width: 39.99875em) {
        .upgrade-top--right {
            background-image:url("//cdn0.careerhunter.io/assets/upgrade/upgrade_man_mob-30af1ddc101b2f1aa326c7c7f4ae89b14fc6c939aca05c2eec3dcf9336bcfade.webp");
            background-repeat: no-repeat;
            background-position: center;
            height: 363px;
    ...
    .upgrade-benefits .circle.bottom-left-small {
        bottom: 55px;
        left: -20px;
        width: 27px;
        height: 27px
    ...
    @media screen and (min-width: 64.0625em) {
        .upgrade-benefits .grid-container {
            padding-top:100px !important;
            padding-bottom: 100px !important
        }
    }
    ...
    @media screen and (max-width: 64.06125em) {
        .upgrade-benefits--section-1 .grid-container {
            padding-bottom:30px !important
        }
    }

    @media screen and (max-width: 64.06125em) {
        .upgrade-benefits--section-1 .upgrade-benefits__imgs {
            margin-top:20px !important
        }
    }
    ...
    .upgrade-benefits--section-2 .grid-container {
        padding-top: 60px !important;
        padding-bottom: 60px !important
    }
    ...
    @media screen and (max-width: 64.06125em) {
        .upgrade-benefits--section-2 .upgrade-benefits__imgs {
            margin-top:-40px !important
        }
    }
    ...
    @media screen and (min-width: 40em) and (max-width: 64.06125em) {
        .upgrade-benefits--section-3 .grid-container {
            padding-bottom:60px !important
        }
    }
    ...
    @media screen and (max-width: 39.99875em) {
        .upgrade-benefits--section-3 .upgrade-benefits__imgs {
            margin:-10px auto 30px
        }
    }

    .upgrade-benefits--section-3 .circle {
        position: absolute;
        background: rgba(10,30,46,0.08);
        border-radius: 50%;
        -webkit-border-radius: 50%;
    ...
    .upgrade-benefits--section-3 .circle.top-right {
        top: 74px;
        right: 0;
        width: 74px;
        height: 74px
    ...
    .upgrade-benefits--section-3 .circle.bottom-left-small {
        top: 650px;
        left: 315px;
        width: 27px;
        height: 27px
    ...
    .upgrade-benefits--section-3 .green-circle {
        position: absolute;
        background: rgba(89,206,97,0.16);
        border-radius: 50%;
        -webkit-border-radius: 50%;
    ...
    .upgrade-benefits--section-3 .green-circle.right-large {
        top: 550px;
        left: 350px;
        width: 95px;
        height: 95px
    ...
    .upgrade-services .grid-container {
        margin: auto
    }
    ...
    @media screen and (min-width: 64.0625em) {
        .upgrade-services__slider .slick-slide {
            padding:0 12.5px
        }
    }

    @media screen and (min-width: 64.0625em) {
        .upgrade-services__slider.slick-slider {
            margin-left:12.5px
        }
    }

    .upgrade-services__slider .slick-prev,.upgrade-services__slider .slick-next {
        width: 40px;
        height: 40px;
        margin: 0 auto;
        position: absolute;
    ...
    .upgrade-services__slider .slick-prev:hover,.upgrade-services__slider .slick-next:hover {
        -webkit-transition: all 0.1s ease;
        transition: all 0.1s ease;
        opacity: 0.5
    }

    .upgrade-services__slider .slick-prev {
        left: 40px
    }

    .upgrade-services__slider .slick-next {
        right: 40px
    }

    .upgrade-services__slider .slick-arrow {
        background: rgba(10,30,46,0.1);
        height: 36px;
        width: 36px;
        border-radius: 50%
    ...
    .upgrade-services__slider .slider-arrow {
        background: url("//cdn3.careerhunter.io/assets/sprites/small_icons_01-6bcc3606a70b883b3aac6954e60c3487e99faacba6fa7fa27f577aa7cfc7cfb0.svg");
        margin: 0 -1px -3px 0;
        position: absolute;
        bottom: 15px
    ...
    .upgrade-services__slider .slider-arrow--next {
        background-position: -221px -17px;
        width: 19px;
        height: 11px;
        right: 11px
    ...
    .upgrade-services__slider .slider-arrow--prev {
        background-position: -184px -17px;
        width: 20px;
        height: 11px;
        left: 11px
    ...
    @media screen and (min-width: 40em) and (max-width: 64.06125em) {
        .upgrade-services__slider {
            padding-bottom:60px;
            overflow: hidden
        }

        .upgrade-services__slider .swiper-wrapper {
            overflow: visible
        }

        .upgrade-services__slider .slick-list {
            overflow: visible;
            margin: 0 40px
        }
    }

    .upgrade-services__block:focus {
        outline: none
    }

    .upgrade-services__card {
        background: #EBEDEE;
        border-radius: 10px;
        margin: auto
    }

    .upgrade-services__card img {
        width: 100%;
    ...
    @media screen and (max-width: 1285px) and (min-width: 1260px) {
        .upgrade-services__card img {
            height:171px
        }
    }
    ...
    .upgrade-users__block {
        background: rgba(10,30,46,0.05);
        border-radius: 10px;
        padding: 20px;
        margin: 0 10px 20px 10px;
        text-align: left;
    ...
    @media screen and (min-width: 40em) {
        .upgrade-users__block-img.left {
            margin:-12px 20px 0 0
        }
    }

    @media screen and (min-width: 40em) {
        .upgrade-users__block-img.right-space {
            margin-right:8px
        }
    }

    @media screen and (min-width: 40em) and (max-width: 64.06125em) {
        .upgrade-users__block-details--on-right {
            margin-left:auto
        }
    }

    @media screen and (max-width: 39.99875em) {
        .upgrade-users__block-details img {
            float:right;
    ...
    .upgrade-steps {
        position: relative;
        background: #091926;
        background: -webkit-radial-gradient(-10% 0%, circle, #5a5e61, #3a4147, #12202b, #081825, #091926 100%);
        background: radial-gradient(circle at -10% 0%, #5a5e61, #3a4147, #12202b, #081825, #091926 100%);
    ...
    @media screen and (max-width: 64.06125em) {
        .upgrade-steps {
            background:-webkit-radial-gradient(-120% 35%, circle, #5a5e61, #3a4147, #12202b, #081825, #091926 100%);
            background: radial-gradient(circle at -120% 35%, #5a5e61, #3a4147, #12202b, #081825, #091926 100%)
        }
    }

    .upgrade-steps .circle {
        position: absolute;
        background: rgba(255,255,255,0.1);
        border-radius: 50%;
        -webkit-border-radius: 50%;
    ...
    .upgrade-steps .circle.left-small {
        top: 86px;
        left: 201px;
        width: 37px;
        height: 37px
    ...
    .upgrade-steps .circle.left-bot-small {
        bottom: 150px;
        left: 173px;
        width: 25px;
        height: 25px
    ...
    .upgrade-steps .circle.right-small {
        top: 99px;
        right: 245px;
        width: 15px;
        height: 15px
    ...
    .upgrade-steps .circle.right-large {
        bottom: 60px;
        right: 145px;
        width: 67px;
        height: 67px
    ...
    .upgrade-steps .green-circle.right-large {
        top: 123px;
        right: 250px;
        width: 54px;
        height: 54px
    ...
    .upgrade-steps .green-circle.left-large {
        bottom: 90px;
        left: 105px;
        width: 52px;
        height: 52px
    ...
    .upgrade-steps__slider .slick-prev,.upgrade-steps__slider .slick-next {
        width: 40px;
        height: 40px;
        margin: 0 auto;
        position: absolute;
    ...
    .upgrade-steps__slider .slick-prev:hover,.upgrade-steps__slider .slick-next:hover {
        -webkit-transition: all 0.1s ease;
        transition: all 0.1s ease;
        opacity: 0.5
    }

    .upgrade-steps__slider .slick-prev {
        left: 40px
    }

    .upgrade-steps__slider .slick-next {
        right: 40px
    }

    .upgrade-steps__slider .slick-arrow {
        background: rgba(255,255,255,0.1);
        height: 36px;
        width: 36px;
        border-radius: 50%
    ...
    .upgrade-steps__slider .slider-arrow {
        background: url("//cdn3.careerhunter.io/assets/sprites/small_icons_01-6bcc3606a70b883b3aac6954e60c3487e99faacba6fa7fa27f577aa7cfc7cfb0.svg");
        margin: 0 -1px -3px 0;
        position: absolute;
        bottom: 15px
    ...
    .upgrade-steps__slider .slider-arrow--next {
        background-position: -157px -17px;
        width: 14px;
        height: 11px;
        right: 11px
    ...
    .upgrade-steps__slider .slider-arrow--prev {
        background-position: -124px -17px;
        width: 14px;
        height: 11px;
        left: 11px
    ...
    @media screen and (min-width: 40em) and (max-width: 64.06125em) {
        .upgrade-steps__slider {
            padding-bottom:60px;
            overflow: hidden
        }

        .upgrade-steps__slider .swiper-wrapper {
            overflow: visible
        }

        .upgrade-steps__slider .slick-list {
            overflow: visible;
            margin: 0 40px
        }
    }

    .upgrade-steps__block {
        position: relative;
        background: rgba(255,255,255,0.08)
    }
    ...
    .upgrade-steps__content .medium-flex-center {
        margin: 0 0 26px 0;
        min-height: 54px
    }
    ...
    .upgrade-steps__content .medium-flex-center .large-icon {
        -webkit-flex-shrink: 0;
        -ms-flex-negative: 0;
        flex-shrink: 0
    }
    ...
    @media screen and (min-width: 40em) {
        .expert-review .grid-container {
            padding-top:60px !important
        }
    }

    @media screen and (min-width: 40em) {
        .expert-review .review__container.grid-container {
            padding-top:0 !important;
            padding-bottom: 40px !important
        }
    }
    ...
    @media screen and (max-width: 39.99875em) {
        .expert-review .blue-blk__mini-subtitle {
            font-size:18px
        }
    }

    .expert-review .blue-blk__title,.expert-review .blue-blk__mini-subtitle {
        color: #0A1E2E;
        text-align: center
    }

    @media screen and (min-width: 40em) {
        .expert-review .review__slider {
    ...
    @media screen and (min-width: 40em) and (max-width: 64.06125em) and (max-width: 64.06125em) {
        ...
        .expert-review .review__slider.swiper-container {
            padding: 0 40px
        }

        .expert-review .review__slider.swiper-container .swiper-wrapper {
            overflow: visible
        }

        .expert-review .review__slider.slider-with-white-arrows {
            padding-bottom: 60px
        }

        .expert-review .review__slider.slider-with-white-arrows .slick-arrow {
            bottom: -10px
        }

        .expert-review .review__slider.slider-with-white-arrows .slick-prev {
            left: 10px
        }

        .expert-review .review__slider.slider-with-white-arrows .slick-next {
            right: 20px
        }

        .expert-review .review__slider .slick-list {
            overflow: visible;
            margin: 0 40px
        }
    }
    ...
    @media screen and (min-width: 40em) and (max-width: 64.06125em) {
        .expert-review .review__slider .slick-list {
            margin:0 32px 0 40px !important
        }

        .expert-review .review__slider .slick-prev {
            left: 40px
        }

        .expert-review .review__slider .slick-next {
            right: 40px
        }
    }
    ...
    .expert-review .review__slide-name {
        font-size: 25px;
        font-family: "Sofia-Pro-Semi-Bold", sans-serif;
        color: #0A1E2E
    }

    .expert-review .review__slide-details {
        color: #0A1E2E
    }

    .expert-review .review__company {
        color: rgba(10,30,46,0.5)
    }

    .expert-review .review__desc,.expert-review .how__illustrations--more {
        color: rgba(10,30,46,0.8)
    }

    .expert-review [data-more-less-ctrl]::after {
        background: url("//cdn3.careerhunter.io/assets/sprites/upgrade_icons-fdc3b2823d41002783508e0f8aa415b54e01ef01711cf936bdf0d659b10dc58d.svg");
    ...
    .expert-review .review__icons {
        display: none
    }

    .expert-review .how__illustrations--more {
        text-decoration: underline;
        color: rgba(10,30,46,0.5)
    }
    ...
    .navbar-toggle.collapsed .icon-bar1,.navbar-toggle.collapsed .icon-bar2,.navbar-toggle.collapsed .icon-bar3 {
    ...
    .upgrade-sticky-menu {
        background: rgba(18,37,53,0.5)
    }

    .upgrade-sticky-menu .grid-container {
        padding-top: 0 !important;
        padding-bottom: 0 !important
    }

    @media screen and (max-width: 1397px) {
        .upgrade-sticky-menu [data-indicator-container] {
            width:100%;
            overflow: scroll;
            -ms-overflow-style: none;
            scrollbar-width: none
        ...
        .upgrade-sticky-menu [data-indicator-container]::-webkit-scrollbar {
            display: none
        }
    ...
    .upgrade-sticky-menu ul li:first-child {
    ...
    @media screen and (min-width: 1397px) {
        .upgrade-sticky-menu ul li:last-child {
            padding-right:0 !important
        }
    }
    ...
    .upgrade-sticky-menu ul li:after {
        content: '';
        color: rgba(18,37,53,0.5);
        background: url("//cdn0.careerhunter.io/assets/upgrade/arrow-light-0d2e4c26eb2c57b4304ba568757409cd060cf86e5447acba01d9d5419c069ae2.svg") no-repeat center center;
        width: 7px;
        height: 11px;
        position: absolute;
        right: 0;
    ...
    .upgrade-sticky-menu ul li:last-child:after {
        display: none
    }

    .upgrade-sticky-menu ul li.active a {
        color: #ffffff
    }

    .upgrade-sticky-menu ul li a {
    ...
    .upgrade-sticky-menu ul li a:hover {
        color: #ffffff
    }

    .upgrade-sticky-menu__container.is-stuck {
        height: 43px
    }

    .upgrade-sticky-menu__container.is-stuck .upgrade-sticky-menu {
    ...
    .upgrade-sticky-menu__container{
    ...
    .upgrade-sticky-menu__container.is-stuck .upgrade-sticky-menu ul li {
        padding: 10px 65px
    }
    ...
    .upgrade-sticky-menu__container.is-stuck .upgrade-sticky-menu ul li:after {
        content: '';
        color: rgba(18,37,53,0.5);
        background: url("//cdn2.careerhunter.io/assets/upgrade/arrow-dark-6e6c96780d23660fcfd3a3a510cdc8d77b9eb16f12ab0b953faee64462029206.svg") no-repeat center center;
        width: 7px;
        height: 11px;
        position: absolute;
        right: 0;
    ...
    .upgrade-sticky-menu__container.is-stuck .upgrade-sticky-menu ul li:first-child {
        padding-top: 10px !important;
        padding-bottom: 10px !important
    }

    .upgrade-sticky-menu__container.is-stuck .upgrade-sticky-menu ul li.active a {
        color: #122535
    }

    .upgrade-sticky-menu__container.is-stuck .upgrade-sticky-menu ul li a {
        color: rgba(18,37,53,0.5)
    }

    .upgrade-sticky-menu__container.is-stuck .upgrade-sticky-menu ul li a:hover {
        color: #122535
    }
