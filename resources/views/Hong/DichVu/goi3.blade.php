        ...
        <div class="grid-container" style="height: 600px;">
            <div class="grid-x upgrade-top__section">
                <div class="large-6 cell">
                    <p class="upgrade-top__access">Tài khoản TeenCodes - TIÊU CHUẨN </p>
                    ...
                    <p class="upgrade-top__bullet-point">
                        ...
                        Báo cáo phân tích chi tiết về khả năng bản thân của bạn ảnh hưởng đến lựa chọn định hướng
                    ...
                    <p class="upgrade-top__bullet-point"><span class="checkout-icon green-tick"></span>Danh sách
                        những nghề nghiệp (theo chuyên ngành đào tạo ở Việt Nam) thuộc 4 trong 6 thể loại ngành nghề
                    ...
                    <p class="upgrade-top__bullet-point"><span class="checkout-icon green-tick"></span> <span
                                class="hide-for-small-only">Nhận báo cáo tư vấn hướng nghiệp được cá nhân hóa dành cho
                                riêng bạn.
                    </p>
                ...
                <div class="grid-x" data-indicator-container="" style="">
                    <ul style="margin: 0; padding: 0;">
                        <li class="active"><a href="#full_access" aria-label="Full Access" data-id="full_access"
                                              data-smooth-scroll="" data-nav-progress="" class="before-fade-in">GÓI [TIÊU CHUẨN] </a>
                        </li>
                ...
                <div class="large-6 medium-12 small-12 cell">
                    ...
                    <div class="upgrade-users__block upgrade-users__block--on-left">
                        ...
                        <div class="upgrade-users__block-details">
                            <h3 class="upgrade-users__block-title before-fade-in">Học sinh trung học phổ thông </h3>
                            <p class="upgrade-users__block-desc before-fade-in">Bạn đang ở bậc THPT và bắt đầu tìm
                                kiếm sự lựa chọn hướng nghiệp cho tương lai? Hãy sử dụng TeenCodes để được tư vấn
                                hướng nghiệp và các thông tin cập nhật dành riêng cho bạn. </p>
                        </div>
                    </div>
                </div>
                <div class="large-6 medium-12 small-12 cell">
                    ...
                    <div class="upgrade-users__block upgrade-users__block--on-right">
                        <div class="upgrade-users__block-details">
                            ...
                            <p class="upgrade-users__block-desc before-fade-in">Bạn sắp tốt nghiệp THPT và đã có một
                                vài nghề nghiệp mong ước ? Kết quả từ bài trắc nghiệm TeenCodes sẽ giúp bạn có quyết
                                định phù hợp nhất và thông tin về khóa đào tạo lý tưởng dành cho bạn. </p>
                        </div>
