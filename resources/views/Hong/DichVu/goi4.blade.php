        ...
        <div class="grid-container" style="height: 600px;">
            <div class="grid-x upgrade-top__section">
                <div class="large-6 cell">
                    <p class="upgrade-top__access">Tài khoản TeenCodes - THÀNH CÔNG </p>
                    <h1 class="upgrade-top__title">Bạn có muốn biết những nghề gì phù hợp nhất với mình ? </h1>
                    <p class="upgrade-top__bullet-point">
                        <span class="checkout-icon green-tick"></span>
                        Báo cáo phân tích đầy đủ nhất về khả năng bản thân của bạn ảnh hưởng đến lựa chọn định hướng
                        chuyên ngành đào tạo và nghề nghiệp trong tương lai gần.
                    </p>
                    <p class="upgrade-top__bullet-point"><span class="checkout-icon green-tick"></span>Danh sách
                        những nghề nghiệp (theo chuyên ngành đào tạo ở Việt Nam thuộc tất cả 6 thể loại ngành nghề)
                    ...
                    <p class="upgrade-top__bullet-point"><span class="checkout-icon green-tick"></span> <span
                                class="hide-for-small-only"> Nhận báo cáo tư vấn hướng nghiệp đầy đủ và được cá nhân hóa
                                dành cho riêng bạn.
                    </p>
                ...
                <div class="grid-x" data-indicator-container="" style="">
                    <ul style="margin: 0; padding: 0;">
                        <li class="active"><a href="#full_access" aria-label="Full Access" data-id="full_access"
                                              data-smooth-scroll="" data-nav-progress="" class="before-fade-in">GÓI [THÀNH CÔNG] </a>
                        </li>
        ...
        <div class="grid-container">
            <div class="grid-x align-middle">
                <div class="large-6 medium-12 cell">
                    ...
                    <h2 class="upgrade-benefits__subtitle before-fade-in">Hiểu biết về mức độ phù hợp của bạn đối
                        với các nghề nghiệp phổ biến và mới nổi </h2>
                    <p class="upgrade-benefits__desc before-fade-in">Thuật toán độc đáo của TeenCodes đánh giá kết
                        quả bài trắc nghiệm của bạn và sắp xếp chính xác danh sách những nghề nghiệp phù hợp mà bạn
                        không chỉ đang yêu thích lúc này mà còn sẽ mang đến thành công trong tương lai. </p>
                </div>
                <div class="large-6 medium-12 cell">
            ...
            <div class="grid-x align-middle">
                ...
                <div class="large-6 medium-12 large-order-2 small-order-1 cell upgrade-benefits__wrapper">
                    <h3 class="upgrade-benefits__title before-fade-in">Phương pháp đánh giá chính xác và đáng tin
                        cậy </h3>
                    <h2 class="upgrade-benefits__subtitle before-fade-in">Phát hiện điểm mạnh và điểm yếu của bạn
                    </h2>
                                                        ...
                                                        <div class="upgrade-services__card">
                                                            ...
                                                            <div class="upgrade-services__content">
                                                                <h3 class="upgrade-services__title">Truy cập không
                                                                    giới hạn và nhận tư vấn trong 18 tháng </h3>
                                                                <p class="upgrade-services__desc">Với khoản phí một
                                                                    ...
                                                                    thực tế dành cho bạn trong vòng 18 tháng. </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
{{--                    <p class="upgrade-users__description before-fade-in">Bài khảo sát trắc nghiệm của TeenCodes rất có ích cho các bạn Teen từ 14-19 tuổi có chí tiến thủ.--}}
                ...
                <div class="large-6 medium-12 small-12 cell">
                    ...
                    <div class="upgrade-users__block upgrade-users__block--on-left">
                        ...
                        <div class="upgrade-users__block-details">
                            <h3 class="upgrade-users__block-title before-fade-in">Học sinh lớp 12 </h3>
                            <p class="upgrade-users__block-desc before-fade-in">Bạn đang ở năm học cuối cùng của bậc
                                trung học nhưng chưa có lựa chọn phù hợp nhất cho tương lai? Hãy sử dụng TeenCodes
                                để được tư vấn hướng nghiệp và luôn nhận được các thông tin cập nhật về tuyển sinh
                                đại học sẽ giúp riêng cho bạn hướng đến THÀNH CÔNG. </p>
                        </div>
                    </div>
                </div>
                <div class="large-6 medium-12 small-12 cell">
                    ...
                    <div class="upgrade-users__block upgrade-users__block--on-right">
                        <div class="upgrade-users__block-details">
                            <h3 class="upgrade-users__block-title before-fade-in">Thí sinh dự tuyển vào đại học, cao
                                đẳng </h3>
                            <p class="upgrade-users__block-desc before-fade-in">Bạn sắp tốt nghiệp trung học hoặc
                                vẫn chưa chắc chắn về lựa chọn hướng nghiệp của mình? Kết quả từ bài trắc nghiệm
                                TeenCodes sẽ giúp bạn chọn đúng nghề nghiệp phù hợp nhất và các khóa đào tạo lý
                                tưởng để nguyện vọng của bạn đạt được THÀNH CÔNG. </p>
                        </div>
                                                    ...
                                                    <div class="upgrade-steps__block" tabindex="-1"
                                                        ...
                                                        <div class="upgrade-steps__content">
                                                            <div class="medium-flex-center">
                                                                ...
                                                                <h3 class="upgrade-steps__title">Hoàn thành bài khảo sát trắc nghiệm đơn giản					</h3>
                                                            </div>
                                                    ...
                                                    <div class="upgrade-steps__block" tabindex="-1"
                                                        ...
                                                        <div class="upgrade-steps__content">
                                                            <div class="medium-flex-center">
                                                                ...
                                                                <h3 class="upgrade-steps__title">TeenCodes.vn xử lý kết quả bằng thuật toán			</span>
                                                                </h3>
                                                            </div>
                                                    ...
                                                    <div class="upgrade-steps__block" tabindex="-1"
                                                        ...
                                                        <div class="upgrade-steps__content">
                                                            <div class="medium-flex-center">
                                                                ...
                                                                <h3 class="upgrade-steps__title">Cung cấp dữ liệu cá nhân hóa dành riêng cho bạn			</span></h3>
                                                            </div>
                                                            <p class="upgrade-steps__desc">Bạn nhận được các thông tin nghề nghiệp chính xác phù hợp với kết quả bài khảo sát của bạn cũng như tư vấn hướng nghiệp và các khóa học phù hợp nhất đối với bạn.					</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <div class="expert-review" id="the_applause">
        <div class="grid-container inner-bottom">
            <div class="grid-x">
                <div class="small-12 cell">
                    <h3 class="blue-blk__title blue-blk__title--with-mrg white before-fade-in">Đánh giá của chuyên gia
                    </h3>
                    <h4 class="blue-blk__mini-subtitle before-fade-in">Ý kiến chứng thực trực tiếp từ các chuyên gia về TeenCodes					</h4>
                </div>
            </div>
        </div>
    ...
    <div class="bottom-banner">
        ...
        <div class="grid-container ">
            <div class="grid-x text-center">
                <h2 class="bottom-banner__headline before-fade-in">Ready to uncover your career matches?</h2>
                <p class="bottom-banner__desc bottom-banner__desc--more-space before-fade-in" style="width: 100%;">Our tests can help
                    you, no matter your study or work status.</p>
                <div class="small-6 cell text-center" style="padding-right: 10px;">
                    <a href="/checkout" aria-label="Unlock Tests"
                       class="button button--with-icon button--green button--green--big before-fade-in"
                       style="margin:0 auto" data-checkout-link="">Tôi đăng ký dịch vụ <span
