...
<div class="wrapper" id="wrapper" style="text-align: left">
        ...
        <div class="grid-container inner-bottom transparent">
            <div class="grid-x">
                <div class="medium-9 small-12 cell">
                    <h1 class="primary">Gói dịch vụ Nhóm TeenCodes </h1>
                </div>
                <div class="grid-x hide-for-large">
                    <div class="small-12 cell">
                        <div class="group__title group__title--white">Purchase test access for your team or students
                        </div>
                    </div>
                </div>
                <div class="large-7 medium-12 cell" style="">
                    <div class="group__title group__title--white show-for-large" style="max-width: 674px;">Đặt mua
                        TeenCodes cho nhóm học sinh của bạn </div>
    ...
    <div class="hide-for-large group__feedback-blk">
        <div class="grid-container no-padding full-width">
            <div class="feedback-blk__card">
                <span class="small-icon green-star"></span>
                <span class="small-icon green-star"></span>
                <span class="small-icon green-star"></span>
                <span class="small-icon green-star"></span>
                <span class="small-icon green-star"></span>
                <div class="trustpilot-container">
                    <p class="customer-text is-marginless">Our customers <b>love us!</b></p>
                    <span class="small-icon trustpilot"></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg__conbtainer">
        <div class="grid-container">
            <div class="grid-x">
                <div class="small-12 cell text-center">
                    <h2 class="group__blk-subtitle ">Hệ thống TeenCodes tự động </h2>
                    <p class="group__benefit__desc ">Công nghệ 4.0 của TeenCodes.vn luôn hỗ trợ tối đa cho giáo viên
                        và nhóm học sinh </p>
                </div>
            </div>
            <div class="grid-x align-center">
                <div class="large-9 medium-12 small-12 cell text-center player-wrapper player-wrapper__group">
                    <iframe
                            src="https://player.vimeo.com/video/477072114?autoplay=1&amp;color=3dd144&amp;title=0&amp;byline=0&amp;portrait=0"
                            style="position:absolute;top:0;left:0;" frameborder="0" height="100%" width="100%"
                            allowfullscreen=""></iframe>
                </div>
            </div>
            <div class="grid-x text-center">
                <div class="large-4 medium-12 small-12 cell">
                    <h3 class="mar-bot-20 ">1. Mời tham gia nhóm TeenCodes </h3>
                    <div data-more-less-container="" class="apply-fade-in ">
                        <p data-more-less-content="" data-more-less-with-dots=""
                           class="how__illustrations--content how__illustrations--content__1 disable-fade-in"
                           data-more-less-height="79" style="max-height: 100px;" data-more-less-enabled="true">
                            Bạn dễ dàng giới thiệu chương trình bằng cách chia sẻ TeenCodes.vn với học sinh của bạn,
                            các học sinh sẽ đăng ký tham gia nhóm chỉ cần có email cá nhân (tự điền vào biểu mẫu
                            trực tuyến) để hệ thống liên hệ xác nhận và cấp phép.


                        </p>
                        <p data-more-less-ctrl="" class="how__illustrations--more " style="visibility: visible;">Đọc
                            thêm</p>
                    </div>
                </div>
                <div class="large-4 medium-12 small-12 cell">
                    <h3 class="mar-bot-20 ">2. Giáo viên tham gia hợp tác quản lý </h3>
                    <div data-more-less-container="" class="apply-fade-in ">
                        <p data-more-less-content="" data-more-less-with-dots=""
                           class="how__illustrations--content how__illustrations--content__2 disable-fade-in"
                           data-more-less-height="79" style="max-height: 100px;" data-more-less-enabled="true">
                            Chúng tôi sẽ gửi bản danh sách đã cấp quyền truy cập của cả nhóm vào Bảng điều khiển
                            trong tài khoản TeenCodes của giáo viên trên website. Sau đó, bạn gửi thông báo riêng
                            cho từng học sinh của mình để mỗi người tự đăng nhập lần đầu vào TeenCodes.vn

                        </p>
                        <p data-more-less-ctrl="" class="how__illustrations--more before-fade-in"
                           style="visibility: visible;">Đọc thêm</p>
                    </div>
                </div>
                <div class="large-4 medium-12 small-12 cell">
                    <h3 class="mar-bot-20 ">3. Sự cảm ơn và ưu đãi dành cho nhóm </h3>
                    <div data-more-less-container="" class="apply-fade-in ">
                        <p data-more-less-content="" data-more-less-with-dots=""
                           class="how__illustrations--content how__illustrations--content__3 disable-fade-in"
                           data-more-less-height="99" style="max-height: 100px;" data-more-less-enabled="true">
                            Để cảm ơn sự hợp tác của bạn trong hoạt động hướng nghiệp, TeenCodes.vn ưu đãi giảm 10%
                            (trong tổng giá) cho nhóm học sinh của bạn và hân hạnh cung cấp một số hỗ trợ đặc biệt
                            dành riêng cho bạn (giáo viên hoặc nhà trường).
                        </p>
                        <p data-more-less-ctrl="" class="how__illustrations--more before-fade-in"
                           style="visibility: visible;">Đọc thêm</p>
                    </div>
    ...
    <div class="bg__conbtainer">
        <div class="grid-container inner-bottom">
            <div class="grid-x">
                <div class="small-12 cell text-center">
                    <h2 class="group__blk-subtitle mar-bot-20 ">Lý do để bạn lựa chọn đăng ký Nhóm TeenCodes </h2>
                    <p class="group__benefit__desc ">Nhận được những lợi ích thiết thực dành cho cả học sinh và giáo
                        viên, nhà giáo dục </p>
                </div>
            </div>
            <div class="grid-x group__benefit--blk">
                <div class="large-6 medium-12 small-12">
                    <div class="group__benefit__img group__benefit__img--1"></div>
                </div>
                <div class="large-6 medium-12 small-12">
                    <h3 class="group__benefit__title before-fade-in">Dành cho giáo viên, nhà giáo dục </h3>
                    <div class="grid-x">
                        <div class="large-6 medium-6 small-12">
                            <div class="icon-wrapper">
                                <div class="green-small-icon icon-1"></div>
                            </div>
                            <div class="group__benefit__content">
                                <p class=""><b>Dễ dàng để hợp tác cùng với học sinh </b> Học sinh của
                                    bạn hiểu rõ mục đích học tập để có mục tiêu và các lựa chọn phù hợp. </p>
                            </div>
                            <div class="icon-wrapper">
                                <div class="green-small-icon icon-3"></div>
                            </div>
                            <div class="group__benefit__content">
                                <p class=""><b>Trải nghiệm công nghệ mới về giáo dục </b> Được tặng (hoặc hoàn lại
                                    tiền) một tài khoản TeenCodes THÀNH CÔNG để trải nghiệm. </p>
                            </div>
                        </div>
                        <div class="large-6 medium-6 small-12">
                            <div class="icon-wrapper">
                                <div class="green-small-icon icon-2"></div>
                            </div>
                            <div class="group__benefit__content">
                                <p class=""><b>Thấu hiểu tất cả học sinh của mình </b> Công việc giảng dạy trở nên
                                    hiểu quả hơn để giúp học sinh đạt được thành công. </p>
                            </div>
                            <div class="icon-wrapper">
                                <div class="green-small-icon icon-4"></div>
                            </div>
                            <div class="group__benefit__content">
                                <p class=""><b>Tham gia hợp tác cùng chúng tôi </b> Được nhận sự hỗ trợ (kinh phí)
                                    hợp tác phát triển tài nguyên hướng nghiệp. </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid-x  group__benefit--blk">
                <div class="large-6 medium-12 small-12 large-flex-end large-order-2">
                    <div class="group__benefit__img group__benefit__img--2"></div>
                </div>
                <div class="large-6 medium-12 small-12 large-order-1">
                    <h3 class="group__benefit__title ">Dành cho học sinh của bạn </h3>
                    <div class="grid-x">
                        <div class="large-6 medium-6 small-12">
                            <div class="icon-wrapper">
                                <div class="green-small-icon icon-5"></div>
                            </div>
                            <div class="group__benefit__content">
                                <p class=""><b>TeenCodes khách quan & chính xác </b> Thuật toán 4.0 tự động phân
                                    tích sở thích, tính cách, động lực và kỹ năng của từng cá nhân. </p>
                            </div>
                            <div class="icon-wrapper">
                                <div class="green-small-icon icon-7"></div>
                            </div>
                            <div class="group__benefit__content">
                                <p class=""><b>Báo cáo kết quả theo thời gian thực </b> Nhận kết quả được cập nhật
                                    và chi tiết ngay từ khi bài trắc nghiệm được hoàn thành. </p>
                            </div>
                        </div>
                        <div class="large-6 medium-6 small-12">
                            <div class="icon-wrapper">
                                <div class="green-small-icon icon-6"></div>
                            </div>
                            <div class="group__benefit__content">
                                <p class=""><b>Cung cấp các lựa chọn hướng nghiệp </b> Liệt kê các môn học trọng tâm
                                    (môn thi), ngành nghề cùng với khóa đào tạo phù hợp. </p>
                            </div>
                            <div class="icon-wrapper">
                                <div class="green-small-icon icon-8"></div>
                            </div>
                            <div class="group__benefit__content">
                                <p class=""><b>Tư vấn hướng nghiệp được cá nhân hóa </b> Báo cáo có sẵn không chỉ để
                                    đọc trực tuyến riêng tư (trên website) mà còn để tải về. </p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg__conbtainer">
        <div class="grid-container">
            <div class="grid-x text-center">
                <div class="small-12 cell">
                    <h2 class="blue-blk__title blue-blk__title--with-mrg before-fade-in">Các đối tượng đại diện để
                        đăng ký Nhóm TeenCodes </h2>
                    <h3 class="blue-blk__mini-subtitle mar-bot-40 before-fade-in">Hình thức cung cấp Dịch vụ nhóm
                        chỉ dành cho những người hoạt động trong lĩnh vực giáo dục </h3>
                </div>
                <div class="large-6 medium-12 small-12 cell">
                    <div class="our-users__block">
                        <div class="grid-x">
                            <div class="large-9 medium-9 small-6 cell">
                                <h3 class="our-users__title before-fade-in">Lãnh đạo của trường học </h3>
                            </div>
                            <div class="our-users__img--wrapper  our-users__img--wrapper--edu adj-width">
                                <img alt="educators" class="our-users__img--5 before-fade-in"
                                     src="//cdn0.careerhunter.io/assets/Educator-c8641946261fd652973dbc8ed19f6a44ac861c117645ef47578411d5d889e24d.png">
                            </div>
                            <div class="large-9 medium-9 small-9 cell our-users__desc--wrapper">
                                <h3 class="our-users__desc our-users__desc--edu white before-fade-in">Hiệu trưởng,
                                    phó hiệu trưởng (hoặc người đứng đầu) của trường trung học phổ thông, trung học
                                    cơ sở ở cả thành phố hoặc vùng nông thôn. </h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="large-6 medium-12 small-12 cell">
                    <div class="our-users__block">
                        <div class="grid-x">
                            <div class="large-9 medium-9 small-6 cell">
                                <h3 class="our-users__title before-fade-in">Giáo viên chủ nhiệm </h3>
                            </div>
                            <div class="our-users__img--wrapper our-users__img--wrapper--edu">
                                <img alt="HR departments" class="our-users__img--6 before-fade-in"
                                     src="//cdn0.careerhunter.io/assets/HR_department-80858b8d234fb2e4ea44030fc488d2a67f6ea2f914d749ad99e68356956a3c1d.png">
                            </div>
                            <div class="large-9 medium-9 small-9 cell our-users__desc--wrapper">
                                <h3 class="our-users__desc our-users__desc--edu white before-fade-in">Giáo viên chủ
                                    nhiệm đang quản lý học sinh từ lớp 9 tới trung học phổ thông, đặc biệt là khối
                                    lớp 12 chuẩn bị tốt nghiệp và dự tuyển vào đại học. </h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="large-6 medium-12 small-12 cell">
                    <div class="our-users__block">
                        <div class="grid-x">
                            <div class="large-9 medium-9 small-6 cell">
                                <h3 class="our-users__title before-fade-in">Giáo viên bộ môn </h3>
                            </div>
                            <div class="our-users__img--wrapper  our-users__img--wrapper--edu adj-width">
                                <img alt="Recruitment_Agencies" class="our-users__img--7 before-fade-in"
                                     src="//cdn1.careerhunter.io/assets/Recruitment_Agencies-e7f984aeafe739f7cd5d3641d78aedf7e00c0ff0e8887096591143e7f7eaa763.png">
                            </div>
                            <div class="large-9 medium-9 small-9 cell our-users__desc--wrapper">
                                <h3 class="our-users__desc our-users__desc--edu white before-fade-in">Giáo viên đang
                                    giảng dạy các môn học trọng tâm (đối với học sinh trung học phổ thông) hoặc
                                    thuộc tổ hợp môn thi để xét tuyển vào các trường đại học. </h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="large-6 medium-12 small-12 cell">
                    <div class="our-users__block">
                        <div class="grid-x">
                            <div class="large-9 medium-9 small-6 cell">
                                <h3 class="our-users__title before-fade-in">Nhà tư vấn giáo dục </h3>
                            </div>
                            <div class="our-users__img--wrapper  our-users__img--wrapper--edu">
                                <img alt="Counsellors" class="our-users__img--8 before-fade-in"
                                     src="//cdn2.careerhunter.io/assets/Counsellors-f55ad3387aaf76ef425fba3f263c30b116cc2d104adf329fb05ec869e560ad2f.png">
                            </div>
                            <div class="large-9 medium-9 small-9 cell our-users__desc--wrapper">
                                <h3 class="our-users__desc our-users__desc--edu white before-fade-in">Nhà tư vấn
                                    hoặc chuyên gia cố vấn về giáo dục (cả ở bậc phổ thông và bậc học cao hơn), đặc
                                    biệt về hướng nghiệp sớm cho học sinh 14-18 tuổi. </h3>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg__conbtainer">
        ...
        <div class="grid-container review__container review__container--blue">
                    ...
                    <div class="slick-slider review__slider slick-initialized" dir="ltr">
                        ...
                        <div class="slick-list">
                            <div class="slick-track"
                                 style="width: 2124px; opacity: 1; transform: translate3d(0px, 0px, 0px);">
    ...
    <div class="group__blk">
        <div class="grid-container max-width-1064">
            <div class="grid-x text-center">
                <div class="small-12 cell">
                    <h2 class="group__blk-subtitle before-fade-in">Chúng tôi sẵn sàng phục vụ bạn </h2>
                    <p class="blue-blk__text before-fade-in">Hãy cung cấp cho tất cả học sinh của bạn tài khoản
                        TeenCodes để nhận được tư vấn hướng nghiệp đầy đủ nhất ngay bây giờ! </p>
                    <a href="#licenses" onclick="window.scrollTo({top: 0, behavior: &quot;smooth&quot;});"
                       aria-label="See group licensing options" class="button button--green before-fade-in">Đăng ký
                        nhóm <br> <span style="font-weight: bold;">CƠ BẢN</span> <span class="button__hovered"></span></a>
                    <a href="#licenses" onclick="window.scrollTo({top: 0, behavior: &quot;smooth&quot;});"
                       aria-label="See group licensing options" class="button button--green before-fade-in">Đăng ký
                        nhóm <br> <span style="font-weight: bold;"> TIÊU CHUẨN</span> <span class="button__hovered"></span></a>
                    <a href="#licenses" onclick="window.scrollTo({top: 0, behavior: &quot;smooth&quot;});"
                       aria-label="See group licensing options" class="button button--green before-fade-in">Đăng ký
                        nhóm <br> <span style="font-weight: bold;"> THÀNH CÔNG</span> <span class="button__hovered"></span></a>
                </div>
            </div>
        </div>
    </div>
