    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title">
                {{ trans('CRMEdu_admin.hop_dong_da_ky') }}
            </h3>
        </div>
    </div>
    <!--begin::Form-->
    <div class="kt-form">
        <div class="kt-portlet__body">
            <div class="kt-section kt-section--first">
                <?php
//                $bill_relate = \App\CRMEdu\Models\Bill::select('id', 'domain', 'service_id', 'registration_date', 'total_price_contract')
//                    ->where('status', 1)->where('customer_id', $customer_id)->where('id', '!=', @$bill_id)->get();
                ...
                <table style="width: 100%;">
                    <thead>
                        <tr>
                            <th>Dự án</th>
                            <th>{{ trans('CRMEdu_admin.service') }}</th>
                            <th>Tổng tiền</th>
                            <th>Ngày ký</th>
                            <th>#</th>
                        </tr>
