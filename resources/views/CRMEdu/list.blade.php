                                ...
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                    ...
                                    <ul class="kt-nav">
                                        ...
                                        <li class="kt-nav__item">
                                            <a href="/admin/import/add?table=bills&table_label=Hợp đồng" class="kt-nav__link"
                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($listItem as $item)
                            <?php
                                if(is_object($item->bill_finance)) $da_thu += @$item->total_received;
                                if(is_object($item->bill_finance)) $chua_thu += @$item->total_price_contract - @$item->total_received;
