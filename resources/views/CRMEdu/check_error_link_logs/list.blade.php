...
@section('main')
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <p><a href="https://www.youtube.com/playlist?list=PL48RvcOsejJBlJrun8cYQ4WLM5fgprqjs" target="_blank">Video hướng dẫn cách sửa lỗi</a> | <a href="https://prnt.sc/ViJ3Hd6hBgN5" target="_blank">Ảnh</a> </p>
                            ...
                            <div class="dropdown dropdown-inline">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                    ...
                                    <ul class="kt-nav">
                                        ...
                                        @if(in_array('penalty_ticket', $permissions))
                                            <li class="kt-nav__item">
                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($listItem as $item)
                            ...
                            @if($day != date('d', strtotime($item->created_at)))
                                <?php 
