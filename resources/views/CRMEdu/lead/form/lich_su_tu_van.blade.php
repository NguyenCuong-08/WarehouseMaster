        ...
        <div class="kt-portlet__body">
            ...
            <div class="log_action">
                ...
                <div class="dat-lich-hen" style="float: right;">
                    <?php
                    $field = ['name' => 'dating', 'type' => 'custom', 'field' => 'CRMEdu.lead.form.dating', 'class' => 'required', 'label' => 'Đặt hẹn ngày tương tác', 'value' => @$result->dating];
...
{{--                        @include('CRMEdu.lead.form.partials.nut_submit_ls_tu_van')--}}
{{--                    @else--}}
