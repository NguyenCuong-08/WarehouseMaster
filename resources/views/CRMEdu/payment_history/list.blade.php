...
{{--                                                type="checkbox"--}}
{{--                                                class="checkbox-master">&nbsp;<span></span>--}}
{{--                                    </label>--}}
{{--                                </span>--}}
{{--                            </th>--}}
...
{{--                                </td>--}}
                                ...
                                @foreach($module['list'] as $field)
                                    <td data-field="{{ @$field['name'] }}"
                                        ...
                                        @else
{{--                                            @if( @$field['name'] == 'trang_thai')--}}
{{--                                                @if(@include(config('core.admin_theme').'.list.td.'.$field['type']) == 'cancel')--}}
{{--                                                    Đã hủy--}}
{{--                                                @elseif(@include(config('core.admin_theme').'.list.td.'.$field['type']) == 'process')--}}
{{--                                                    Đang xử lý--}}
{{--                                                @elseif(@include(config('core.admin_theme').'.list.td.'.$field['type']) == 'succes')--}}
{{--                                                    Thành công--}}
{{--                                                @endif--}}
{{--                                            @else--}}
