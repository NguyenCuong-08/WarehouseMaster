                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                ...
                                @endforeach
                                    <div class="form-group-div form-group col-md-6 cursor-hover" id="form-group-status">
                                        <label for="status" class="cursor-hover">Tạo cây mới </label>
                                        <div class="col-xs-12 cursor-hover">
                                            <label style="cursor: pointer" for="tao-cay-moi" class="kt-checkbox kt-checkbox--tick kt-checkbox--brand pointer-hover">
                                                <input style="height: 20px; width: 18px; float: left; margin-right: 5px;" type="checkbox" name="company_id" id="tao-cay-moi" value="1">
                                                Tạo cây mới
                                                <span></span>
