...
@include(config('core.admin_theme').'.import.new_header.new_header_mobile')
<!-- end:: Header Mobile -->
...
{{--                @include('CRMDV.codes.new_header.new_nv_xuat_sac')--}}
                @include(config('core.admin_theme').'.import.new_header.new_nv_xuat_sac')
                <!-- begin: Header Menu -->
...
{{--                    @include('CRMDV.codes.new_header.new_user_bar')--}}
                    @include(config('core.admin_theme').'.import.new_header.new_user_bar')
                    <!--end: BillPayment Bar -->
                </div>
                <!-- end:: Header Topbar -->
            </div>
