...
@section('main')
    <style>
        ...
        @media(max-width:768px){
            ...
            .kt-portlet__head-actions .form-control {
			...
			<span class="kt-portlet__head-icon">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions" style="">
                        ...
                        <div class="kt-portlet__head-actions">
                            <input type="text" name="quick_search" value="{{ @$_GET['quick_search'] }}"
                                   ...
                                   placeholder="Tìm kiếm nhanh theo {{ @$quick_search['label'] }}" style="background:transparent">
                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($listItem as $item)
                            {{--                            @if($item->sender_id == $admin_id or $item->receiver_id == $admin_id)--}}
                            ...
                            <tr data-row="0" class="kt-datatable__row" >
                                ...
                                @foreach($module['list'] as $field)
                                    ...
                                    <td data-field="{{ @$field['name'] }}" style="white-space: nowrap;"
