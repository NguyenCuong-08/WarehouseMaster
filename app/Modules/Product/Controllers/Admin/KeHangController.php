...
//use DB;
class KeHangController extends CURDBaseController
{

    protected $module = [
        'code' => 'ke-hang',
        'table_name' => 'ke_hang',
        'label' => 'Quản lý kệ hàng',
        'modal' => '\App\Modules\Product\Models\KeHang',
        'list' => [
            ['name' => 'name', 'type' => 'text', 'label' => 'Tên kệ hàng'],
...
//            ['name' => 'code', 'type' => 'text', 'label' => 'Mã sản phẩm'],
        ...
        'form' => [
            'general_tab' => [
                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'Tên kệ hàng', 'group_class' => 'col-md-12'],
                ['name' => 'day_hang_id', 'type' => 'select2_model', 'class' => '',  'label' => 'Dãy hàng',
                    'model' => DayHang::class, 'display_field' => 'name', 'group_class' => 'col-md-4'],
