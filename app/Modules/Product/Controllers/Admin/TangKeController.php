...
//use DB;
class TangKeController extends CURDBaseController
{

    protected $module = [
        'code' => 'tang-ke',
        'table_name' => 'tang_ke',
        'label' => 'Quản lý tầng hàng',
        'modal' => '\App\Modules\Product\Models\TangKe',
        'list' => [
            ['name' => 'name', 'type' => 'text', 'label' => 'Tên tầng hàng'],
            ['name' => 'ke_hang_id', 'type' => 'relation', 'object' => 'ke_hang', 'display_field' => 'name', 'label' => 'Kệ hàng'],
...
//            ['name' => 'code', 'type' => 'text', 'label' => 'Mã sản phẩm'],
        ...
        'form' => [
            'general_tab' => [
                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'Tên tầng hàng', 'group_class' => 'col-md-12'],
                ['name' => 'day_hang_id', 'type' => 'select2_model', 'class' => '',  'label' => 'Kệ hàng',
                    'model' => KeHang::class, 'display_field' => 'name', 'group_class' => 'col-md-4'],
