...
//use DB;
class DayHangController extends CURDBaseController
{

    protected $module = [
        'code' => 'day_hang',
        'table_name' => 'day_hang',
        'label' => 'Quản lý dãy hàng',
        'modal' => '\App\Modules\Product\Models\DayHang',
        'list' => [
            ['name' => 'name', 'type' => 'text', 'label' => 'Tên dãy hàng'],
...
//            ['name' => 'code', 'type' => 'text', 'label' => 'Mã sản phẩm'],
        ...
        'form' => [
            'general_tab' => [
                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'Tên dãy hàng', 'group_class' => 'col-md-12'],
        ...
        if ($file) {
            ...
            if (!empty($data) && $data->count()) {
                foreach ($data as $key => $value) {
                    ...
                    if (!empty($value->ten) ) {
                        $existingProduct = DayHang::where('name', $value->name)
