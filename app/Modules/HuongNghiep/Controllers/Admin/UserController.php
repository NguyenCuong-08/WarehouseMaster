...
class UserController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'modal' => '\App\Modules\HuongNghiep\Models\User',
        'list' => [
            ['name' => 'id', 'type' => 'text_edit', 'label' => 'Mã'],
            ['name' => 'name', 'type' => 'text', 'label' => 'Tên người dùng'],
            ['name' => 'email', 'type' => 'text', 'label' => 'Email'],
            ['name' => 'password', 'type' => 'text', 'label' => 'Mật khẩu'],
            ['name' => 'phone', 'type' => 'text', 'label' => 'SĐT'],
            ['name' => 'year', 'type' => 'text', 'label' => 'Năm sinh'],
            ['name' => 'province_id', 'type' => 'relation','object'=>'province', 'display_field'=>'name' , 'label' => 'Thành phố'],
        ],
        'form' => [
            'general_tab' => [
                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'Tên người dùng', 'group_class' => 'col-md-6'],

                ['name' => 'email', 'type' => 'text', 'class' => 'required', 'label' => 'Email','group_class' => 'col-md-6'],
                ['name' => 'password', 'type' => 'text', 'class' => 'required', 'label' => 'Mật khẩu','group_class' => 'col-md-6'],
                ['name' => 'phone', 'type' => 'text', 'class' => 'required', 'label' => 'Số DTDĐ','group_class' => 'col-md-6'],
                ['name' => 'year', 'type' => 'text', 'class' => 'required', 'label' => 'Năm sinh','group_class' => 'col-md-6'],
                ['name' => 'province_id', 'type' => 'select2_model', 'class' => 'required', 'label' => 'Tỉnh/Thành', 'model' => \App\Models\Province::class, 'display_field' => 'name','group_class' => 'col-md-12'],
                ['name' => 'district_id', 'type' => 'select2_model', 'class' => 'required', 'label' => 'Quận/Huyện', 'model' => \App\Models\District::class, 'display_field' => 'name','group_class' => 'col-md-12'],
                ['name' => 'ward_id', 'type' => 'select2_model', 'class' => 'required', 'label' => 'Phường Xá', 'model' => \App\Models\Ward::class, 'display_field' => 'name','group_class' => 'col-md-12'],
                ['name' => 'phone_zalo', 'type' => 'text', 'label' => 'Số ĐTDĐ sử dụng zalo','group_class' => 'col-md-6'],
                ['name' => 'school', 'type' => 'text', 'label' => 'Tên hoặc mã tuyển sinh cửa trường đang theo học','group_class' => 'col-md-6'],
                ['name' => 'school_address', 'type' => 'text', 'label' => 'Địa chỉ trường học','group_class' => 'col-md-6'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('HuongNghiep.Admin.user.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('HuongNghiep.Admin.user.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('HuongNghiep.Admin.user.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
