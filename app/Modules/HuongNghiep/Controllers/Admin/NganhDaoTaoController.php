...
class NganhDaoTaoController extends CURDBaseController
{

    protected $module = [
        'code' => 'nganh_dao_tao',
        'table_name' => 'nganh_dao_tao',
        'label' => 'Ngành đào tạo',
        'modal' => '\App\Modules\HuongNghiep\Models\NganhDaoTao',
        'list' => [
            ['name' => 'id', 'type' => 'text_edit', 'label' => 'Mã'],
            ['name' => 'name', 'type' => 'text', 'label' => 'Tên ngành đào tạo'],
            ['name' => 'note', 'type' => 'text', 'label' => 'Ghi chú'],

        ],
        'form' => [
            'general_tab' => [
                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'Tiêu ngành đào tạo', 'group_class' => 'col-md-12'],

                ['name' => 'note', 'type' => 'textarea_editor', 'class' => 'required', 'label' => 'Ghi chú','group_class' => 'col-md-12'],
            ],
        ]
    ];
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('HuongNghiep.Admin.nganh-dao-tao.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('HuongNghiep.Admin.nganh-dao-tao.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('HuongNghiep.Admin.nganh-dao-tao.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
