...
class ContactController extends \App\Modules\Post\Controllers\Admin\CURDBaseController
{
    ...
    protected $module = [
        ...
        'table_name' => 'posts',
        'label' => 'Post',
        'modal' => '\App\Modules\Post\Models\Post',
        'list' => [
            ['name' => 'name', 'type' => 'text', 'label' => 'Tiêu đề'],
            ['name' => 'link', 'type' => 'text', 'label' => 'Link'],
            ['name' => 'admin_id', 'type' => 'relation', 'object' => 'admin', 'display_field' => 'name', 'label' => 'Admin'],
            ['name' => 'content', 'type' => 'text', 'label' => 'Nội dung'],
            ['name' => 'multi_cat', 'type' => 'relation', 'object' => 'categori', 'display_field' => 'name', 'label' => 'Danh mục'],
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'multi_cat',  'type' => 'select2_model', 'label' => 'Danh mục', 'model' => \App\Modules\Post\Models\Categori::class, 'object' => 'categori', 'display_field' => 'name', 'group_class' => 'col-md-6'],
            ],
            'des_tab' => [
...
//
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('Post.post.list')->with($data);
    }
