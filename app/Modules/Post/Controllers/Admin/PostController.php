...
class PostController extends \App\Modules\Post\Controllers\Admin\CURDBaseController
{
    ...
    protected $module = [
        ...
        'list' => [
            ['name' => 'name', 'type' => 'text_admin_edit', 'label' => 'Tiêu đề'],
            ['name' => 'link', 'type' => 'text', 'label' => 'Link'],
            ['name' => 'admin_id', 'type' => 'relation', 'object' => 'admin', 'display_field' => 'name', 'label' => 'Admin'],
            ['name' => 'content', 'type' => 'text', 'label' => 'Nội dung'],
            ['name' => 'multi_cat', 'type' => 'custom','td'=>'Post.post.list.td.danhmuc', 'object' => 'categori', 'display_field' => 'name', 'label' => 'Danh mục'],
