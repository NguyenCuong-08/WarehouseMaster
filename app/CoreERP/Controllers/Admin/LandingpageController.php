...
use App\CoreERP\Controllers\Helpers\CustomHelper;
use Validator;
...
class LandingpageController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'list' => [
            ['name' => 'domain', 'type' => 'custom', 'td' => 'CoreERP.list.td.domain', 'label' => 'Tên miền'],
...
//                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'Tên web', 'group_class' => 'col-md-6'],
               /* ['name' => 'customer_id', 'object' => 'admin', 'type' => 'custom', 'field' => 'CoreERP.form.fields.customer_id',
                ...
                ['name' => 'form_fields', 'type' => 'custom', 'field' => 'CoreERP.landingpage.form.fields.form_fields', 'object' => 'tours', 'class' => '',
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CoreERP.landingpage.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CoreERP.landingpage.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CoreERP.landingpage.edit')->with($data);
            } else if ($_POST) {
