...
//                    ['name' => 'so_ngay_khoa_vi', 'type' => 'text', 'class' => 'require', 'label' => 'Số ngày không mua hàng sẽ bị khóa ví'],

                    ['name' => 'yeu_cau_f1', 'type' => 'text', 'class' => 'require', 'label' => 'Số lượng F1 yêu cầu (Hoàn phí 1)', 'group_class' => 'col-xs-12 col-md-6'],
                    ['name' => 'hoan_phi_f1', 'type' => 'text', 'class' => 'require', 'label' => 'Số % hoàn phí 1', 'group_class' => 'col-xs-12 col-md-6'],
                    ['name' => 'yeu_cau_f1_2', 'type' => 'text', 'class' => 'require', 'label' => 'Số lượng F1 yêu cầu (Hoàn phí 2)', 'group_class' => 'col-xs-12 col-md-6'],
                    ['name' => 'hoan_phi_f1_2', 'type' => 'text', 'class' => 'require', 'label' => 'Số % hoàn phí 2', 'group_class' => 'col-xs-12 col-md-6'],
                    ['name' => 'hoan_phi_nhom_mot', 'type' => 'text', 'class' => 'require', 'label' => 'Phần trăm hoàn phí nhóm 1', 'group_class' => 'col-xs-12 col-md-6'],
                    ['name' => 'hoan_phi_nhom_hai', 'type' => 'text', 'class' => 'require', 'label' => 'Phần trăm hoàn phí nhóm 2', 'group_class' => 'col-xs-12 col-md-6'],
                    ['name' => 'hoan_phi_nhom_ba', 'type' => 'text', 'class' => 'require', 'label' => 'Phần trăm hoàn phí nhóm 3', 'group_class' => 'col-xs-12 col-md-6'],
                    ['name' => 'hoan_phi_nhom_bon', 'type' => 'text', 'class' => 'require', 'label' => 'Phần trăm hoàn phí nhóm 4', 'group_class' => 'col-xs-12 col-md-6'],
                    ['name' => 'hoan_phi_nhom_nam', 'type' => 'text', 'class' => 'require', 'label' => 'Phần trăm hoàn phí nhóm 5', 'group_class' => 'col-xs-12 col-md-6'],
                    ['name' => 'hoan_phi_nhom_sau', 'type' => 'text', 'class' => 'require', 'label' => 'Phần trăm hoàn phí nhóm 6', 'group_class' => 'col-xs-12 col-md-6'],
                ]
            ],
...
//               'intro' =>'',
    ...
    public function ajaxUpdate(Request $r) {
        Setting::where('name', $r->name)->where('type', $r->type)->update(['value' => $r->value]);
