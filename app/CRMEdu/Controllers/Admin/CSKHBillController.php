...
//            ['name' => 'count_product', 'type' => 'custom', 'td' => 'CRMEdu.cskh_bill.list.td.count_product', 'label' => 'Tổng SP'],
            ['name' => 'exp_price', 'type' => 'price_vi', 'label' => 'CRMEdu_admin.cskh_exp_price'],
            ['name' => 'expiry_date', 'type' => 'date_vi', 'label' => 'CRMEdu_admin.cskh_expiry_date'],
            ['name' => 'contacted_log_last', 'type' => 'date_vi', 'label' => 'CRMEdu_admin.cskh_contacted_log_last'],
            ['name' => 'action', 'type' => 'custom', 'td' => 'CRMEdu.cskh_bill.list.td.action', 'label' => 'CRMEdu_admin.cskh_action'],
        ],
        'form' => [
            'general_tab' => [
...
//                ['name' => 'customer_note', 'type' => 'textarea', 'class' => 'required', 'label' => 'Ghi chú của Khách'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMEdu.cskh_bill.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        ...
        try {
            if (!$_POST) {
                ...
                return view('CRMEdu.cskh_bill.add')->with($data);
            }
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMEdu.cskh_bill.edit')->with($data);
            }
