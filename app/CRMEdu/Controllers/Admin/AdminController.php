...
use Session;
use Validator;
use App\CRMEdu\Models\DailyWorkReport;
...
//            ], 'label' => 'Thời gian', 'sort' => true],
            ...
            ['name' => 'created_at', 'type' => 'date_vi', 'label' => 'CRMEdu_admin.admin_date'],
        ],
        'form' => [
            'general_tab' => [
                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'admin.full_name', 'group_class' => 'col-md-6'],
                ['name' => 'short_name', 'type' => 'text', 'class' => '', 'label' => 'CRMEdu_admin.admin_Name', 'group_class' => 'col-md-6'],
                ['name' => 'email', 'type' => 'custom', 'field' => 'CRMEdu.admin.form.email', 'class' => 'required', 'label' => 'admin.email', 'group_class' => 'col-md-6'],
                ['name' => 'tel', 'type' => 'custom', 'class' => 'required', 'field' => 'CRMEdu.admin.form.tel', 'label' => 'admin.phone', 'group_class' => 'col-md-6'],
//                ['name' => 'code', 'type' => 'custom', 'class' => 'required', 'field' => 'CRMEdu.admin.form.code', 'label' => 'Mã nhân viên', 'group_class' => 'col-md-4'],
//                ['name' => 'may_cham_cong_id', 'type' => 'number', 'class' => '', 'label' => 'CRMEdu_admin.admin_ID', 'group_class' => 'col-md-4'],
//                ['name' => 'status', 'type' => 'checkbox', 'label' => 'admin.active', 'value' => 1, 'group_class' => 'col-md-4'],
                ...
                /*['name' => 'role_id', 'type' => 'custom', 'field' => 'CRMEdu.admin.partials.select_role', 'label' => 'Quyền', 'class' => 'required', 'model' => \App\Models\Roles::class, 'display_field' => 'display_name', 'group_class' => 'col-md-6'],*/

//                ['name' => 'address', 'type' => 'text', 'class' => '', 'label' => 'admin.address', 'group_class' => 'col-md-12'],
//                ['name' => 'province_id', 'type' => 'select_location', 'label' => 'admin.choose_place', 'group_class' => 'col-md-12'],
...
//                ['name' => 'note', 'type' => 'textarea', 'class' => '', 'label' => 'admin.note', 'inner' => 'rows=10'],
            ...
            'more_info_tab' => [
                ['name' => 'image', 'type' => 'file_editor', 'label' => 'CRMEdu_admin.admin_anh'],
//                ['name' => 'facebook', 'type' => 'text', 'class' => '', 'label' => 'CRMEdu_admin.admin_facebook'],
//                ['name' => 'skype', 'type' => 'text', 'class' => '', 'label' => 'CRMEdu_admin.admin_skype'],
//                ['name' => 'zalo', 'type' => 'text', 'class' => '', 'label' => 'CRMEdu_admin.admin_zalo'],
...
//                ], 'label' => 'Thời gian làm', 'group_class' => 'col-md-12'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMEdu.admin.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMEdu.admin.add')->with($data);
            } else if ($_POST) {
                dd($request);
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMEdu.admin.edit')->with($data);
            } else if ($_POST) {
...
//                        'company_id' => \Auth::guard('admin')->user()->company_id
                    ...
                    $adminsuperadmin = new \App\CRMEdu\Models\Admin();
                    $superadmin = $adminsuperadmin->where('id','=',$request->id)->first();
                    $superadmin->super_admin = $request->role_id;
                    $superadmin->save();
...
//                }
    ...
    public function hieuSuatCongViec() {
        ...
        return view('CRMEdu.admin.hieu_suat_cong_viec')->with($data);
    }
    ...
    public function updateDailyWorkReport() {
        ...
        foreach($admins as $admin) {
            ...
            $count_leads_created = \App\CRMEdu\Models\Lead::whereRaw($whereSale)
                ->whereRaw($whereCreated_at)
                ->count();

            $coun_lead_contacted_logs = \App\CRMEdu\Models\LeadContactedLog::whereRaw($whereSale)
                ->whereRaw($whereCreated_at)
                ->whereNotIn('note', ['Không nghe', 'Sai số'])->count();

            $count_khqt = \App\CRMEdu\Models\Lead::whereRaw($whereLikeSale)
            ...
            $quanTamMoi = \App\CRMEdu\Models\LeadContactedLog::whereRaw($whereSale)
                ->where('created_at', '>', date('Y-m-d 00:00:00'))
                ->where('type', 'lead_quan_tam_lai')->count();

            $count_khqt_cao = \App\CRMEdu\Models\Lead::whereRaw($whereLikeSale)
