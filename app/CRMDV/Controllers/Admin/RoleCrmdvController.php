...
class RoleCrmdvController extends CURDBaseController
{
    protected $view = 'role';
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMDV.role_crmdv.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.role_crmdv.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.role_crmdv.edit')->with($data);
            } else if ($_POST) {
